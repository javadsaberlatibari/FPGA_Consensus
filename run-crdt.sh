...
#Node_List="157 156 155 153 159 151";
...
for i in $( seq 0 $((NUM_Nodes-=1)) ); do
    ...
    make exe DEVICE=/opt/xilinx/platforms/xilinx_u280_gen3x16_xdma_1_202211_1/xilinx_u280_gen3x16_xdma_1_202211_1.xpfm USER_KRNL=permission_switch EXE_NUM=${i}
done
h=0;
for j in $Node_List; do
    scp -r ~/Desktop/Saved_Files/permission_switch/network.xclbin jsaber@pc${j}.cloudlab.umass.edu:/users/jsaber
