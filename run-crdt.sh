...
for i in $( seq 0 $((NUM_Nodes-=1)) ); do
    ...
    make exe DEVICE=/opt/xilinx/platforms/xilinx_u280_gen3x16_xdma_1_202211_1/xilinx_u280_gen3x16_xdma_1_202211_1.xpfm USER_KRNL=test_krnl EXE_NUM=${i}
done
h=0;
...
#     printf "ssh pyuvaraj@pc${n}.cloudlab.umass.edu './host${h} network.xclbin $Arp_Delay_Base&'\n";
