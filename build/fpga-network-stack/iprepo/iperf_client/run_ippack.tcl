...
set sdx_kernel_name "iperf_client"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/kernel/user_krnl/iperf_krnl/src/hls/iperf_client_prj/solution1"
...
regslice_core
iperf_client_entry3
iperf_client_entry20
status_handler
openStatus_handler
txMetaData_handler
txDataBuffer_handler
client_512_s
server_512_s
clock
iperf_client
...
set Interfaces {
    m_axis_listen_port_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_listen_port_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_rx_metadata_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_metadata_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_close_connection_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_close_connection_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    ap_clk {
        ...
        buses "m_axis_listen_port_V_V s_axis_listen_port_status_V s_axis_notifications_V m_axis_read_package_V s_axis_rx_metadata_V_V s_axis_rx_data m_axis_open_connection_V s_axis_open_status_V m_axis_close_connection_V_V m_axis_tx_metadata_V m_axis_tx_data s_axis_tx_status_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
