...
set sdx_kernel_name "mac_ip_encode_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/fpga-network-stack/hls/mac_ip_encode/mac_ip_encode_prj/solution1"
...
regslice_core
extract_ip_address
mac_compute_ipv4_che
mac_finalize_ipv4_ch
insert_ip_checksum
handle_arp_reply
mac_lshiftWordByOcte
...
set Interfaces {
    ...
    m_axis_arp_lookup_request_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_arp_lookup_request_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "s_axis_ip s_axis_arp_lookup_reply_V m_axis_ip m_axis_arp_lookup_request_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 17 II x}
