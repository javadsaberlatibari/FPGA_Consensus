...
set sdx_kernel_name "dhcp_client"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/fpga-network-stack/hls/dhcp_client/dhcp_client_prj/solution1"
...
set Interfaces {
    m_axis_open_port_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_open_port_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_rx_metadata_V_sourceSocket {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_metadata_V_sourceSocket"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    s_axis_rx_metadata_V_destinationSocket {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_rx_metadata_V_destinationSocket"
        has_tready "1"
        ports {
            TDATA 48
        }
    ...
    m_axis_tx_length_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_tx_length_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    ap_clk {
        ...
        buses "m_axis_open_port_V_V s_axis_open_port_status_V s_axis_rx_metadata_V_sourceSocket s_axis_rx_metadata_V_destinationSocket s_axis_rx_data m_axis_tx_metadata_V m_axis_tx_length_V_V m_axis_tx_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
