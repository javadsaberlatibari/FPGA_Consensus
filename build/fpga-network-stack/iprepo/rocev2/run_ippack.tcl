...
set sdx_kernel_name "rocev2_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/fpga-network-stack/hls/rocev2/rocev2_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {rocev2_top_mux_32bkb
...
msn_table_msn_tabncg
msn_table_msn_tabocq
read_req_table_reqcK
mq_pointer_table_sc4
mq_pointer_table_udo
mq_meta_table_metvdy
mq_meta_table_metwdI
mq_meta_table_metxdS
regslice_core
fifo_w128_d2_A
fifo_w128_d3_A
fifo_w512_d2_A
...
regslice_core
rocev2_top_entry3
rocev2_top_entry2009
process_ipv4_512_s
ipv4_drop_optional_i
ipv4_lshiftWordByOct
ipv4_generate_ipv420
process_udp_512_2006
...
set Interfaces {
    ...
    s_axis_qp_interface_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_qp_interface_V"
        has_tready "1"
        ports {
            TDATA 144
        }
    ...
    s_axis_qp_conn_interface_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_qp_conn_interface_V"
        has_tready "1"
        ports {
            TDATA 184
        }
    ...
    ap_clk {
        ...
        buses "s_axis_rx_data s_axis_tx_meta_V s_axis_tx_data m_axis_tx_data m_axis_mem_write_cmd m_axis_mem_read_cmd m_axis_mem_write_data s_axis_mem_read_data s_axis_qp_interface_V s_axis_qp_conn_interface_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
