...
wire   [0:0] tmp_110_nbreadreq_fu_72_p3;
...
wire   [63:0] zext_ln544_8_fu_199_p1;
wire   [63:0] zext_ln544_fu_206_p1;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] trunc_ln321_fu_162_p1;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((tmp_nbreadreq_fu_64_p3 == 1'd1)) begin
            conn_table_remote_ip_address0 = zext_ln544_fu_206_p1;
        end else if (((tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0))) begin
            conn_table_remote_ip_address0 = zext_ln544_8_fu_199_p1;
        end else begin
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (tmp_nbreadreq_fu_64_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((tmp_nbreadreq_fu_64_p3 == 1'd1)) begin
            conn_table_remote_qp_address0 = zext_ln544_fu_206_p1;
        end else if (((tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0))) begin
            conn_table_remote_qp_address0 = zext_ln544_8_fu_199_p1;
        end else begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_113)) begin
        if ((tmp_nbreadreq_fu_64_p3 == 1'd1)) begin
            conn_table_remote_ud_address0 = zext_ln544_fu_206_p1;
        end else if (((tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0))) begin
            conn_table_remote_ud_address0 = zext_ln544_8_fu_199_p1;
        end else begin
...
always @ (*) begin
    if (((tmp_reg_224 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_reg_224 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_nbreadreq_fu_64_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((tmp_reg_224 == 1'd1) & (tx_connTable2ibh_rsp_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_64_p3 == 1'd1) & (tx_ibhconnTable_req_s_3_empty_n == 1'b0)) | ((qpi2connTable_req_V_TVALID == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((tmp_reg_224 == 1'd1) & (tx_connTable2ibh_rsp_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_64_p3 == 1'd1) & (tx_ibhconnTable_req_s_3_empty_n == 1'b0)) | ((qpi2connTable_req_V_TVALID == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((tmp_reg_224 == 1'd1) & (tx_connTable2ibh_rsp_1_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_64_p3 == 1'd1) & (tx_ibhconnTable_req_s_3_empty_n == 1'b0)) | ((qpi2connTable_req_V_TVALID == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_64_p3 == 1'd1) & (tx_ibhconnTable_req_s_3_empty_n == 1'b0)) | ((qpi2connTable_req_V_TVALID == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((tmp_reg_224 == 1'd1) & (tx_connTable2ibh_rsp_1_full_n == 1'b0));
end
...
always @ (*) begin
    ap_predicate_op7_read_state1 = ((tmp_110_nbreadreq_fu_72_p3 == 1'd1) & (tmp_nbreadreq_fu_64_p3 == 1'd0));
end
...
assign tmp_110_nbreadreq_fu_72_p3 = qpi2connTable_req_V_TVALID;

assign tmp_nbreadreq_fu_64_p3 = tx_ibhconnTable_req_s_3_empty_n;

assign trunc_ln321_fu_162_p1 = qpi2connTable_req_V_TDATA[15:0];

assign tx_connTable2ibh_rsp_1_din = {{{conn_table_remote_ud_q0}, {conn_table_remote_ip_q0}}, {conn_table_remote_qp_q0}};

assign zext_ln544_8_fu_199_p1 = trunc_ln321_fu_162_p1;

assign zext_ln544_fu_206_p1 = tx_ibhconnTable_req_s_3_dout;
