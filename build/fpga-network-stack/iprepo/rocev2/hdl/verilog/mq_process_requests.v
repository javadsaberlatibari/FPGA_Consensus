...
reg   [1:0] ap_phi_mux_storemerge37_i_phi_fu_333_p4;
wire   [1:0] ap_phi_reg_pp0_iter0_storemerge37_i_reg_330;
...
always @ (*) begin
    if (((rt_state_load_reg_734 == 3'd1) & (tmp_47_reg_787 == 1'd1))) begin
...
always @ (*) begin
    if (((grp_nbreadreq_fu_172_p5 == 1'd1) & (rt_state == 3'd1))) begin
        if ((grp_fu_556_p1 == 1'd0)) begin
            ap_phi_mux_storemerge37_i_phi_fu_333_p4 = 2'd0;
        end else if ((grp_fu_556_p1 == 1'd1)) begin
            ap_phi_mux_storemerge37_i_phi_fu_333_p4 = 2'd2;
        end else begin
...
always @ (*) begin
    ap_condition_476 = ((grp_nbreadreq_fu_172_p5 == 1'd1) & (grp_fu_556_p1 == 1'd1) & (rt_state == 3'd1));
end

always @ (*) begin
    ap_condition_479 = ((grp_nbreadreq_fu_172_p5 == 1'd1) & (rt_state == 3'd1) & (grp_fu_556_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_594 = ((1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_phi_reg_pp0_iter0_storemerge37_i_reg_330 = 'bx;
...
assign zext_ln319_fu_613_p1 = ap_phi_mux_storemerge37_i_phi_fu_333_p4;
