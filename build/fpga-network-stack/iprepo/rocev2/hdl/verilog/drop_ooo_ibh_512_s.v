...
wire   [1:0] select_ln460_fu_121_p3;
...
always @ (*) begin
    ap_predicate_op34_write_state2 = ((state_5_load_reg_135 == 2'd1) & (tmp_106_reg_147 == 1'd1));
end
...
assign select_ln460_fu_121_p3 = ((rx_ibhDropFifo_V_dout[0:0] === 1'b1) ? 2'd2 : 2'd1);
