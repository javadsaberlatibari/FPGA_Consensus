...
reg   [511:0] currWord_data_V_reg_345;
reg   [511:0] tmp_data_V_reg_354;
reg   [0:0] tmp_last_V_reg_359;
reg    ap_block_pp0_stage0_subdone;
wire   [1:0] select_ln1551_fu_274_p3;
wire   [15:0] select_ln82_fu_246_p3;
...
wire   [15:0] add_ln85_fu_240_p2;
wire   [511:0] p_Result_s_fu_228_p5;
wire   [0:0] xor_ln1551_fu_268_p2;
reg   [0:0] ap_NS_fsm;
...
assign add_ln85_fu_240_p2 = (header_idx + 16'd1);
...
assign currWord_data_V_fu_254_p3 = ((icmp_ln82_fu_170_p2[0:0] === 1'b1) ? p_Result_s_fu_228_p5 : tx_shift2ibhFifo_V_d_dout);
...
assign icmp_ln82_fu_170_p2 = ((Lo_assign_fu_162_p3 < 25'd96) ? 1'b1 : 1'b0);
...
assign select_ln1551_fu_274_p3 = ((xor_ln1551_fu_268_p2[0:0] === 1'b1) ? 2'd3 : 2'd0);
...
assign select_ln82_fu_246_p3 = ((icmp_ln82_fu_170_p2[0:0] === 1'b1) ? add_ln85_fu_240_p2 : header_idx);
...
assign xor_ln1551_fu_268_p2 = (tx_shift2ibhFifo_V_l_dout ^ 1'd1);
