...
reg   [511:0] tmp_data_V_3_reg_273;
reg   [63:0] tmp_keep_V_3_reg_279;
wire   [0:0] tmp_last_V_fu_160_p1;
wire   [0:0] rs_firstWord_load_load_fu_164_p1;
wire   [0:0] tmp_last_V_1_fu_178_p2;
reg   [0:0] tmp_last_V_1_reg_293;
...
wire   [55:0] p_Result_9_i_fu_168_p4;
wire   [63:0] trunc_ln647_fu_207_p1;
wire   [447:0] grp_fu_130_p4;
wire   [7:0] trunc_ln647_1_fu_219_p1;
wire   [55:0] grp_fu_139_p4;
reg   [0:0] ap_NS_fsm;
...
assign grp_fu_130_p4 = {{prevWord_data_V_14[511:64]}};

assign grp_fu_139_p4 = {{prevWord_keep_V_15[63:8]}};

assign io_acc_block_signal_op37 = (rx_udp2ibFifo_V_last_full_n & rx_udp2ibFifo_V_keep_full_n & rx_udp2ibFifo_V_data_full_n);
...
assign p_Result_1_fu_222_p3 = {{trunc_ln647_1_fu_219_p1}, {grp_fu_139_p4}};

assign p_Result_2_fu_247_p3 = {{64'd0}, {grp_fu_130_p4}};

assign p_Result_3_fu_256_p3 = {{8'd0}, {grp_fu_139_p4}};

assign p_Result_9_i_fu_168_p4 = {{rx_udp2shiftFifo_V_k_dout[63:8]}};
...
assign tmp_last_V_1_fu_178_p2 = ((p_Result_9_i_fu_168_p4 == 56'd0) ? 1'b1 : 1'b0);

assign tmp_last_V_fu_160_p1 = rx_udp2shiftFifo_V_l_dout;

assign tmp_nbreadreq_fu_70_p5 = (rx_udp2shiftFifo_V_l_empty_n & rx_udp2shiftFifo_V_k_empty_n & rx_udp2shiftFifo_V_d_empty_n);

assign trunc_ln647_1_fu_219_p1 = tmp_keep_V_3_reg_279[7:0];

assign trunc_ln647_fu_207_p1 = tmp_data_V_3_reg_273[63:0];
