...
reg   [511:0] tmp_data_V_65_reg_430;
...
wire   [511:0] p_Result_99_fu_291_p5;
...
wire   [511:0] ap_phi_reg_pp0_iter0_tmp_data_V_67_reg_211;
reg   [511:0] ap_phi_reg_pp0_iter1_tmp_data_V_67_reg_211;
wire   [511:0] ap_phi_reg_pp0_iter0_tmp_data_V_66_reg_221;
reg   [511:0] ap_phi_reg_pp0_iter1_tmp_data_V_66_reg_221;
wire   [2:0] select_ln1410_fu_349_p3;
wire   [2:0] select_ln1378_fu_401_p3;
wire   [0:0] trunc_ln150_fu_369_p1;
reg    ap_block_pp0_stage0_01001;
wire   [127:0] trunc_ln647_29_fu_287_p1;
wire   [31:0] trunc_ln647_fu_315_p1;
wire   [0:0] tmp_115_fu_379_p3;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_nbreadreq_fu_182_p3 == 1'd1) & (state_6 == 3'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        firstPayload <= 1'd1;
    end else if ((((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (firstPayload_load_load_fu_247_p1 == 1'd1) & (state_6 == 3'd2) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (firstPayload_load_load_fu_247_p1 == 1'd1) & (state_6 == 3'd3) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        firstPayload <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((tmp_last_V_fu_339_p1 == 1'd1) & (info_hasPayload_load_load_fu_255_p1 == 1'd1) & (tmp_111_nbreadreq_fu_160_p5 == 1'd1) & (state_6 == 3'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        state_6 <= select_ln1410_fu_349_p3;
    end else if ((((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (tmp_last_V_46_fu_311_p1 == 1'd1) & (state_6 == 3'd2) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (tmp_last_V_47_fu_283_p1 == 1'd1) & (state_6 == 3'd3) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_last_V_48_fu_271_p1 == 1'd1) & (tmp_114_nbreadreq_fu_94_p5 == 1'd1) & (state_6 == 3'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((tmp_last_V_fu_339_p1 == 1'd1) & (tmp_111_nbreadreq_fu_160_p5 == 1'd1) & (state_6 == 3'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (info_hasPayload_load_load_fu_255_p1 == 1'd0)))) begin
        state_6 <= 3'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_111_nbreadreq_fu_160_p5 == 1'd1) & (state_6 == 3'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_114_nbreadreq_fu_94_p5 == 1'd1) & (state_6 == 3'd4) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_111_nbreadreq_fu_160_p5 == 1'd1) & (state_6 == 3'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (state_6 == 3'd2) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (state_6 == 3'd3) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_condition_301 = ((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (firstPayload_load_load_fu_247_p1 == 1'd1) & (state_6 == 3'd3));
end

always @ (*) begin
    ap_condition_314 = ((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (firstPayload_load_load_fu_247_p1 == 1'd1) & (state_6 == 3'd2));
end

always @ (*) begin
    ap_condition_333 = ((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (state_6 == 3'd3) & (firstPayload_load_load_fu_247_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_341 = ((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (state_6 == 3'd2) & (firstPayload_load_load_fu_247_p1 == 1'd0));
end
...
assign ap_phi_reg_pp0_iter0_tmp_data_V_66_reg_221 = 'bx;

assign ap_phi_reg_pp0_iter0_tmp_data_V_67_reg_211 = 'bx;

always @ (*) begin
    ap_predicate_op11_read_state1 = ((tmp_114_nbreadreq_fu_94_p5 == 1'd1) & (state_6 == 3'd4));
end

always @ (*) begin
    ap_predicate_op18_read_state1 = ((tmp_113_nbreadreq_fu_116_p5 == 1'd1) & (state_6 == 3'd3));
end

always @ (*) begin
    ap_predicate_op30_read_state1 = ((tmp_112_nbreadreq_fu_138_p5 == 1'd1) & (state_6 == 3'd2));
end

always @ (*) begin
    ap_predicate_op42_read_state1 = ((tmp_111_nbreadreq_fu_160_p5 == 1'd1) & (state_6 == 3'd1));
end
...
always @ (*) begin
    ap_predicate_op80_write_state2 = ((tmp_114_reg_426 == 1'd1) & (state_6_load_reg_415 == 3'd4));
end

always @ (*) begin
    ap_predicate_op86_write_state2 = ((state_6_load_reg_415 == 3'd3) & (tmp_113_reg_445 == 1'd1));
end

always @ (*) begin
    ap_predicate_op92_write_state2 = ((state_6_load_reg_415 == 3'd2) & (tmp_112_reg_469 == 1'd1));
end

always @ (*) begin
    ap_predicate_op97_write_state2 = ((tmp_111_reg_493 == 1'd1) & (tmp_last_V_reg_507 == 1'd0) & (state_6_load_reg_415 == 3'd1));
end

always @ (*) begin
    ap_predicate_op99_write_state2 = ((tmp_last_V_reg_507 == 1'd1) & (tmp_111_reg_493 == 1'd1) & (info_hasPayload_load_reg_422 == 1'd0) & (state_6_load_reg_415 == 3'd1));
end
...
assign p_Result_99_fu_291_p5 = {{tx_rethShift2payFifo_3_dout[511:128]}, {trunc_ln647_29_fu_287_p1}};

assign p_Result_s_fu_319_p5 = {{tx_aethShift2payFifo_3_dout[511:32]}, {trunc_ln647_fu_315_p1}};

assign select_ln1378_fu_401_p3 = ((tmp_115_fu_379_p3[0:0] === 1'b1) ? 3'd1 : 3'd4);

assign select_ln1410_fu_349_p3 = ((info_isAETH[0:0] === 1'b1) ? 3'd2 : 3'd3);

assign tmp_111_nbreadreq_fu_160_p5 = (tx_exh2payFifo_V_las_empty_n & tx_exh2payFifo_V_kee_empty_n & tx_exh2payFifo_V_dat_empty_n);

assign tmp_112_nbreadreq_fu_138_p5 = (tx_aethShift2payFifo_6_empty_n & tx_aethShift2payFifo_5_empty_n & tx_aethShift2payFifo_3_empty_n);

assign tmp_113_nbreadreq_fu_116_p5 = (tx_rethShift2payFifo_6_empty_n & tx_rethShift2payFifo_5_empty_n & tx_rethShift2payFifo_3_empty_n);

assign tmp_114_nbreadreq_fu_94_p5 = (tx_rawPayFifo_V_last_empty_n & tx_rawPayFifo_V_keep_empty_n & tx_rawPayFifo_V_data_empty_n);

assign tmp_115_fu_379_p3 = tx_packetInfoFifo_V_dout[32'd1];
...
assign trunc_ln150_fu_369_p1 = tx_packetInfoFifo_V_dout[0:0];

assign trunc_ln647_29_fu_287_p1 = prevWord_data_V_16[127:0];
