...
architecture behav of rx_exh_payload_512_s is 
    ...
    signal empty_219_reg_366 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_219_fu_301_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal trunc_ln150_fu_171_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal empty_216_fu_283_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_215_fu_277_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_218_fu_295_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_217_fu_289_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    rocev2_top_mux_32bkb_U157 : component rocev2_top_mux_32bkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_nbreadreq_fu_96_p5 = ap_const_lv1_1) and (tmp_i_i_fu_207_p34 = ap_const_lv1_0) and (rep_state = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                empty_219_reg_366 <= empty_219_fu_301_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_29_nbreadreq_fu_82_p3 = ap_const_lv1_1) and (rep_state = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                meta_op_code_5 <= trunc_ln150_fu_171_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_predicate_op48_write_state2_assign_proc : process(rep_state_load_reg_324, tmp_reg_337, tmp_i_i_reg_362, empty_219_reg_366)
    begin
                ap_predicate_op48_write_state2 <= ((tmp_reg_337 = ap_const_lv1_1) and (rep_state_load_reg_324 = ap_const_lv1_1) and (empty_219_reg_366 = ap_const_lv1_0) and (tmp_i_i_reg_362 = ap_const_lv1_0));
    end process;


    ap_predicate_op50_write_state2_assign_proc : process(rep_state_load_reg_324, tmp_reg_337, tmp_i_i_reg_362, empty_219_reg_366)
    begin
                ap_predicate_op50_write_state2 <= ((tmp_reg_337 = ap_const_lv1_1) and (rep_state_load_reg_324 = ap_const_lv1_1) and (empty_219_reg_366 = ap_const_lv1_1) and (tmp_i_i_reg_362 = ap_const_lv1_0));
    end process;
    ...
    empty_215_fu_277_p2 <= "1" when (meta_op_code_5 = ap_const_lv5_10) else "0";
    empty_216_fu_283_p2 <= "1" when (meta_op_code_5 = ap_const_lv5_F) else "0";
    empty_217_fu_289_p2 <= (empty_216_fu_283_p2 or empty_215_fu_277_p2);
    empty_218_fu_295_p2 <= "1" when (meta_op_code_5 = ap_const_lv5_D) else "0";
    empty_219_fu_301_p2 <= (empty_218_fu_295_p2 or empty_217_fu_289_p2);
    ...
    trunc_ln150_fu_171_p1 <= rx_pkgSplitTypeFifo_s_7_dout(5 - 1 downto 0);
end behav;
