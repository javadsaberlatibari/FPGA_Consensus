...
architecture behav of mq_meta_table is 
    ...
    component mq_meta_table_metvdy IS
    generic (
        DataWidth : INTEGER;
    ...
    component mq_meta_table_metwdI IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component mq_meta_table_metxdS IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    meta_table_value_V_U : component mq_meta_table_metvdy
    generic map (
        DataWidth => 64,
        AddressRange => 2048,
        AddressWidth => 11)
    ...
    meta_table_next_V_U : component mq_meta_table_metwdI
    generic map (
        DataWidth => 16,
        AddressRange => 2048,
        AddressWidth => 11)
    ...
    meta_table_valid_U : component mq_meta_table_metxdS
    generic map (
        DataWidth => 1,
        AddressRange => 2048,
        AddressWidth => 11)
    ...
    meta_table_isTail_U : component mq_meta_table_metxdS
    generic map (
        DataWidth => 1,
        AddressRange => 2048,
        AddressWidth => 11)
