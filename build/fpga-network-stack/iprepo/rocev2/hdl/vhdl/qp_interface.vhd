...
architecture behav of qp_interface is 
    ...
    signal tmp_36_nbreadreq_fu_94_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal qp_fsmState_load_reg_310 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_36_reg_314 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_qpn_V_12_reg_318 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal trunc_ln109_fu_140_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_1_2_fu_247_p4 : STD_LOGIC_VECTOR (67 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_3_fu_278_p6 : STD_LOGIC_VECTOR (67 downto 0);
    signal tmp_1_fu_236_p5 : STD_LOGIC_VECTOR (67 downto 0);
    signal tmp_qpn_V_fu_262_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_30_i_fu_297_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_102)) then
                if (((tmp_nbreadreq_fu_108_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_1))) then 
                    qp_fsmState <= ap_const_lv1_0;
                elsif (((tmp_36_nbreadreq_fu_94_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_36_nbreadreq_fu_94_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                context_local_psn_V <= contextIn_V_TDATA(74 downto 51);
                context_newState <= trunc_ln109_fu_140_p1;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                qp_fsmState_load_reg_310 <= qp_fsmState;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (qp_fsmState = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_36_reg_314 <= tmp_36_nbreadreq_fu_94_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_36_nbreadreq_fu_94_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_qpn_V_12_reg_318 <= contextIn_V_TDATA(18 downto 3);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (qp_fsmState = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_reg_323 <= tmp_nbreadreq_fu_108_p3;
            end if;
        end if;
    end process;
    ...
    ap_predicate_op22_read_state1_assign_proc : process(tmp_nbreadreq_fu_108_p3, qp_fsmState)
    begin
                ap_predicate_op22_read_state1 <= ((tmp_nbreadreq_fu_108_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_1));
    end process;


    ap_predicate_op31_write_state2_assign_proc : process(qp_fsmState_load_reg_310, tmp_36_reg_314)
    begin
                ap_predicate_op31_write_state2 <= ((tmp_36_reg_314 = ap_const_lv1_1) and (qp_fsmState_load_reg_310 = ap_const_lv1_0));
    end process;


    ap_predicate_op40_write_state2_assign_proc : process(qp_fsmState_load_reg_310, tmp_reg_323)
    begin
                ap_predicate_op40_write_state2 <= ((tmp_reg_323 = ap_const_lv1_1) and (qp_fsmState_load_reg_310 = ap_const_lv1_1));
    end process;


    ap_predicate_op44_write_state2_assign_proc : process(qp_fsmState_load_reg_310, tmp_reg_323)
    begin
                ap_predicate_op44_write_state2 <= ((tmp_reg_323 = ap_const_lv1_1) and (qp_fsmState_load_reg_310 = ap_const_lv1_1));
    end process;


    ap_predicate_op7_read_state1_assign_proc : process(tmp_36_nbreadreq_fu_94_p3, qp_fsmState)
    begin
                ap_predicate_op7_read_state1 <= ((tmp_36_nbreadreq_fu_94_p3 = ap_const_lv1_1) and (qp_fsmState = ap_const_lv1_0));
    end process;
    ...
    if2msnTable_init_V_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_30_i_fu_297_p3),48));
    ...
    qpi2stateTable_upd_r_1_din_assign_proc : process(ap_predicate_op31_write_state2, ap_predicate_op40_write_state2, tmp_1_2_fu_247_p4, tmp_3_fu_278_p6, ap_condition_172)
    begin
        if ((ap_const_boolean_1 = ap_condition_172)) then
            if ((ap_predicate_op40_write_state2 = ap_const_boolean_1)) then 
                qpi2stateTable_upd_r_1_din <= tmp_3_fu_278_p6;
            elsif ((ap_predicate_op31_write_state2 = ap_const_boolean_1)) then 
                qpi2stateTable_upd_r_1_din <= tmp_1_2_fu_247_p4;
            else 
    ...
    tmp_1_2_fu_247_p4_proc : process(tmp_1_fu_236_p5)
    begin
        tmp_1_2_fu_247_p4 <= tmp_1_fu_236_p5;
        tmp_1_2_fu_247_p4(67) <= ap_const_lv1_0(0);
    end process;

    tmp_1_fu_236_p5 <= (ap_const_lv68_0(67 downto 16) & tmp_qpn_V_12_reg_318);
    tmp_30_i_fu_297_p3 <= (context_r_key_V & tmp_qpn_V_fu_262_p1);
    tmp_36_nbreadreq_fu_94_p3 <= (0=>(contextIn_V_TVALID), others=>'-');
    tmp_3_fu_278_p6 <= ((((ap_const_lv1_1 & context_local_psn_V) & context_remote_psn_V) & context_newState) & tmp_qpn_V_fu_262_p1);
    tmp_nbreadreq_fu_108_p3 <= (0=>(stateTable2qpi_rsp_V_empty_n), others=>'-');
    tmp_qpn_V_fu_262_p1 <= context_qp_num_V(16 - 1 downto 0);
    trunc_ln109_fu_140_p1 <= contextIn_V_TDATA(3 - 1 downto 0);
end behav;
