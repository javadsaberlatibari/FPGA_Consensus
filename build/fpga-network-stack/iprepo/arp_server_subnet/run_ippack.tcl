...
set sdx_kernel_name "arp_server_subnet_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/fpga-network-stack/hls/arp_server_subnet/arp_server_subnet_prj/solution1"
...
set Interfaces {
    ...
    s_axis_arp_lookup_request_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_arp_lookup_request_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    s_axis_host_arp_lookup_request_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_host_arp_lookup_request_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "s_axis s_axis_arp_lookup_request_V_V s_axis_host_arp_lookup_request_V_V m_axis m_axis_arp_lookup_reply_V m_axis_host_arp_lookup_reply_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
