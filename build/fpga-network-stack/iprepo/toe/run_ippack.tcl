...
set sdx_kernel_name "toe_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/jsabe004/Vitis_RoCE/build/fpga-network-stack/hls/toe/toe_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {fifo_w32_d8_A
fifo_w16_d8_A
fifo_w16_d8_A
fifo_w1_d8_A
fifo_w1_d8_A
...
state_table_statefYi
rx_sar_table_rx_tg8j
rx_sar_table_rx_thbi
rx_sar_table_rx_tibs
rx_sar_table_rx_tlbW
...
listening_port_taxdS
free_port_table_fyd2
retransmit_timer_zec
probe_timer_probeAem
...
set Interfaces {
    ...
    s_axis_listen_port_req_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_listen_port_req_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    s_axis_close_conn_req_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_close_conn_req_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    m_axis_rx_data_rsp_metadata_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_rx_data_rsp_metadata_V_V"
        has_tready "1"
        ports {
            TDATA 16
        }
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 34 II x}
