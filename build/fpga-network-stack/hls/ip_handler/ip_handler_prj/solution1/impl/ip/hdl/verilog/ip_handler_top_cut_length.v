...
reg    ap_idle_pp0;
wire   [0:0] tmp_i_nbreadreq_fu_182_p3;
reg    ap_predicate_op16_read_state1;
reg    ap_predicate_op27_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] cl_state_load_reg_415;
reg   [0:0] tmp_i_reg_419;
...
wire   [63:0] currWord_keep_V_2_fu_255_p66;
wire   [63:0] ap_phi_reg_pp0_iter0_currWord_keep_V_reg_203;
reg   [63:0] ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203;
wire   [1023:0] p_s_fu_402_p5;
reg    ap_block_pp0_stage0_01001;
wire   [5:0] currWord_keep_V_2_fu_255_p65;
wire   [64:0] tmp_117_i_fu_395_p3;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_117)) begin
        if ((1'b1 == ap_condition_139)) begin
            ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203 <= {{ipDataDropFifo_dout[575:512]}};
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_347)) begin
        if (((cl_state == 1'd1) & (grp_fu_212_p3 == 1'd1))) begin
            cl_state <= 1'd0;
        end else if (((cl_state == 1'd0) & (grp_fu_212_p3 == 1'd0))) begin
            cl_state <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((((1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op27_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op16_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        reg_220 <= ipDataDropFifo_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (cl_state == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_last_V_reg_428 <= ipDataDropFifo_dout[1024'd576];
    end
end
...
always @ (*) begin
    if ((((1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0) & (ap_predicate_op27_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)) | ((1'b0 == ap_block_pp0_stage0) & (ap_done_reg == 1'b0) & (ap_predicate_op16_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((ap_predicate_op27_read_state1 == 1'b1) & (ipDataDropFifo_empty_n == 1'b0)) | ((ap_predicate_op16_read_state1 == 1'b1) & (ipDataDropFifo_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_117 = ((1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end

always @ (*) begin
    ap_condition_131 = ((tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (cl_state == 1'd0) & (grp_fu_212_p3 == 1'd1));
end

always @ (*) begin
    ap_condition_139 = ((tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (cl_state == 1'd0) & (grp_fu_212_p3 == 1'd0));
end
...
always @ (*) begin
    ap_condition_347 = ((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_phi_reg_pp0_iter0_currWord_keep_V_reg_203 = 'bx;

always @ (*) begin
    ap_predicate_op16_read_state1 = ((tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (cl_state == 1'd0));
end

always @ (*) begin
    ap_predicate_op27_read_state1 = ((tmp_i_nbreadreq_fu_182_p3 == 1'd1) & (cl_state == 1'd1));
end

always @ (*) begin
    ap_predicate_op37_write_state2 = ((tmp_i_reg_419 == 1'd1) & (cl_state_load_reg_415 == 1'd0));
end

always @ (*) begin
    ap_predicate_op39_write_state2 = ((tmp_i_reg_419 == 1'd1) & (cl_state_load_reg_415 == 1'd1));
end

assign currWord_keep_V_2_fu_255_p65 = {{ipDataDropFifo_dout[29:24]}};

assign grp_fu_212_p3 = ipDataDropFifo_dout[1024'd576];

assign p_s_fu_402_p5 = {{reg_220[1023:577]}, {tmp_117_i_fu_395_p3}, {reg_220[511:0]}};

assign tmp_117_i_fu_395_p3 = {{tmp_last_V_reg_428}, {ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203}};

assign tmp_i_nbreadreq_fu_182_p3 = ipDataDropFifo_empty_n;
