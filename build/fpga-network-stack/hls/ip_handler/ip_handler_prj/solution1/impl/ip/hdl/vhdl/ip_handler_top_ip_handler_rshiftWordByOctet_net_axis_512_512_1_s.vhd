...
attribute shreg_extract : string;
    ...
    signal fsmState_1_load_reg_268 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_reg_282 : STD_LOGIC_VECTOR (0 downto 0);
    signal rs_firstWord_1_load_reg_289 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_Val2_4_reg_277 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_2_i7_reg_298 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal zext_ln174_2_fu_246_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal zext_ln174_fu_263_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal tmp_3_i8_fu_188_p4 : STD_LOGIC_VECTOR (49 downto 0);
    signal grp_fu_127_p4 : STD_LOGIC_VECTOR (49 downto 0);
    signal grp_fu_118_p4 : STD_LOGIC_VECTOR (399 downto 0);
    signal tmp_14_i_fu_235_p6 : STD_LOGIC_VECTOR (576 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                fsmState_1_load_reg_268 <= fsmState_1;
                p_Val2_4_reg_277 <= prevWord_keep_V_1;
                p_Val2_s_reg_272 <= prevWord_data_V_1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_76_p3 = ap_const_lv1_1) and (fsmState_1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                rs_firstWord_1_load_reg_289 <= rs_firstWord_1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_76_p3 = ap_const_lv1_1) and (fsmState_1 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (rs_firstWord_1_load_load_fu_170_p1 = ap_const_lv1_0))) then
                ...
                tmp_2_i7_reg_298 <= ipv4ShiftFifo_dout(525 downto 512);
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv4ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipDataFifo_full_n, fsmState_1_load_reg_268, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_1_load_reg_268 = ap_const_lv1_1) and (ipDataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipDataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv4ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv4ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipDataFifo_full_n, fsmState_1_load_reg_268, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_1_load_reg_268 = ap_const_lv1_1) and (ipDataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipDataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv4ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipv4ShiftFifo_empty_n, ap_predicate_op18_read_state1, ap_done_reg, ipDataFifo_full_n, fsmState_1_load_reg_268, ap_predicate_op46_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((fsmState_1_load_reg_268 = ap_const_lv1_1) and (ipDataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipDataFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (ipv4ShiftFifo_empty_n = ap_const_logic_0)))));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(ipDataFifo_full_n, fsmState_1_load_reg_268, ap_predicate_op46_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((fsmState_1_load_reg_268 = ap_const_lv1_1) and (ipDataFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ipDataFifo_full_n = ap_const_logic_0)));
    end process;
    ...
    ap_predicate_op46_write_state2_assign_proc : process(fsmState_1_load_reg_268, tmp_i_reg_282, rs_firstWord_1_load_reg_289)
    begin
                ap_predicate_op46_write_state2 <= ((rs_firstWord_1_load_reg_289 = ap_const_lv1_0) and (tmp_i_reg_282 = ap_const_lv1_1) and (fsmState_1_load_reg_268 = ap_const_lv1_0));
    end process;
    ...
    grp_fu_127_p4 <= p_Val2_4_reg_277(63 downto 14);

    ipDataFifo_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ipDataFifo_full_n, fsmState_1_load_reg_268, ap_predicate_op46_write_state2, ap_block_pp0_stage0)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0) and (fsmState_1_load_reg_268 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    ipDataFifo_din_assign_proc : process(fsmState_1_load_reg_268, ap_predicate_op46_write_state2, zext_ln174_2_fu_246_p1, zext_ln174_fu_263_p1, ap_condition_166)
    begin
        if ((ap_const_boolean_1 = ap_condition_166)) then
            if ((fsmState_1_load_reg_268 = ap_const_lv1_1)) then 
                ipDataFifo_din <= zext_ln174_fu_263_p1;
            elsif ((ap_predicate_op46_write_state2 = ap_const_boolean_1)) then 
                ipDataFifo_din <= zext_ln174_2_fu_246_p1;
            else 
    ...
    ipDataFifo_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, fsmState_1_load_reg_268, ap_predicate_op46_write_state2, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (fsmState_1_load_reg_268 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op46_write_state2 = ap_const_boolean_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    sendWord_last_V_fu_198_p2 <= "1" when (tmp_3_i8_fu_188_p4 = ap_const_lv50_0) else "0";
    tmp_14_i_fu_235_p6 <= ((((sendWord_last_V_reg_303 & tmp_2_i7_reg_298) & grp_fu_127_p4) & trunc_ln674_reg_293) & grp_fu_118_p4);
    tmp_3_i8_fu_188_p4 <= ipv4ShiftFifo_dout(575 downto 526);
    tmp_i_nbreadreq_fu_76_p3 <= (0=>(ipv4ShiftFifo_empty_n), others=>'-');
    trunc_ln674_fu_174_p1 <= ipv4ShiftFifo_dout(112 - 1 downto 0);
    zext_ln174_2_fu_246_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_14_i_fu_235_p6),1024));
