...
attribute shreg_extract : string;
    ...
    signal tmp_i_29_nbreadreq_fu_74_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_i_29_reg_183 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal ipDataCheckFifo_read_1_reg_165 : STD_LOGIC_VECTOR (1023 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((iid_state = ap_const_lv2_2)) and not((iid_state = ap_const_lv2_1)) and (tmp_i_29_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((iid_state = ap_const_lv2_2)) and not((iid_state = ap_const_lv2_1)) and (tmp_i_29_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_66_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
    ...
    ap_condition_69_assign_proc : process(tmp_i_nbreadreq_fu_66_p3, tmp_i_29_nbreadreq_fu_74_p3, iid_state)
    begin
                ap_condition_69 <= (not((iid_state = ap_const_lv2_2)) and not((iid_state = ap_const_lv2_1)) and (tmp_i_29_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_66_p3 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op48_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_66_p3, tmp_i_29_nbreadreq_fu_74_p3, iid_state)
    begin
                ap_predicate_op48_read_state1 <= (not((iid_state = ap_const_lv2_2)) and not((iid_state = ap_const_lv2_1)) and (tmp_i_29_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_66_p3 = ap_const_lv1_1));
    end process;


    ap_predicate_op49_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_66_p3, tmp_i_29_nbreadreq_fu_74_p3, iid_state)
    begin
                ap_predicate_op49_read_state1 <= (not((iid_state = ap_const_lv2_2)) and not((iid_state = ap_const_lv2_1)) and (tmp_i_29_nbreadreq_fu_74_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_66_p3 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op59_write_state2_assign_proc : process(iid_state_load_reg_157, tmp_i_reg_179, tmp_i_29_reg_183, and_ln195_reg_187)
    begin
                ap_predicate_op59_write_state2 <= (not((iid_state_load_reg_157 = ap_const_lv2_1)) and not((iid_state_load_reg_157 = ap_const_lv2_2)) and (ap_const_lv1_0 = and_ln195_reg_187) and (tmp_i_29_reg_183 = ap_const_lv1_1) and (tmp_i_reg_179 = ap_const_lv1_1));
    end process;


    ap_predicate_op60_write_state2_assign_proc : process(iid_state_load_reg_157, tmp_i_reg_179, tmp_i_29_reg_183, and_ln195_reg_187)
    begin
                ap_predicate_op60_write_state2 <= (not((iid_state_load_reg_157 = ap_const_lv2_1)) and not((iid_state_load_reg_157 = ap_const_lv2_2)) and (ap_const_lv1_1 = and_ln195_reg_187) and (tmp_i_29_reg_183 = ap_const_lv1_1) and (tmp_i_reg_179 = ap_const_lv1_1));
    end process;
    ...
    tmp_i_29_nbreadreq_fu_74_p3 <= (0=>(validIpAddressFifo_empty_n), others=>'-');
