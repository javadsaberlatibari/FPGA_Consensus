...
attribute shreg_extract : string;
    ...
    signal tmp_i_nbreadreq_fu_182_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_predicate_op16_read_state1 : BOOLEAN;
    signal ap_predicate_op27_read_state1 : BOOLEAN;
    signal ap_done_reg : STD_LOGIC := '0';
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal cl_state_load_reg_415 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_reg_419 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal reg_220 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal grp_fu_212_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_last_V_reg_428 : STD_LOGIC_VECTOR (0 downto 0);
    signal currWord_keep_V_2_fu_255_p66 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_phi_reg_pp0_iter0_currWord_keep_V_reg_203 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_s_fu_402_p5 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal currWord_keep_V_2_fu_255_p65 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_117_i_fu_395_p3 : STD_LOGIC_VECTOR (64 downto 0);
...
begin
    mux_646_64_1_1_U34 : component ip_handler_top_mux_646_64_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 64,
    ...
    port map (
        ...
        din64 => currWord_keep_V_2_fu_255_p65,
        dout => currWord_keep_V_2_fu_255_p66);
    ...
    ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_117)) then
                if ((ap_const_boolean_1 = ap_condition_139)) then 
                    ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203 <= ipDataDropFifo_dout(575 downto 512);
                elsif ((ap_const_boolean_1 = ap_condition_131)) then 
                    ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203 <= currWord_keep_V_2_fu_255_p66;
                elsif ((ap_const_boolean_1 = ap_const_boolean_1)) then 
                    ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203 <= ap_phi_reg_pp0_iter0_currWord_keep_V_reg_203;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_347)) then
                if (((cl_state = ap_const_lv1_1) and (grp_fu_212_p3 = ap_const_lv1_1))) then 
                    cl_state <= ap_const_lv1_0;
                elsif (((cl_state = ap_const_lv1_0) and (grp_fu_212_p3 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                cl_state_load_reg_415 <= cl_state;
                tmp_i_reg_419 <= tmp_i_nbreadreq_fu_182_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (cl_state = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_last_V_reg_428 <= ipDataDropFifo_dout(576 downto 576);
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipDataDropFifo_empty_n, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_done_reg, ipDataCutFifo_full_n, ap_predicate_op37_write_state2, ap_predicate_op39_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ap_predicate_op39_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op37_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipDataDropFifo_empty_n, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_done_reg, ipDataCutFifo_full_n, ap_predicate_op37_write_state2, ap_predicate_op39_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ap_predicate_op39_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op37_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, ipDataDropFifo_empty_n, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_done_reg, ipDataCutFifo_full_n, ap_predicate_op37_write_state2, ap_predicate_op39_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ap_predicate_op39_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)) or ((ap_predicate_op37_write_state2 = ap_const_boolean_1) and (ipDataCutFifo_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(ipDataDropFifo_empty_n, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_done_reg)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)) or ((ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ipDataDropFifo_empty_n = ap_const_logic_0)));
    end process;
    ...
    begin
                ap_condition_117 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;


    ap_condition_131_assign_proc : process(tmp_i_nbreadreq_fu_182_p3, cl_state, grp_fu_212_p3)
    begin
                ap_condition_131 <= ((tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (cl_state = ap_const_lv1_0) and (grp_fu_212_p3 = ap_const_lv1_1));
    end process;


    ap_condition_139_assign_proc : process(tmp_i_nbreadreq_fu_182_p3, cl_state, grp_fu_212_p3)
    begin
                ap_condition_139 <= ((tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (cl_state = ap_const_lv1_0) and (grp_fu_212_p3 = ap_const_lv1_0));
    end process;
    ...
    ap_condition_347_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, tmp_i_nbreadreq_fu_182_p3, ap_block_pp0_stage0_11001)
    begin
                ap_condition_347 <= ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0));
    end process;
    ...
    ap_phi_reg_pp0_iter0_currWord_keep_V_reg_203 <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";

    ap_predicate_op16_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_182_p3, cl_state)
    begin
                ap_predicate_op16_read_state1 <= ((tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (cl_state = ap_const_lv1_0));
    end process;


    ap_predicate_op27_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_182_p3, cl_state)
    begin
                ap_predicate_op27_read_state1 <= ((tmp_i_nbreadreq_fu_182_p3 = ap_const_lv1_1) and (cl_state = ap_const_lv1_1));
    end process;


    ap_predicate_op37_write_state2_assign_proc : process(cl_state_load_reg_415, tmp_i_reg_419)
    begin
                ap_predicate_op37_write_state2 <= ((tmp_i_reg_419 = ap_const_lv1_1) and (cl_state_load_reg_415 = ap_const_lv1_0));
    end process;


    ap_predicate_op39_write_state2_assign_proc : process(cl_state_load_reg_415, tmp_i_reg_419)
    begin
                ap_predicate_op39_write_state2 <= ((tmp_i_reg_419 = ap_const_lv1_1) and (cl_state_load_reg_415 = ap_const_lv1_1));
    end process;
    ...
    currWord_keep_V_2_fu_255_p65 <= ipDataDropFifo_dout(29 downto 24);
    grp_fu_212_p3 <= ipDataDropFifo_dout(576 downto 576);
    ...
    ipDataCutFifo_din_assign_proc : process(ap_predicate_op37_write_state2, ap_predicate_op39_write_state2, reg_220, p_s_fu_402_p5, ap_condition_149)
    begin
        if ((ap_const_boolean_1 = ap_condition_149)) then
            if ((ap_predicate_op39_write_state2 = ap_const_boolean_1)) then 
                ipDataCutFifo_din <= reg_220;
            elsif ((ap_predicate_op37_write_state2 = ap_const_boolean_1)) then 
                ipDataCutFifo_din <= p_s_fu_402_p5;
            else 
    ...
    ipDataDropFifo_blk_n_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ipDataDropFifo_empty_n, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_done_reg, ap_block_pp0_stage0)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_done_reg = ap_const_logic_0) and (ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_done_reg = ap_const_logic_0) and (ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    ipDataDropFifo_read_assign_proc : process(ap_start, ap_CS_fsm_pp0_stage0, ap_predicate_op16_read_state1, ap_predicate_op27_read_state1, ap_block_pp0_stage0_11001)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op27_read_state1 = ap_const_boolean_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_predicate_op16_read_state1 = ap_const_boolean_1) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    p_s_fu_402_p5 <= (reg_220(1023 downto 577) & tmp_117_i_fu_395_p3 & reg_220(511 downto 0));
    tmp_117_i_fu_395_p3 <= (tmp_last_V_reg_428 & ap_phi_reg_pp0_iter1_currWord_keep_V_reg_203);
    tmp_i_nbreadreq_fu_182_p3 <= (0=>(ipDataDropFifo_empty_n), others=>'-');
end behav;
