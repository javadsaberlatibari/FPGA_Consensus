...
assign process_axis_block_vec[9] = idx3_block & (1'b0 | axis_block_sigs[2] | axis_block_sigs[3]);
assign process_idle_vec[9] = inst_idle_sigs[9];
assign process_chan_block_vec[9] = inst_block_sigs[9];
assign process_axis_block_vec[10] = idx4_block & (1'b0 | axis_block_sigs[4] | axis_block_sigs[5]);
assign process_idle_vec[10] = inst_idle_sigs[10];
assign process_chan_block_vec[10] = inst_block_sigs[10];
assign process_axis_block_vec[11] = idx5_block & (1'b0 | axis_block_sigs[6] | axis_block_sigs[7]);
...
// instant sub module
 ip_handler_top_hls_deadlock_idx4_monitor ip_handler_top_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 ip_handler_top_hls_deadlock_idx3_monitor ip_handler_top_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 ip_handler_top_hls_deadlock_idx5_monitor ip_handler_top_hls_deadlock_idx5_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
