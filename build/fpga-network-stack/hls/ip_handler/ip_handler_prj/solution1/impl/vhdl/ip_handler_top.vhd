...
architecture behav of ip_handler_top is 
    ...
    signal detect_eth_protocol_512_U0_s_axis_raw_TREADY : STD_LOGIC;
    ...
    signal route_by_eth_protocol_512_U0_m_axis_arp_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal route_by_eth_protocol_512_U0_m_axis_arp_TVALID : STD_LOGIC;
    ...
    signal detect_ipv4_protocol_512_U0_m_axis_icmp_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal detect_ipv4_protocol_512_U0_m_axis_icmp_TVALID : STD_LOGIC;
    signal detect_ipv4_protocol_512_U0_m_axis_tcp_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal detect_ipv4_protocol_512_U0_m_axis_tcp_TVALID : STD_LOGIC;
    ...
    signal detect_ipv6_protocol_512_U0_m_axis_icmpv6_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal detect_ipv6_protocol_512_U0_m_axis_icmpv6_TVALID : STD_LOGIC;
    signal detect_ipv6_protocol_512_U0_m_axis_ipv6udp_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal detect_ipv6_protocol_512_U0_m_axis_ipv6udp_TVALID : STD_LOGIC;
    ...
    signal ip_handler_duplicate_stream_net_axis_512_U0_m_axis_udp_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal ip_handler_duplicate_stream_net_axis_512_U0_m_axis_udp_TVALID : STD_LOGIC;
    signal ip_handler_duplicate_stream_net_axis_512_U0_m_axis_roce_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal ip_handler_duplicate_stream_net_axis_512_U0_m_axis_roce_TVALID : STD_LOGIC;
    signal etherTypeFifo_full_n : STD_LOGIC;
    signal etherTypeFifo_dout : STD_LOGIC_VECTOR (15 downto 0);
    signal etherTypeFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal etherTypeFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ethDataFifo_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal ethDataFifo_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ipv4ShiftFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipv4ShiftFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ipv6ShiftFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipv6ShiftFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ipDataFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipDataFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ipv6DataFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipv6DataFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ipDataMetaFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipDataMetaFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal validIpAddressFifo_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal validIpAddressFifo_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal ipv4ProtocolFifo_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal ipv4ProtocolFifo_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal ipDataCheckFifo_num_data_valid : STD_LOGIC_VECTOR (6 downto 0);
    signal ipDataCheckFifo_fifo_cap : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal iph_subSumsFifoOut_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal iph_subSumsFifoOut_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal validChecksumFifo_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal validChecksumFifo_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal ipv4ValidFifo_num_data_valid : STD_LOGIC_VECTOR (3 downto 0);
    signal ipv4ValidFifo_fifo_cap : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal ipDataDropFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipDataDropFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal ipDataCutFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal ipDataCutFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal udpDataFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal udpDataFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
