...
set portList { 
	...
	{ iph_subSumsFifoOut_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ iph_subSumsFifoOut_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ validChecksumFifo_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ validChecksumFifo_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set Spec2ImplPortList { 
	iph_subSumsFifoOut { ap_fifo {  { iph_subSumsFifoOut_dout fifo_port_we 0 1024 }  { iph_subSumsFifoOut_num_data_valid fifo_status_num_data_valid 0 2 }  { iph_subSumsFifoOut_fifo_cap fifo_update 0 2 }  { iph_subSumsFifoOut_empty_n fifo_status 0 1 }  { iph_subSumsFifoOut_read fifo_data 1 1 } } }
	validChecksumFifo { ap_fifo {  { validChecksumFifo_din fifo_port_we 1 1 }  { validChecksumFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { validChecksumFifo_fifo_cap fifo_update 0 3 }  { validChecksumFifo_full_n fifo_status 0 1 }  { validChecksumFifo_write fifo_data 1 1 } } }
}
