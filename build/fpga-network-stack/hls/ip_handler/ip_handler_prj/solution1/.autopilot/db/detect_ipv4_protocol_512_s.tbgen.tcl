...
set portList { 
	...
	{ ipv4ProtocolFifo_dout sc_in sc_lv 8 signal 2 } 
	{ ipv4ProtocolFifo_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ ipv4ProtocolFifo_fifo_cap sc_in sc_lv 6 signal 2 } 
	{ ipv4ProtocolFifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ ipv4ProtocolFifo_read sc_out sc_logic 1 signal 2 } 
	{ ipv4ValidFifo_dout sc_in sc_lv 1 signal 3 } 
	{ ipv4ValidFifo_num_data_valid sc_in sc_lv 4 signal 3 } 
	{ ipv4ValidFifo_fifo_cap sc_in sc_lv 4 signal 3 } 
	{ ipv4ValidFifo_empty_n sc_in sc_logic 1 signal 3 } 
	{ ipv4ValidFifo_read sc_out sc_logic 1 signal 3 } 
	{ ipDataCutFifo_dout sc_in sc_lv 1024 signal 4 } 
	{ ipDataCutFifo_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ ipDataCutFifo_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ ipDataCutFifo_empty_n sc_in sc_logic 1 signal 4 } 
	{ ipDataCutFifo_read sc_out sc_logic 1 signal 4 } 
	{ m_axis_tcp_TREADY sc_in sc_logic 1 outacc 1 } 
	{ udpDataFifo_din sc_out sc_lv 1024 signal 5 } 
	{ udpDataFifo_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ udpDataFifo_fifo_cap sc_in sc_lv 2 signal 5 } 
	{ udpDataFifo_full_n sc_in sc_logic 1 signal 5 } 
	{ udpDataFifo_write sc_out sc_logic 1 signal 5 } 
	{ m_axis_icmp_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_icmp_TDATA sc_out sc_lv 1024 signal 0 } 
	{ m_axis_icmp_TVALID sc_out sc_logic 1 outvld 0 } 
	{ m_axis_tcp_TDATA sc_out sc_lv 1024 signal 1 } 
	{ m_axis_tcp_TVALID sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ipDataCutFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ipDataCutFifo", "role": "num_data_valid" }} , 
 	{ "name": "ipDataCutFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "ipDataCutFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "udpDataFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "udpDataFifo", "role": "num_data_valid" }} , 
 	{ "name": "udpDataFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "udpDataFifo", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_icmp_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_tcp_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_icmp { axis {  { m_axis_icmp_TREADY out_acc 0 1 }  { m_axis_icmp_TDATA out_data 1 1024 }  { m_axis_icmp_TVALID out_vld 1 1 } } }
	m_axis_tcp { axis {  { m_axis_tcp_TREADY out_acc 0 1 }  { m_axis_tcp_TDATA out_data 1 1024 }  { m_axis_tcp_TVALID out_vld 1 1 } } }
	ipv4ProtocolFifo { ap_fifo {  { ipv4ProtocolFifo_dout fifo_port_we 0 8 }  { ipv4ProtocolFifo_num_data_valid fifo_status_num_data_valid 0 6 }  { ipv4ProtocolFifo_fifo_cap fifo_update 0 6 }  { ipv4ProtocolFifo_empty_n fifo_status 0 1 }  { ipv4ProtocolFifo_read fifo_data 1 1 } } }
	ipv4ValidFifo { ap_fifo {  { ipv4ValidFifo_dout fifo_port_we 0 1 }  { ipv4ValidFifo_num_data_valid fifo_status_num_data_valid 0 4 }  { ipv4ValidFifo_fifo_cap fifo_update 0 4 }  { ipv4ValidFifo_empty_n fifo_status 0 1 }  { ipv4ValidFifo_read fifo_data 1 1 } } }
	ipDataCutFifo { ap_fifo {  { ipDataCutFifo_dout fifo_port_we 0 1024 }  { ipDataCutFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipDataCutFifo_fifo_cap fifo_update 0 2 }  { ipDataCutFifo_empty_n fifo_status 0 1 }  { ipDataCutFifo_read fifo_data 1 1 } } }
	udpDataFifo { ap_fifo {  { udpDataFifo_din fifo_port_we 1 1024 }  { udpDataFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { udpDataFifo_fifo_cap fifo_update 0 2 }  { udpDataFifo_full_n fifo_status 0 1 }  { udpDataFifo_write fifo_data 1 1 } } }
}
