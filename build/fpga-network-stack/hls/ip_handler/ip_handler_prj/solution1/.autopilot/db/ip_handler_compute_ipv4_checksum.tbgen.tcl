...
set portList { 
	...
	{ ipDataMetaFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ ipDataMetaFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ ipDataCheckFifo_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ ipDataCheckFifo_fifo_cap sc_in sc_lv 7 signal 1 } 
	...
	{ iph_subSumsFifoOut_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ iph_subSumsFifoOut_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "iph_subSumsFifoOut_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "iph_subSumsFifoOut", "role": "num_data_valid" }} , 
 	{ "name": "iph_subSumsFifoOut_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "iph_subSumsFifoOut", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	ipDataMetaFifo { ap_fifo {  { ipDataMetaFifo_dout fifo_port_we 0 1024 }  { ipDataMetaFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipDataMetaFifo_fifo_cap fifo_update 0 2 }  { ipDataMetaFifo_empty_n fifo_status 0 1 }  { ipDataMetaFifo_read fifo_data 1 1 } } }
	ipDataCheckFifo { ap_fifo {  { ipDataCheckFifo_din fifo_port_we 1 1024 }  { ipDataCheckFifo_num_data_valid fifo_status_num_data_valid 0 7 }  { ipDataCheckFifo_fifo_cap fifo_update 0 7 }  { ipDataCheckFifo_full_n fifo_status 0 1 }  { ipDataCheckFifo_write fifo_data 1 1 } } }
	iph_subSumsFifoOut { ap_fifo {  { iph_subSumsFifoOut_din fifo_port_we 1 1024 }  { iph_subSumsFifoOut_num_data_valid fifo_status_num_data_valid 0 2 }  { iph_subSumsFifoOut_fifo_cap fifo_update 0 2 }  { iph_subSumsFifoOut_full_n fifo_status 0 1 }  { iph_subSumsFifoOut_write fifo_data 1 1 } } }
}
