...
set portList { 
	...
	{ ipv4ShiftFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ ipv4ShiftFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set Spec2ImplPortList { 
	ipv4ShiftFifo { ap_fifo {  { ipv4ShiftFifo_dout fifo_port_we 0 1024 }  { ipv4ShiftFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipv4ShiftFifo_fifo_cap fifo_update 0 2 }  { ipv4ShiftFifo_empty_n fifo_status 0 1 }  { ipv4ShiftFifo_read fifo_data 1 1 } } }
	ipDataFifo { ap_fifo {  { ipDataFifo_din fifo_port_we 1 1024 }  { ipDataFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipDataFifo_fifo_cap fifo_update 0 2 }  { ipDataFifo_full_n fifo_status 0 1 }  { ipDataFifo_write fifo_data 1 1 } } }
}
