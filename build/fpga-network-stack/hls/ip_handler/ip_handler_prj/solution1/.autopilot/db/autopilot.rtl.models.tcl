set SynModuleInfo {
  {SRCNAME clear.1 MODELNAME clear_1 RTLNAME ip_handler_top_clear_1}
  ...
  {SRCNAME clear MODELNAME clear RTLNAME ip_handler_top_clear}
  ...
  {SRCNAME ip_handler_top MODELNAME ip_handler_top RTLNAME ip_handler_top IS_TOP 1
    SUBMODULES {
      {MODELNAME ip_handler_top_fifo_w16_d2_S RTLNAME ip_handler_top_fifo_w16_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1024_d4_A RTLNAME ip_handler_top_fifo_w1024_d4_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1024_d2_S RTLNAME ip_handler_top_fifo_w1024_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1_d32_S RTLNAME ip_handler_top_fifo_w1_d32_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w8_d32_S RTLNAME ip_handler_top_fifo_w8_d32_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1024_d64_A RTLNAME ip_handler_top_fifo_w1024_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1_d4_S RTLNAME ip_handler_top_fifo_w1_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME ip_handler_top_fifo_w1_d8_S RTLNAME ip_handler_top_fifo_w1_d8_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
    }
  }
}
