...
set portList { 
	...
	{ ipv6ShiftFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ ipv6ShiftFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ ipv6DataFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ ipv6DataFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
...
set Spec2ImplPortList { 
	ipv6ShiftFifo { ap_fifo {  { ipv6ShiftFifo_dout fifo_port_we 0 1024 }  { ipv6ShiftFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipv6ShiftFifo_fifo_cap fifo_update 0 2 }  { ipv6ShiftFifo_empty_n fifo_status 0 1 }  { ipv6ShiftFifo_read fifo_data 1 1 } } }
	ipv6DataFifo { ap_fifo {  { ipv6DataFifo_din fifo_port_we 1 1024 }  { ipv6DataFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { ipv6DataFifo_fifo_cap fifo_update 0 2 }  { ipv6DataFifo_full_n fifo_status 0 1 }  { ipv6DataFifo_write fifo_data 1 1 } } }
}
