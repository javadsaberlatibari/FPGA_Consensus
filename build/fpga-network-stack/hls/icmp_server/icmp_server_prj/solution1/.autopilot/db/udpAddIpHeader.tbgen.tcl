...
set C_modelArgList {
	...
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1 int 128 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "udpPort2addIpHeader_header", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ udpPort2addIpHeader_header_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ udpPort2addIpHeader_header_fifo_cap sc_in sc_lv 7 signal 0 } 
	{ udpPort2addIpHeader_header_empty_n sc_in sc_logic 1 signal 0 } 
	{ udpPort2addIpHeader_header_read sc_out sc_logic 1 signal 0 } 
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_din sc_out sc_lv 128 signal 1 } 
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_fifo_cap sc_in sc_lv 5 signal 1 } 
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_full_n sc_in sc_logic 1 signal 1 } 
	{ icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1", "role": "din" }} , 
 	...
 	{ "name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1", "role": "full_n" }} , 
 	{ "name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	udpPort2addIpHeader_header { ap_fifo {  { udpPort2addIpHeader_header_dout fifo_port_we 0 64 }  { udpPort2addIpHeader_header_num_data_valid fifo_status_num_data_valid 0 7 }  { udpPort2addIpHeader_header_fifo_cap fifo_update 0 7 }  { udpPort2addIpHeader_header_empty_n fifo_status 0 1 }  { udpPort2addIpHeader_header_read fifo_data 1 1 } } }
	icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1 { ap_fifo {  { icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_din fifo_port_we 1 128 }  { icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_num_data_valid fifo_status_num_data_valid 0 5 }  { icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_fifo_cap fifo_update 0 5 }  { icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_full_n fifo_status 0 1 }  { icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_write fifo_data 1 1 } } }
	udpPort2addIpHeader_data { ap_fifo {  { udpPort2addIpHeader_data_dout fifo_port_we 0 128 }  { udpPort2addIpHeader_data_num_data_valid fifo_status_num_data_valid 0 9 }  { udpPort2addIpHeader_data_fifo_cap fifo_update 0 9 }  { udpPort2addIpHeader_data_empty_n fifo_status 0 1 }  { udpPort2addIpHeader_data_read fifo_data 1 1 } } }
}
