...
assign process_axis_block_vec[1] = idx2_block & (1'b0 | axis_block_sigs[1] | axis_block_sigs[2]);
...
assign process_axis_block_vec[4] = idx3_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 icmp_server_hls_deadlock_idx2_monitor icmp_server_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
