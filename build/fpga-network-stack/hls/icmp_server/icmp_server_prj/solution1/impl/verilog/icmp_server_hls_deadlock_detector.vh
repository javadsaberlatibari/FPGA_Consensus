    ...
    icmp_server_hls_deadlock_detect_unit #(5, 0, 2, 2) icmp_server_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~check_icmp_checksum_U0.packageBuffer1_blk_n) | (~check_icmp_checksum_U0.validFifo_blk_n);
    ...
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~check_icmp_checksum_U0.icmp_server_stream_stream_stream_stream_axiWord_0_checksumStreams_1_blk_n);
    ...
    icmp_server_hls_deadlock_detect_unit #(5, 1, 2, 2) icmp_server_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~udpPortUnreachable_U0.udpPort2addIpHeader_data_blk_n) | (~udpPortUnreachable_U0.udpPort2addIpHeader_header_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~udpPortUnreachable_U0.icmp_server_stream_stream_stream_stream_axiWord_0_checksumStreams_blk_n);
    ...
    assign in_chan_dep_data_vec_1[9 : 5] = dep_chan_data_4_1;
    ...
    icmp_server_hls_deadlock_detect_unit #(5, 2, 2, 2) icmp_server_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~udpAddIpHeader_U0.udpPort2addIpHeader_header_blk_n) | (~udpAddIpHeader_U0.udpPort2addIpHeader_data_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~udpAddIpHeader_U0.icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_blk_n);
    ...
    // Process: dropper_U0
    icmp_server_hls_deadlock_detect_unit #(5, 3, 2, 2) icmp_server_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~dropper_U0.packageBuffer1_blk_n) | (~dropper_U0.validFifo_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~dropper_U0.icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_blk_n);
    ...
    icmp_server_hls_deadlock_detect_unit #(5, 4, 4, 4) icmp_server_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~insertChecksum_U0.icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~insertChecksum_U0.icmp_server_stream_stream_stream_stream_axiWord_0_dataStreams_1_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~insertChecksum_U0.icmp_server_stream_stream_stream_stream_axiWord_0_checksumStreams_1_blk_n);
    ...
    assign proc_4_data_FIFO_blk[3] = 1'b0 | (~insertChecksum_U0.icmp_server_stream_stream_stream_stream_axiWord_0_checksumStreams_blk_n);
...
`include "icmp_server_hls_deadlock_report_unit.vh"
