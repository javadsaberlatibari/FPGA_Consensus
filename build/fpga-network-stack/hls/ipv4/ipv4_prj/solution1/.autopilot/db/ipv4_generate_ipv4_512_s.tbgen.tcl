...
set portList { 
	...
	{ tx_shift2ipv4Fifo_num_data_valid sc_in sc_lv 4 signal 4 } 
	{ tx_shift2ipv4Fifo_fifo_cap sc_in sc_lv 4 signal 4 } 
	...
	{ s_axis_tx_meta_TDATA sc_in sc_lv 64 signal 0 } 
	...
	{ local_ipv4_address sc_in sc_lv 32 signal 2 } 
	{ protocol sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	s_axis_tx_meta { axis {  { s_axis_tx_meta_TVALID in_vld 0 1 }  { s_axis_tx_meta_TDATA in_data 0 64 }  { s_axis_tx_meta_TREADY in_acc 1 1 } } }
