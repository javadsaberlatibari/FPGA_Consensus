...
set portList { 
	...
	{ rx_process2dropFifo_dout sc_in sc_lv 1024 signal 2 } 
	{ rx_process2dropFifo_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ rx_process2dropFifo_fifo_cap sc_in sc_lv 4 signal 2 } 
	{ rx_process2dropFifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ rx_process2dropFifo_read sc_out sc_logic 1 signal 2 } 
	{ rx_process2dropLengthFifo_dout sc_in sc_lv 4 signal 1 } 
	{ rx_process2dropLengthFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ rx_process2dropLengthFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ rx_process2dropLengthFifo_empty_n sc_in sc_logic 1 signal 1 } 
	{ rx_process2dropLengthFifo_read sc_out sc_logic 1 signal 1 } 
	{ m_axis_rx_data_TREADY sc_in sc_logic 1 outacc 0 } 
	{ m_axis_rx_data_TDATA sc_out sc_lv 1024 signal 0 } 
	{ m_axis_rx_data_TVALID sc_out sc_logic 1 outvld 0 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_m_axis_rx_data_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	m_axis_rx_data { axis {  { m_axis_rx_data_TREADY out_acc 0 1 }  { m_axis_rx_data_TDATA out_data 1 1024 }  { m_axis_rx_data_TVALID out_vld 1 1 } } }
