...
assign process_axis_block_vec[2] = idx3_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 ipv4_top_hls_deadlock_idx1_monitor ipv4_top_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 ipv4_top_hls_deadlock_idx4_monitor ipv4_top_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
