...
set portList { 
	...
	{ dataStreamBuffer1_num_data_valid sc_in sc_lv 6 signal 0 } 
	{ dataStreamBuffer1_fifo_cap sc_in sc_lv 6 signal 0 } 
	...
	{ checksumFifo_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ checksumFifo_fifo_cap sc_in sc_lv 5 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "checksumFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "checksumFifo", "role": "num_data_valid" }} , 
 	{ "name": "checksumFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "checksumFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	dataStreamBuffer1 { ap_fifo {  { dataStreamBuffer1_dout fifo_port_we 0 1024 }  { dataStreamBuffer1_num_data_valid fifo_status_num_data_valid 0 6 }  { dataStreamBuffer1_fifo_cap fifo_update 0 6 }  { dataStreamBuffer1_empty_n fifo_status 0 1 }  { dataStreamBuffer1_read fifo_data 1 1 } } }
	checksumFifo { ap_fifo {  { checksumFifo_dout fifo_port_we 0 16 }  { checksumFifo_num_data_valid fifo_status_num_data_valid 0 5 }  { checksumFifo_fifo_cap fifo_update 0 5 }  { checksumFifo_empty_n fifo_status 0 1 }  { checksumFifo_read fifo_data 1 1 } } }
	dataStreamBuffer2 { ap_fifo {  { dataStreamBuffer2_din fifo_port_we 1 1024 }  { dataStreamBuffer2_num_data_valid fifo_status_num_data_valid 0 2 }  { dataStreamBuffer2_fifo_cap fifo_update 0 2 }  { dataStreamBuffer2_full_n fifo_status 0 1 }  { dataStreamBuffer2_write fifo_data 1 1 } } }
}
