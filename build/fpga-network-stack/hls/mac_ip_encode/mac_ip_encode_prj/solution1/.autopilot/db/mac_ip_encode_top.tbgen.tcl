...
set C_modelArgList {
	...
	{ m_axis_ip int 1024 regular {axi_s 1 volatile  { m_axis_ip Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_ip", "interface" : "axis", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "m_axis_ip", "interface" : "axis", "bitwidth" : 1024, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ s_axis_arp_lookup_reply_TDATA sc_in sc_lv 128 signal 1 } 
	{ m_axis_ip_TDATA sc_out sc_lv 1024 signal 2 } 
	{ m_axis_arp_lookup_request_TDATA sc_out sc_lv 32 signal 3 } 
	...
	{ m_axis_arp_lookup_request_TVALID sc_out sc_logic 1 outvld 3 } 
	{ m_axis_arp_lookup_request_TREADY sc_in sc_logic 1 outacc 3 } 
	{ s_axis_arp_lookup_reply_TVALID sc_in sc_logic 1 invld 1 } 
	{ s_axis_arp_lookup_reply_TREADY sc_out sc_logic 1 inacc 1 } 
...
set NewPortList {[ 
	{ "name": "s_axis_ip_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "s_axis_ip", "role": "TDATA" }} , 
 	...
 	{ "name": "m_axis_ip_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "m_axis_ip", "role": "TDATA" }} , 
 	...
 	{ "name": "m_axis_ip_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "m_axis_ip", "role": "TVALID" }} , 
 	{ "name": "m_axis_ip_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "m_axis_ip", "role": "TREADY" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "5", "6", "7", "8", "10", "11", "13", "14", "15", "16", "17", "18", "19", "20"],
		...
		"IsBlackBox" : "0",
		"InputProcess" : [
			{"ID" : "1", "Name" : "extract_ip_address_512_U0"}],
		"OutputProcess" : [
			{"ID" : "11", "Name" : "insert_ethernet_header_512_U0"}],
		"Port" : [
			{"Name" : "s_axis_ip", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "s_axis_ip"}]},
			{"Name" : "s_axis_arp_lookup_reply", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_arp_reply_512_U0", "Port" : "s_axis_arp_lookup_reply"}]},
			{"Name" : "m_axis_ip", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "insert_ethernet_header_512_U0", "Port" : "m_axis_ip"}]},
			{"Name" : "m_axis_arp_lookup_request", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "m_axis_arp_lookup_request"}]},
			...
			{"Name" : "header_ready", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "header_ready"}]},
			{"Name" : "header_header_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "header_header_V"}]},
			{"Name" : "header_idx", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "header_idx"}]},
			{"Name" : "dataStreamBuffer0", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "dataStreamBuffer0"},
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "dataStreamBuffer0"}]},
			{"Name" : "metaWritten", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "extract_ip_address_512_U0", "Port" : "metaWritten"}]},
			{"Name" : "dataStreamBuffer1", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "insert_ip_checksum_512_U0", "Port" : "dataStreamBuffer1"},
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "dataStreamBuffer1"}]},
			{"Name" : "cics_firstWord", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_firstWord"}]},
			{"Name" : "cics_ip_sums_sum_V_0", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_0"}]},
			{"Name" : "cics_ip_sums_sum_V_1", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_1"}]},
			{"Name" : "cics_ip_sums_sum_V_2", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_2"}]},
			{"Name" : "cics_ip_sums_sum_V_3", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_3"}]},
			{"Name" : "cics_ip_sums_sum_V_4", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_4"}]},
			{"Name" : "cics_ip_sums_sum_V_6", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_6"}]},
			{"Name" : "cics_ip_sums_sum_V_7", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_7"}]},
			{"Name" : "cics_ip_sums_sum_V_8", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_8"}]},
			{"Name" : "cics_ip_sums_sum_V_9", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_9"}]},
			{"Name" : "cics_ip_sums_sum_V_10", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_10"}]},
			{"Name" : "cics_ip_sums_sum_V_11", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_11"}]},
			{"Name" : "cics_ip_sums_sum_V_12", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_12"}]},
			{"Name" : "cics_ip_sums_sum_V_13", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_13"}]},
			{"Name" : "cics_ip_sums_sum_V_14", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_14"}]},
			{"Name" : "cics_ip_sums_sum_V_15", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_15"}]},
			{"Name" : "cics_ip_sums_sum_V_16", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_16"}]},
			{"Name" : "cics_ip_sums_sum_V_17", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_17"}]},
			{"Name" : "cics_ip_sums_sum_V_18", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_18"}]},
			{"Name" : "cics_ip_sums_sum_V_19", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_19"}]},
			{"Name" : "cics_ip_sums_sum_V_20", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_20"}]},
			{"Name" : "cics_ip_sums_sum_V_21", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_21"}]},
			{"Name" : "cics_ip_sums_sum_V_22", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_22"}]},
			{"Name" : "cics_ip_sums_sum_V_23", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_23"}]},
			{"Name" : "cics_ip_sums_sum_V_24", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_24"}]},
			{"Name" : "cics_ip_sums_sum_V_25", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_25"}]},
			{"Name" : "cics_ip_sums_sum_V_26", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_26"}]},
			{"Name" : "cics_ip_sums_sum_V_27", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_27"}]},
			{"Name" : "cics_ip_sums_sum_V_28", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_28"}]},
			{"Name" : "cics_ip_sums_sum_V_29", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "cics_ip_sums_sum_V_29"}]},
			{"Name" : "subSumFifo", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "mac_finalize_ipv4_checksum_32_U0", "Port" : "subSumFifo"},
					{"ID" : "5", "SubInstance" : "mac_compute_ipv4_checksum_U0", "Port" : "subSumFifo"}]},
			{"Name" : "checksumFifo", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "insert_ip_checksum_512_U0", "Port" : "checksumFifo"},
					{"ID" : "6", "SubInstance" : "mac_finalize_ipv4_checksum_32_U0", "Port" : "checksumFifo"}]},
			{"Name" : "wordCount_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "insert_ip_checksum_512_U0", "Port" : "wordCount_V"}]},
			{"Name" : "dataStreamBuffer2", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_arp_reply_512_U0", "Port" : "dataStreamBuffer2"},
					{"ID" : "7", "SubInstance" : "insert_ip_checksum_512_U0", "Port" : "dataStreamBuffer2"}]},
			{"Name" : "har_state", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_arp_reply_512_U0", "Port" : "har_state"}]},
			{"Name" : "headerFifo", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_arp_reply_512_U0", "Port" : "headerFifo"},
					{"ID" : "11", "SubInstance" : "insert_ethernet_header_512_U0", "Port" : "headerFifo"}]},
			{"Name" : "dataStreamBuffer3", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_arp_reply_512_U0", "Port" : "dataStreamBuffer3"},
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "dataStreamBuffer3"}]},
			{"Name" : "ls_writeRemainder", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "ls_writeRemainder"}]},
			{"Name" : "prevWord_data_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "prevWord_data_V"}]},
			{"Name" : "prevWord_keep_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "prevWord_keep_V"}]},
			{"Name" : "dataStreamBuffer4", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "insert_ethernet_header_512_U0", "Port" : "dataStreamBuffer4"},
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "dataStreamBuffer4"}]},
			{"Name" : "ls_firstWord", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "mac_lshiftWordByOctet_512_1_U0", "Port" : "ls_firstWord"}]},
			{"Name" : "ge_state", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "insert_ethernet_header_512_U0", "Port" : "ge_state"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.extract_ip_address_512_U0", "Parent" : "0", "Child" : ["2", "3", "4"],
		...
		"Port" : [
			...
			{"Name" : "header_ready", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "call_ln70_clear_fu_171", "Port" : "header_ready"}]},
			{"Name" : "header_header_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "header_idx", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "call_ln70_clear_fu_171", "Port" : "header_idx"}]},
			{"Name" : "dataStreamBuffer0", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["5"], "DependentChan" : "13", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "metaWritten", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.extract_ip_address_512_U0.call_ln70_clear_fu_171", "Parent" : "1",
		"CDFG" : "clear",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.extract_ip_address_512_U0.regslice_both_s_axis_ip_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.extract_ip_address_512_U0.regslice_both_m_axis_arp_lookup_request_U", "Parent" : "1"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_compute_ipv4_checksum_U0", "Parent" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "dataStreamBuffer0", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1"], "DependentChan" : "13", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer0_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dataStreamBuffer1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["7"], "DependentChan" : "14", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "cics_ip_sums_sum_V_28", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "cics_ip_sums_sum_V_29", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "subSumFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["6"], "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "subSumFifo_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_finalize_ipv4_checksum_32_U0", "Parent" : "0",
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "subSumFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "15", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "subSumFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "checksumFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["7"], "DependentChan" : "16", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "checksumFifo_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.insert_ip_checksum_512_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "wordCount_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "dataStreamBuffer1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["5"], "DependentChan" : "14", "DependentChanDepth" : "32", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "checksumFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["6"], "DependentChan" : "16", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "checksumFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dataStreamBuffer2", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["8"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer2_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.handle_arp_reply_512_U0", "Parent" : "0", "Child" : ["9"],
		...
		"Port" : [
			...
			{"Name" : "myMacAddress", "Type" : "Stable", "Direction" : "I"},
			{"Name" : "har_state", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "dataStreamBuffer2", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer2_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "headerFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "headerFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dataStreamBuffer3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "19", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer3_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_arp_reply_512_U0.regslice_both_s_axis_arp_lookup_reply_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_lshiftWordByOctet_512_1_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "prevWord_data_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "prevWord_keep_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "dataStreamBuffer4", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["11"], "DependentChan" : "20", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer4_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dataStreamBuffer3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "19", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer3_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ls_firstWord", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.insert_ethernet_header_512_U0", "Parent" : "0", "Child" : ["12"],
		...
		"Port" : [
			...
			{"Name" : "ge_state", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "headerFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["8"], "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "headerFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "dataStreamBuffer4", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["10"], "DependentChan" : "20", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "dataStreamBuffer4_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.insert_ethernet_header_512_U0.regslice_both_m_axis_ip_U", "Parent" : "11"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataStreamBuffer0_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataStreamBuffer1_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.subSumFifo_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.checksumFifo_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataStreamBuffer2_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.headerFifo_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataStreamBuffer3_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataStreamBuffer4_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	mac_ip_encode_top {
		...
		m_axis_ip {Type O LastRead -1 FirstWrite 1}
...
set Spec2ImplPortList { 
	s_axis_ip { axis {  { s_axis_ip_TDATA in_data 0 1024 }  { s_axis_ip_TVALID in_vld 0 1 }  { s_axis_ip_TREADY in_acc 1 1 } } }
	s_axis_arp_lookup_reply { axis {  { s_axis_arp_lookup_reply_TDATA in_data 0 128 }  { s_axis_arp_lookup_reply_TVALID in_vld 0 1 }  { s_axis_arp_lookup_reply_TREADY in_acc 1 1 } } }
	m_axis_ip { axis {  { m_axis_ip_TDATA out_data 1 1024 }  { m_axis_ip_TVALID out_vld 1 1 }  { m_axis_ip_TREADY out_acc 0 1 } } }
