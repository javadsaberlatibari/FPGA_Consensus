set SynModuleInfo {
  {SRCNAME clear MODELNAME clear RTLNAME mac_ip_encode_top_clear}
  ...
  {SRCNAME mac_ip_encode_top MODELNAME mac_ip_encode_top RTLNAME mac_ip_encode_top IS_TOP 1
    SUBMODULES {
      {MODELNAME mac_ip_encode_top_fifo_w1024_d2_S RTLNAME mac_ip_encode_top_fifo_w1024_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME mac_ip_encode_top_fifo_w1024_d32_A RTLNAME mac_ip_encode_top_fifo_w1024_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME mac_ip_encode_top_fifo_w16_d16_S RTLNAME mac_ip_encode_top_fifo_w16_d16_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME mac_ip_encode_top_fifo_w256_d2_S RTLNAME mac_ip_encode_top_fifo_w256_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
    }
  }
}
