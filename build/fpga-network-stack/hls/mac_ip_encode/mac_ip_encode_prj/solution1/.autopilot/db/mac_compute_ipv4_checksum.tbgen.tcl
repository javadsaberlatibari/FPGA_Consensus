...
set portList { 
	...
	{ dataStreamBuffer0_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ dataStreamBuffer0_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ dataStreamBuffer1_num_data_valid sc_in sc_lv 6 signal 1 } 
	{ dataStreamBuffer1_fifo_cap sc_in sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dataStreamBuffer1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "dataStreamBuffer1", "role": "num_data_valid" }} , 
 	{ "name": "dataStreamBuffer1_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "dataStreamBuffer1", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	dataStreamBuffer0 { ap_fifo {  { dataStreamBuffer0_dout fifo_port_we 0 1024 }  { dataStreamBuffer0_num_data_valid fifo_status_num_data_valid 0 2 }  { dataStreamBuffer0_fifo_cap fifo_update 0 2 }  { dataStreamBuffer0_empty_n fifo_status 0 1 }  { dataStreamBuffer0_read fifo_data 1 1 } } }
	dataStreamBuffer1 { ap_fifo {  { dataStreamBuffer1_din fifo_port_we 1 1024 }  { dataStreamBuffer1_num_data_valid fifo_status_num_data_valid 0 6 }  { dataStreamBuffer1_fifo_cap fifo_update 0 6 }  { dataStreamBuffer1_full_n fifo_status 0 1 }  { dataStreamBuffer1_write fifo_data 1 1 } } }
