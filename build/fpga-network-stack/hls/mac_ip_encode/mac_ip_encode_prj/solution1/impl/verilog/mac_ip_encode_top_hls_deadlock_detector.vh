    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 0, 1, 1) mac_ip_encode_top_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~extract_ip_address_512_U0.dataStreamBuffer0_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 1, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~mac_compute_ipv4_checksum_U0.dataStreamBuffer0_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~mac_compute_ipv4_checksum_U0.dataStreamBuffer1_blk_n);
    ...
    assign proc_1_data_FIFO_blk[2] = 1'b0 | (~mac_compute_ipv4_checksum_U0.subSumFifo_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 2, 2, 2) mac_ip_encode_top_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~mac_finalize_ipv4_checksum_32_U0.subSumFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~mac_finalize_ipv4_checksum_32_U0.checksumFifo_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 3, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~insert_ip_checksum_512_U0.dataStreamBuffer1_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~insert_ip_checksum_512_U0.checksumFifo_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~insert_ip_checksum_512_U0.dataStreamBuffer2_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 4, 3, 3) mac_ip_encode_top_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~handle_arp_reply_512_U0.dataStreamBuffer2_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~handle_arp_reply_512_U0.headerFifo_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~handle_arp_reply_512_U0.dataStreamBuffer3_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 5, 2, 2) mac_ip_encode_top_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~mac_lshiftWordByOctet_512_1_U0.dataStreamBuffer4_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~mac_lshiftWordByOctet_512_1_U0.dataStreamBuffer3_blk_n);
    ...
    mac_ip_encode_top_hls_deadlock_detect_unit #(7, 6, 2, 2) mac_ip_encode_top_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~insert_ethernet_header_512_U0.headerFifo_blk_n);
    ...
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~insert_ethernet_header_512_U0.dataStreamBuffer4_blk_n);
