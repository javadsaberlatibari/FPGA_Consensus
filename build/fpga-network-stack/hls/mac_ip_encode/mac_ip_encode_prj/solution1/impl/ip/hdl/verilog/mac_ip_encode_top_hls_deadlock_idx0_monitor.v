...
assign process_axis_block_vec[4] = idx2_block & (1'b0 | axis_block_sigs[2]);
...
assign process_axis_block_vec[6] = idx3_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 mac_ip_encode_top_hls_deadlock_idx1_monitor mac_ip_encode_top_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
