...
attribute shreg_extract : string;
    ...
    signal tmp_6_i_nbreadreq_fu_84_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_6_i_reg_331 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln674_reg_338 : STD_LOGIC_VECTOR (399 downto 0);
    signal tmp_i7_reg_344 : STD_LOGIC_VECTOR (49 downto 0);
    ...
    signal zext_ln174_1_fu_299_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal zext_ln174_fu_322_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal tmp_1_i8_fu_194_p4 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal select_ln1139_fu_280_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal sendWord_data_V_2_fu_272_p3 : STD_LOGIC_VECTOR (511 downto 0);
    signal or_ln174_3_i_fu_288_p5 : STD_LOGIC_VECTOR (577 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_6_i_reg_331 = ap_const_lv1_1) and (ls_writeRemainder_load_reg_327 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_6_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_6_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                sendWord_last_V_reg_350 <= sendWord_last_V_fu_204_p2;
                tmp_i7_reg_344 <= dataStreamBuffer3_dout(561 downto 512);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ls_writeRemainder = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_6_i_reg_331 <= tmp_6_i_nbreadreq_fu_84_p3;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, ap_done_reg, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (dataStreamBuffer3_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, ap_done_reg, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (dataStreamBuffer3_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, dataStreamBuffer3_empty_n, ap_predicate_op18_read_state1, ap_done_reg, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)))) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((ap_predicate_op18_read_state1 = ap_const_boolean_1) and (dataStreamBuffer3_empty_n = ap_const_logic_0)))));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (((ls_writeRemainder_load_reg_327 = ap_const_lv1_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)) or ((ap_predicate_op47_write_state2 = ap_const_boolean_1) and (dataStreamBuffer4_full_n = ap_const_logic_0)));
    end process;
    ...
    ap_condition_131_assign_proc : process(tmp_6_i_nbreadreq_fu_84_p3, ls_writeRemainder, currWord_last_V_fu_172_p3)
    begin
                ap_condition_131 <= ((tmp_6_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (currWord_last_V_fu_172_p3 = ap_const_lv1_1));
    end process;


    ap_condition_135_assign_proc : process(tmp_6_i_nbreadreq_fu_84_p3, ls_writeRemainder, currWord_last_V_fu_172_p3)
    begin
                ap_condition_135 <= ((tmp_6_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0) and (currWord_last_V_fu_172_p3 = ap_const_lv1_0));
    end process;
    ...
    ap_predicate_op18_read_state1_assign_proc : process(tmp_6_i_nbreadreq_fu_84_p3, ls_writeRemainder)
    begin
                ap_predicate_op18_read_state1 <= ((tmp_6_i_nbreadreq_fu_84_p3 = ap_const_lv1_1) and (ls_writeRemainder = ap_const_lv1_0));
    end process;


    ap_predicate_op47_write_state2_assign_proc : process(ls_writeRemainder_load_reg_327, tmp_6_i_reg_331)
    begin
                ap_predicate_op47_write_state2 <= ((tmp_6_i_reg_331 = ap_const_lv1_1) and (ls_writeRemainder_load_reg_327 = ap_const_lv1_0));
    end process;
    ...
    dataStreamBuffer4_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, dataStreamBuffer4_full_n, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, ap_block_pp0_stage0)
    begin
    ...
    dataStreamBuffer4_din_assign_proc : process(ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, zext_ln174_1_fu_299_p1, zext_ln174_fu_322_p1, ap_condition_156)
    begin
        if ((ap_const_boolean_1 = ap_condition_156)) then
            if ((ls_writeRemainder_load_reg_327 = ap_const_lv1_1)) then 
                dataStreamBuffer4_din <= zext_ln174_fu_322_p1;
            elsif ((ap_predicate_op47_write_state2 = ap_const_boolean_1)) then 
                dataStreamBuffer4_din <= zext_ln174_1_fu_299_p1;
            else 
    ...
    dataStreamBuffer4_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ls_writeRemainder_load_reg_327, ap_predicate_op47_write_state2, ap_block_pp0_stage0_11001)
    begin
    ...
    or_ln174_3_i_fu_288_p5 <= (((ap_const_lv1_0 & sendWord_last_V_reg_350) & select_ln1139_fu_280_p3) & sendWord_data_V_2_fu_272_p3);
    p_Result_1_fu_251_p3 <= (tmp_i7_reg_344 & ap_const_lv14_3FFF);
    p_Result_2_fu_258_p3 <= (trunc_ln674_reg_338 & reg_136);
    p_Result_3_fu_265_p3 <= (tmp_i7_reg_344 & reg_140);
    p_Result_s_fu_244_p3 <= (trunc_ln674_reg_338 & ap_const_lv112_0);
    select_ln1139_fu_280_p3 <= 
    ...
    sendWord_last_V_fu_204_p2 <= "1" when (tmp_1_i8_fu_194_p4 = ap_const_lv14_0) else "0";
    tmp_1_i8_fu_194_p4 <= dataStreamBuffer3_dout(575 downto 562);
    tmp_6_i_nbreadreq_fu_84_p3 <= (0=>(dataStreamBuffer3_empty_n), others=>'-');
    ...
    zext_ln174_1_fu_299_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(or_ln174_3_i_fu_288_p5),1024));
    zext_ln174_cast_fu_310_p5 <= (((ap_const_lv51_4000000000000 & reg_140) & ap_const_lv400_lc_3) & reg_136);
