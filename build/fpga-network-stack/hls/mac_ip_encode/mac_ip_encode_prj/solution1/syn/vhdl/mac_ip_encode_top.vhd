...
architecture behav of mac_ip_encode_top is 
    ...
    "mac_ip_encode_top_mac_ip_encode_top,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.389438,HLS_SYN_LAT=18,HLS_SYN_TPT=2,HLS_SYN_MEM=29,HLS_SYN_DSP=0,HLS_SYN_FF=22297,HLS_SYN_LUT=15511,HLS_VERSION=2022_1}";
    ...
    signal extract_ip_address_512_U0_s_axis_ip_TREADY : STD_LOGIC;
    ...
    signal insert_ethernet_header_512_U0_m_axis_ip_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal insert_ethernet_header_512_U0_m_axis_ip_TVALID : STD_LOGIC;
    signal dataStreamBuffer0_full_n : STD_LOGIC;
    signal dataStreamBuffer0_dout : STD_LOGIC_VECTOR (1023 downto 0);
    signal dataStreamBuffer0_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal dataStreamBuffer0_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal dataStreamBuffer1_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal dataStreamBuffer1_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal checksumFifo_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal checksumFifo_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal dataStreamBuffer2_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal dataStreamBuffer2_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal headerFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal headerFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal dataStreamBuffer3_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal dataStreamBuffer3_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal dataStreamBuffer4_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal dataStreamBuffer4_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    ...
    port map (
        ...
        dataStreamBuffer0_num_data_valid => dataStreamBuffer0_num_data_valid,
        dataStreamBuffer0_fifo_cap => dataStreamBuffer0_fifo_cap,
        ...
        s_axis_ip_TREADY => extract_ip_address_512_U0_s_axis_ip_TREADY,
    ...
    port map (
        ...
        dataStreamBuffer1_num_data_valid => dataStreamBuffer1_num_data_valid,
        dataStreamBuffer1_fifo_cap => dataStreamBuffer1_fifo_cap,
    ...
    port map (
        ...
        checksumFifo_num_data_valid => checksumFifo_num_data_valid,
        checksumFifo_fifo_cap => checksumFifo_fifo_cap,
    ...
    port map (
        ...
        dataStreamBuffer2_num_data_valid => dataStreamBuffer2_num_data_valid,
        dataStreamBuffer2_fifo_cap => dataStreamBuffer2_fifo_cap,
    ...
    port map (
        ...
        dataStreamBuffer3_num_data_valid => dataStreamBuffer3_num_data_valid,
        dataStreamBuffer3_fifo_cap => dataStreamBuffer3_fifo_cap,
        ...
        headerFifo_num_data_valid => headerFifo_num_data_valid,
        headerFifo_fifo_cap => headerFifo_fifo_cap,
    ...
    port map (
        ...
        dataStreamBuffer4_num_data_valid => dataStreamBuffer4_num_data_valid,
        dataStreamBuffer4_fifo_cap => dataStreamBuffer4_fifo_cap,
    ...
    port map (
        ...
        m_axis_ip_TDATA => insert_ethernet_header_512_U0_m_axis_ip_TDATA,
        m_axis_ip_TVALID => insert_ethernet_header_512_U0_m_axis_ip_TVALID);
    ...
    port map (
        ...
        if_num_data_valid => dataStreamBuffer0_num_data_valid,
        if_fifo_cap => dataStreamBuffer0_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => dataStreamBuffer1_num_data_valid,
        if_fifo_cap => dataStreamBuffer1_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => checksumFifo_num_data_valid,
        if_fifo_cap => checksumFifo_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => dataStreamBuffer2_num_data_valid,
        if_fifo_cap => dataStreamBuffer2_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => headerFifo_num_data_valid,
        if_fifo_cap => headerFifo_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => dataStreamBuffer3_num_data_valid,
        if_fifo_cap => dataStreamBuffer3_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => dataStreamBuffer4_num_data_valid,
        if_fifo_cap => dataStreamBuffer4_fifo_cap,
