    ...
    dhcp_client_hls_deadlock_detect_unit #(4, 0, 1, 1) dhcp_client_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~open_dhcp_port_U0.portOpen_blk_n);
    ...
    dhcp_client_hls_deadlock_detect_unit #(4, 1, 1, 1) dhcp_client_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~receive_message_U0.dhcp_replyMetaFifo_blk_n);
    ...
    // Process: dhcp_fsm_U0
    dhcp_client_hls_deadlock_detect_unit #(4, 2, 3, 3) dhcp_client_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~dhcp_fsm_U0.portOpen_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~dhcp_fsm_U0.dhcp_requestMetaFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~dhcp_fsm_U0.dhcp_replyMetaFifo_blk_n);
    ...
    dhcp_client_hls_deadlock_detect_unit #(4, 3, 1, 1) dhcp_client_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~send_message_U0.dhcp_requestMetaFifo_blk_n);
