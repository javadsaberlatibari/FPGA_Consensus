...
set portList { 
	...
	{ portOpen_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ portOpen_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set Spec2ImplPortList { 
	...
	portOpen { ap_fifo {  { portOpen_din fifo_port_we 1 1 }  { portOpen_num_data_valid fifo_status_num_data_valid 0 2 }  { portOpen_fifo_cap fifo_update 0 2 }  { portOpen_full_n fifo_status 0 1 }  { portOpen_write fifo_data 1 1 } } }
}
