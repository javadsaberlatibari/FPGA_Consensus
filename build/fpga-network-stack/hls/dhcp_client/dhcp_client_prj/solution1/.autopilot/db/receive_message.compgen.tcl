...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dhcp_replyMetaFifo_din { O 128 vector } dhcp_replyMetaFifo_num_data_valid { I 3 vector } dhcp_replyMetaFifo_fifo_cap { I 3 vector } dhcp_replyMetaFifo_full_n { I 1 bit } dhcp_replyMetaFifo_write { O 1 bit } } \
} "
}
