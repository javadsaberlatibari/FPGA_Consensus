set SynModuleInfo {
  ...
  {SRCNAME dhcp_client MODELNAME dhcp_client RTLNAME dhcp_client IS_TOP 1
    SUBMODULES {
      {MODELNAME dhcp_client_fifo_w1_d2_S RTLNAME dhcp_client_fifo_w1_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME dhcp_client_fifo_w128_d4_S RTLNAME dhcp_client_fifo_w128_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME dhcp_client_fifo_w96_d4_S RTLNAME dhcp_client_fifo_w96_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
    }
  }
}
