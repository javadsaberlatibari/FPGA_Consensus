...
set portList { 
	...
	{ rxEng_dataBuffer2_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ rxEng_dataBuffer2_fifo_cap sc_in sc_lv 9 signal 0 } 
	...
	{ rxEng_checksumValidFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ rxEng_checksumValidFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ rxEng_headerMetaFifo_num_data_valid sc_in sc_lv 5 signal 3 } 
	{ rxEng_headerMetaFifo_fifo_cap sc_in sc_lv 5 signal 3 } 
	...
	{ rxEng2portTable_check_req_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ rxEng2portTable_check_req_fifo_cap sc_in sc_lv 3 signal 4 } 
	...
	{ rxEng_tupleBuffer_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ rxEng_tupleBuffer_fifo_cap sc_in sc_lv 2 signal 5 } 
	...
	{ rxEng_dataBuffer3a_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ rxEng_dataBuffer3a_fifo_cap sc_in sc_lv 4 signal 2 } 
	...
	{ rxEng_optionalFieldsMetaFifo_num_data_valid sc_in sc_lv 4 signal 6 } 
	{ rxEng_optionalFieldsMetaFifo_fifo_cap sc_in sc_lv 4 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer2_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "rxEng_dataBuffer2", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_dataBuffer2_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "rxEng_dataBuffer2", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng_checksumValidFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_checksumValidFifo", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_checksumValidFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_checksumValidFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng_headerMetaFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "rxEng_headerMetaFifo", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_headerMetaFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "rxEng_headerMetaFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng2portTable_check_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "rxEng2portTable_check_req", "role": "num_data_valid" }} , 
 	{ "name": "rxEng2portTable_check_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "rxEng2portTable_check_req", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng_dataBuffer3a_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer3a", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_dataBuffer3a_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer3a", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rxEng_dataBuffer2 { ap_fifo {  { rxEng_dataBuffer2_dout fifo_port_we 0 1024 }  { rxEng_dataBuffer2_num_data_valid fifo_status_num_data_valid 0 9 }  { rxEng_dataBuffer2_fifo_cap fifo_update 0 9 }  { rxEng_dataBuffer2_empty_n fifo_status 0 1 }  { rxEng_dataBuffer2_read fifo_data 1 1 } } }
	rxEng_checksumValidFifo { ap_fifo {  { rxEng_checksumValidFifo_dout fifo_port_we 0 1 }  { rxEng_checksumValidFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_checksumValidFifo_fifo_cap fifo_update 0 2 }  { rxEng_checksumValidFifo_empty_n fifo_status 0 1 }  { rxEng_checksumValidFifo_read fifo_data 1 1 } } }
	rxEng_dataBuffer3a { ap_fifo {  { rxEng_dataBuffer3a_din fifo_port_we 1 1024 }  { rxEng_dataBuffer3a_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer3a_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer3a_full_n fifo_status 0 1 }  { rxEng_dataBuffer3a_write fifo_data 1 1 } } }
	rxEng_headerMetaFifo { ap_fifo {  { rxEng_headerMetaFifo_din fifo_port_we 1 160 }  { rxEng_headerMetaFifo_num_data_valid fifo_status_num_data_valid 0 5 }  { rxEng_headerMetaFifo_fifo_cap fifo_update 0 5 }  { rxEng_headerMetaFifo_full_n fifo_status 0 1 }  { rxEng_headerMetaFifo_write fifo_data 1 1 } } }
	rxEng2portTable_check_req { ap_fifo {  { rxEng2portTable_check_req_din fifo_port_we 1 16 }  { rxEng2portTable_check_req_num_data_valid fifo_status_num_data_valid 0 3 }  { rxEng2portTable_check_req_fifo_cap fifo_update 0 3 }  { rxEng2portTable_check_req_full_n fifo_status 0 1 }  { rxEng2portTable_check_req_write fifo_data 1 1 } } }
	rxEng_tupleBuffer { ap_fifo {  { rxEng_tupleBuffer_din fifo_port_we 1 96 }  { rxEng_tupleBuffer_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_tupleBuffer_fifo_cap fifo_update 0 2 }  { rxEng_tupleBuffer_full_n fifo_status 0 1 }  { rxEng_tupleBuffer_write fifo_data 1 1 } } }
	rxEng_optionalFieldsMetaFifo { ap_fifo {  { rxEng_optionalFieldsMetaFifo_din fifo_port_we 1 16 }  { rxEng_optionalFieldsMetaFifo_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_optionalFieldsMetaFifo_fifo_cap fifo_update 0 4 }  { rxEng_optionalFieldsMetaFifo_full_n fifo_status 0 1 }  { rxEng_optionalFieldsMetaFifo_write fifo_data 1 1 } } }
}
