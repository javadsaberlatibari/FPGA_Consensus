...
set portList { 
	...
	{ rxEng_headerMetaFifo_num_data_valid sc_in sc_lv 5 signal 0 } 
	{ rxEng_headerMetaFifo_fifo_cap sc_in sc_lv 5 signal 0 } 
	...
	{ rxEng_winScaleFifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ rxEng_winScaleFifo_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ rxEng_metaDataFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ rxEng_metaDataFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_winScaleFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_winScaleFifo", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_winScaleFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_winScaleFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rxEng_headerMetaFifo { ap_fifo {  { rxEng_headerMetaFifo_dout fifo_port_we 0 160 }  { rxEng_headerMetaFifo_num_data_valid fifo_status_num_data_valid 0 5 }  { rxEng_headerMetaFifo_fifo_cap fifo_update 0 5 }  { rxEng_headerMetaFifo_empty_n fifo_status 0 1 }  { rxEng_headerMetaFifo_read fifo_data 1 1 } } }
	rxEng_metaDataFifo { ap_fifo {  { rxEng_metaDataFifo_din fifo_port_we 1 160 }  { rxEng_metaDataFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_metaDataFifo_fifo_cap fifo_update 0 2 }  { rxEng_metaDataFifo_full_n fifo_status 0 1 }  { rxEng_metaDataFifo_write fifo_data 1 1 } } }
	rxEng_winScaleFifo { ap_fifo {  { rxEng_winScaleFifo_dout fifo_port_we 0 4 }  { rxEng_winScaleFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_winScaleFifo_fifo_cap fifo_update 0 2 }  { rxEng_winScaleFifo_empty_n fifo_status 0 1 }  { rxEng_winScaleFifo_read fifo_data 1 1 } } }
}
