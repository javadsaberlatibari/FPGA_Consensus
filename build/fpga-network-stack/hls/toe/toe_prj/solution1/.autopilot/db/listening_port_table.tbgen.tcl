...
set portList { 
	...
	{ rxApp2portTable_listen_req_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ rxApp2portTable_listen_req_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ pt_portCheckListening_req_fifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ pt_portCheckListening_req_fifo_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ pt_portCheckListening_rsp_fifo_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ pt_portCheckListening_rsp_fifo_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ portTable2rxApp_listen_rsp_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ portTable2rxApp_listen_rsp_fifo_cap sc_in sc_lv 3 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxApp2portTable_listen_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "rxApp2portTable_listen_req", "role": "num_data_valid" }} , 
 	{ "name": "rxApp2portTable_listen_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "rxApp2portTable_listen_req", "role": "fifo_cap" }} , 
 	...
 	{ "name": "pt_portCheckListening_req_fifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckListening_req_fifo", "role": "num_data_valid" }} , 
 	{ "name": "pt_portCheckListening_req_fifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckListening_req_fifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "pt_portCheckListening_rsp_fifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckListening_rsp_fifo", "role": "num_data_valid" }} , 
 	{ "name": "pt_portCheckListening_rsp_fifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckListening_rsp_fifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "portTable2rxApp_listen_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "portTable2rxApp_listen_rsp", "role": "num_data_valid" }} , 
 	{ "name": "portTable2rxApp_listen_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "portTable2rxApp_listen_rsp", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rxApp2portTable_listen_req { ap_fifo {  { rxApp2portTable_listen_req_dout fifo_port_we 0 16 }  { rxApp2portTable_listen_req_num_data_valid fifo_status_num_data_valid 0 3 }  { rxApp2portTable_listen_req_fifo_cap fifo_update 0 3 }  { rxApp2portTable_listen_req_empty_n fifo_status 0 1 }  { rxApp2portTable_listen_req_read fifo_data 1 1 } } }
	portTable2rxApp_listen_rsp { ap_fifo {  { portTable2rxApp_listen_rsp_din fifo_port_we 1 1 }  { portTable2rxApp_listen_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { portTable2rxApp_listen_rsp_fifo_cap fifo_update 0 3 }  { portTable2rxApp_listen_rsp_full_n fifo_status 0 1 }  { portTable2rxApp_listen_rsp_write fifo_data 1 1 } } }
	pt_portCheckListening_req_fifo { ap_fifo {  { pt_portCheckListening_req_fifo_dout fifo_port_we 0 15 }  { pt_portCheckListening_req_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckListening_req_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckListening_req_fifo_empty_n fifo_status 0 1 }  { pt_portCheckListening_req_fifo_read fifo_data 1 1 } } }
	pt_portCheckListening_rsp_fifo { ap_fifo {  { pt_portCheckListening_rsp_fifo_din fifo_port_we 1 1 }  { pt_portCheckListening_rsp_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckListening_rsp_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckListening_rsp_fifo_full_n fifo_status 0 1 }  { pt_portCheckListening_rsp_fifo_write fifo_data 1 1 } } }
}
