...
set portList { 
	...
	{ rtTimer2eventEng_setEvent_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ rtTimer2eventEng_setEvent_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ probeTimer2eventEng_setEvent_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ probeTimer2eventEng_setEvent_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ timer2eventEng_setEvent_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ timer2eventEng_setEvent_fifo_cap sc_in sc_lv 7 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rtTimer2eventEng_setEvent_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rtTimer2eventEng_setEvent", "role": "num_data_valid" }} , 
 	{ "name": "rtTimer2eventEng_setEvent_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rtTimer2eventEng_setEvent", "role": "fifo_cap" }} , 
 	...
 	{ "name": "probeTimer2eventEng_setEvent_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "probeTimer2eventEng_setEvent", "role": "num_data_valid" }} , 
 	{ "name": "probeTimer2eventEng_setEvent_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "probeTimer2eventEng_setEvent", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rtTimer2eventEng_setEvent { ap_fifo {  { rtTimer2eventEng_setEvent_dout fifo_port_we 0 128 }  { rtTimer2eventEng_setEvent_num_data_valid fifo_status_num_data_valid 0 2 }  { rtTimer2eventEng_setEvent_fifo_cap fifo_update 0 2 }  { rtTimer2eventEng_setEvent_empty_n fifo_status 0 1 }  { rtTimer2eventEng_setEvent_read fifo_data 1 1 } } }
	timer2eventEng_setEvent { ap_fifo {  { timer2eventEng_setEvent_din fifo_port_we 1 128 }  { timer2eventEng_setEvent_num_data_valid fifo_status_num_data_valid 0 7 }  { timer2eventEng_setEvent_fifo_cap fifo_update 0 7 }  { timer2eventEng_setEvent_full_n fifo_status 0 1 }  { timer2eventEng_setEvent_write fifo_data 1 1 } } }
	probeTimer2eventEng_setEvent { ap_fifo {  { probeTimer2eventEng_setEvent_dout fifo_port_we 0 128 }  { probeTimer2eventEng_setEvent_num_data_valid fifo_status_num_data_valid 0 2 }  { probeTimer2eventEng_setEvent_fifo_cap fifo_update 0 2 }  { probeTimer2eventEng_setEvent_empty_n fifo_status 0 1 }  { probeTimer2eventEng_setEvent_read fifo_data 1 1 } } }
}
