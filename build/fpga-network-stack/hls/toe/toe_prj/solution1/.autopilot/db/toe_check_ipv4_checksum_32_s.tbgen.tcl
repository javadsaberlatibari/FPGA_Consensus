...
set portList { 
	...
	{ subSumFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ subSumFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set Spec2ImplPortList { 
	subSumFifo { ap_fifo {  { subSumFifo_dout fifo_port_we 0 1024 }  { subSumFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { subSumFifo_fifo_cap fifo_update 0 2 }  { subSumFifo_empty_n fifo_status 0 1 }  { subSumFifo_read fifo_data 1 1 } } }
	rxEng_checksumValidFifo { ap_fifo {  { rxEng_checksumValidFifo_din fifo_port_we 1 1 }  { rxEng_checksumValidFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_checksumValidFifo_fifo_cap fifo_update 0 2 }  { rxEng_checksumValidFifo_full_n fifo_status 0 1 }  { rxEng_checksumValidFifo_write fifo_data 1 1 } } }
}
