...
set portList { 
	...
	{ txEng_tcpPkgBuffer1_num_data_valid sc_in sc_lv 5 signal 0 } 
	{ txEng_tcpPkgBuffer1_fifo_cap sc_in sc_lv 5 signal 0 } 
	...
	{ txEng_tcpPkgBuffer2_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ txEng_tcpPkgBuffer2_fifo_cap sc_in sc_lv 9 signal 1 } 
	...
	{ txEng_subChecksumsFifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ txEng_subChecksumsFifo_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer2_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer2", "role": "num_data_valid" }} , 
 	{ "name": "txEng_tcpPkgBuffer2_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer2", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txEng_subChecksumsFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_subChecksumsFifo", "role": "num_data_valid" }} , 
 	{ "name": "txEng_subChecksumsFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_subChecksumsFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer1 { ap_fifo {  { txEng_tcpPkgBuffer1_dout fifo_port_we 0 1024 }  { txEng_tcpPkgBuffer1_num_data_valid fifo_status_num_data_valid 0 5 }  { txEng_tcpPkgBuffer1_fifo_cap fifo_update 0 5 }  { txEng_tcpPkgBuffer1_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer1_read fifo_data 1 1 } } }
	txEng_tcpPkgBuffer2 { ap_fifo {  { txEng_tcpPkgBuffer2_din fifo_port_we 1 1024 }  { txEng_tcpPkgBuffer2_num_data_valid fifo_status_num_data_valid 0 9 }  { txEng_tcpPkgBuffer2_fifo_cap fifo_update 0 9 }  { txEng_tcpPkgBuffer2_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer2_write fifo_data 1 1 } } }
	txEng_subChecksumsFifo { ap_fifo {  { txEng_subChecksumsFifo_din fifo_port_we 1 1024 }  { txEng_subChecksumsFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_subChecksumsFifo_fifo_cap fifo_update 0 2 }  { txEng_subChecksumsFifo_full_n fifo_status 0 1 }  { txEng_subChecksumsFifo_write fifo_data 1 1 } } }
}
