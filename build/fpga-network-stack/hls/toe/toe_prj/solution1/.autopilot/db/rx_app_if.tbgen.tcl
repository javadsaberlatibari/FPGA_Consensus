...
set portList { 
	...
	{ portTable2rxApp_listen_rsp_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ portTable2rxApp_listen_rsp_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ rxApp2portTable_listen_req_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ rxApp2portTable_listen_req_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set Spec2ImplPortList { 
	...
	rxApp2portTable_listen_req { ap_fifo {  { rxApp2portTable_listen_req_din fifo_port_we 1 16 }  { rxApp2portTable_listen_req_num_data_valid fifo_status_num_data_valid 0 3 }  { rxApp2portTable_listen_req_fifo_cap fifo_update 0 3 }  { rxApp2portTable_listen_req_full_n fifo_status 0 1 }  { rxApp2portTable_listen_req_write fifo_data 1 1 } } }
	portTable2rxApp_listen_rsp { ap_fifo {  { portTable2rxApp_listen_rsp_dout fifo_port_we 0 1 }  { portTable2rxApp_listen_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { portTable2rxApp_listen_rsp_fifo_cap fifo_update 0 3 }  { portTable2rxApp_listen_rsp_empty_n fifo_status 0 1 }  { portTable2rxApp_listen_rsp_read fifo_data 1 1 } } }
}
