...
set portList { 
	...
	{ sLookup2portTable_releasePort_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ sLookup2portTable_releasePort_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ pt_portCheckUsed_req_fifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ pt_portCheckUsed_req_fifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ portTable2txApp_port_rsp_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ portTable2txApp_port_rsp_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ pt_portCheckUsed_rsp_fifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ pt_portCheckUsed_rsp_fifo_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pt_portCheckUsed_req_fifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckUsed_req_fifo", "role": "num_data_valid" }} , 
 	{ "name": "pt_portCheckUsed_req_fifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckUsed_req_fifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "pt_portCheckUsed_rsp_fifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckUsed_rsp_fifo", "role": "num_data_valid" }} , 
 	{ "name": "pt_portCheckUsed_rsp_fifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "pt_portCheckUsed_rsp_fifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	sLookup2portTable_releasePort { ap_fifo {  { sLookup2portTable_releasePort_dout fifo_port_we 0 16 }  { sLookup2portTable_releasePort_num_data_valid fifo_status_num_data_valid 0 3 }  { sLookup2portTable_releasePort_fifo_cap fifo_update 0 3 }  { sLookup2portTable_releasePort_empty_n fifo_status 0 1 }  { sLookup2portTable_releasePort_read fifo_data 1 1 } } }
	pt_portCheckUsed_req_fifo { ap_fifo {  { pt_portCheckUsed_req_fifo_dout fifo_port_we 0 15 }  { pt_portCheckUsed_req_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckUsed_req_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckUsed_req_fifo_empty_n fifo_status 0 1 }  { pt_portCheckUsed_req_fifo_read fifo_data 1 1 } } }
	pt_portCheckUsed_rsp_fifo { ap_fifo {  { pt_portCheckUsed_rsp_fifo_din fifo_port_we 1 1 }  { pt_portCheckUsed_rsp_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckUsed_rsp_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckUsed_rsp_fifo_full_n fifo_status 0 1 }  { pt_portCheckUsed_rsp_fifo_write fifo_data 1 1 } } }
	portTable2txApp_port_rsp { ap_fifo {  { portTable2txApp_port_rsp_din fifo_port_we 1 16 }  { portTable2txApp_port_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { portTable2txApp_port_rsp_fifo_cap fifo_update 0 3 }  { portTable2txApp_port_rsp_full_n fifo_status 0 1 }  { portTable2txApp_port_rsp_write fifo_data 1 1 } } }
}
