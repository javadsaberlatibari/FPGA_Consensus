...
set C_modelArgList {
	...
	{ conEstablishedFifo int 32 regular {fifo 0 volatile } {global 0}  }
	{ timer2txApp_notification int 32 regular {fifo 0 volatile } {global 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_open_conn_req", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conEstablishedFifo", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "timer2txApp_notification", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} , 
...
set portList { 
	...
	{ portTable2txApp_port_rsp_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ portTable2txApp_port_rsp_fifo_cap sc_in sc_lv 3 signal 4 } 
	...
	{ timer2txApp_notification_dout sc_in sc_lv 32 signal 10 } 
	{ timer2txApp_notification_num_data_valid sc_in sc_lv 3 signal 10 } 
	{ timer2txApp_notification_fifo_cap sc_in sc_lv 3 signal 10 } 
	{ timer2txApp_notification_empty_n sc_in sc_logic 1 signal 10 } 
	{ timer2txApp_notification_read sc_out sc_logic 1 signal 10 } 
	{ conEstablishedFifo_dout sc_in sc_lv 32 signal 9 } 
	{ conEstablishedFifo_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ conEstablishedFifo_fifo_cap sc_in sc_lv 3 signal 9 } 
	...
	{ sLookup2txApp_rsp_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ sLookup2txApp_rsp_fifo_cap sc_in sc_lv 3 signal 6 } 
	...
	{ stateTable2txApp_upd_rsp_num_data_valid sc_in sc_lv 2 signal 11 } 
	{ stateTable2txApp_upd_rsp_fifo_cap sc_in sc_lv 2 signal 11 } 
	...
	{ txApp2sLookup_req_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ txApp2sLookup_req_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ txApp2stateTable_upd_req_num_data_valid sc_in sc_lv 2 signal 8 } 
	{ txApp2stateTable_upd_req_fifo_cap sc_in sc_lv 2 signal 8 } 
	...
	{ txApp2eventEng_mergeEvent_num_data_valid sc_in sc_lv 7 signal 7 } 
	{ txApp2eventEng_mergeEvent_fifo_cap sc_in sc_lv 7 signal 7 } 
	{ txApp2eventEng_mergeEvent_full_n sc_in sc_logic 1 signal 7 } 
	{ txApp2eventEng_mergeEvent_write sc_out sc_logic 1 signal 7 } 
	{ s_axis_open_conn_req_TDATA sc_in sc_lv 64 signal 0 } 
	...
	{ m_axis_open_conn_rsp_TDATA sc_out sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "portTable2txApp_port_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "portTable2txApp_port_rsp", "role": "num_data_valid" }} , 
 	{ "name": "portTable2txApp_port_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "portTable2txApp_port_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "timer2txApp_notification_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "timer2txApp_notification", "role": "dout" }} , 
 	{ "name": "timer2txApp_notification_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timer2txApp_notification", "role": "num_data_valid" }} , 
 	{ "name": "timer2txApp_notification_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timer2txApp_notification", "role": "fifo_cap" }} , 
 	...
 	{ "name": "conEstablishedFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conEstablishedFifo", "role": "dout" }} , 
 	...
 	{ "name": "sLookup2txApp_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sLookup2txApp_rsp", "role": "num_data_valid" }} , 
 	{ "name": "sLookup2txApp_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sLookup2txApp_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "stateTable2txApp_upd_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stateTable2txApp_upd_rsp", "role": "num_data_valid" }} , 
 	{ "name": "stateTable2txApp_upd_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stateTable2txApp_upd_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txApp2sLookup_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "txApp2sLookup_req", "role": "num_data_valid" }} , 
 	{ "name": "txApp2sLookup_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "txApp2sLookup_req", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txApp2stateTable_upd_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txApp2stateTable_upd_req", "role": "num_data_valid" }} , 
 	{ "name": "txApp2stateTable_upd_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txApp2stateTable_upd_req", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	s_axis_open_conn_req { axis {  { s_axis_open_conn_req_TVALID in_vld 0 1 }  { s_axis_open_conn_req_TDATA in_data 0 64 }  { s_axis_open_conn_req_TREADY in_acc 1 1 } } }
	...
	m_axis_open_conn_rsp { axis {  { m_axis_open_conn_rsp_TREADY out_acc 0 1 }  { m_axis_open_conn_rsp_TDATA out_data 1 32 }  { m_axis_open_conn_rsp_TVALID out_vld 1 1 } } }
	myIpAddress { ap_stable {  { myIpAddress in_data 0 32 } } }
	portTable2txApp_port_rsp { ap_fifo {  { portTable2txApp_port_rsp_dout fifo_port_we 0 16 }  { portTable2txApp_port_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { portTable2txApp_port_rsp_fifo_cap fifo_update 0 3 }  { portTable2txApp_port_rsp_empty_n fifo_status 0 1 }  { portTable2txApp_port_rsp_read fifo_data 1 1 } } }
	txApp2sLookup_req { ap_fifo {  { txApp2sLookup_req_din fifo_port_we 1 96 }  { txApp2sLookup_req_num_data_valid fifo_status_num_data_valid 0 3 }  { txApp2sLookup_req_fifo_cap fifo_update 0 3 }  { txApp2sLookup_req_full_n fifo_status 0 1 }  { txApp2sLookup_req_write fifo_data 1 1 } } }
	sLookup2txApp_rsp { ap_fifo {  { sLookup2txApp_rsp_dout fifo_port_we 0 32 }  { sLookup2txApp_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { sLookup2txApp_rsp_fifo_cap fifo_update 0 3 }  { sLookup2txApp_rsp_empty_n fifo_status 0 1 }  { sLookup2txApp_rsp_read fifo_data 1 1 } } }
	txApp2eventEng_mergeEvent { ap_fifo {  { txApp2eventEng_mergeEvent_din fifo_port_we 1 128 }  { txApp2eventEng_mergeEvent_num_data_valid fifo_status_num_data_valid 0 7 }  { txApp2eventEng_mergeEvent_fifo_cap fifo_update 0 7 }  { txApp2eventEng_mergeEvent_full_n fifo_status 0 1 }  { txApp2eventEng_mergeEvent_write fifo_data 1 1 } } }
	txApp2stateTable_upd_req { ap_fifo {  { txApp2stateTable_upd_req_din fifo_port_we 1 96 }  { txApp2stateTable_upd_req_num_data_valid fifo_status_num_data_valid 0 2 }  { txApp2stateTable_upd_req_fifo_cap fifo_update 0 2 }  { txApp2stateTable_upd_req_full_n fifo_status 0 1 }  { txApp2stateTable_upd_req_write fifo_data 1 1 } } }
	conEstablishedFifo { ap_fifo {  { conEstablishedFifo_dout fifo_port_we 0 32 }  { conEstablishedFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { conEstablishedFifo_fifo_cap fifo_update 0 3 }  { conEstablishedFifo_empty_n fifo_status 0 1 }  { conEstablishedFifo_read fifo_data 1 1 } } }
	timer2txApp_notification { ap_fifo {  { timer2txApp_notification_dout fifo_port_we 0 32 }  { timer2txApp_notification_num_data_valid fifo_status_num_data_valid 0 3 }  { timer2txApp_notification_fifo_cap fifo_update 0 3 }  { timer2txApp_notification_empty_n fifo_status 0 1 }  { timer2txApp_notification_read fifo_data 1 1 } } }
	stateTable2txApp_upd_rsp { ap_fifo {  { stateTable2txApp_upd_rsp_dout fifo_port_we 0 32 }  { stateTable2txApp_upd_rsp_num_data_valid fifo_status_num_data_valid 0 2 }  { stateTable2txApp_upd_rsp_fifo_cap fifo_update 0 2 }  { stateTable2txApp_upd_rsp_empty_n fifo_status 0 1 }  { stateTable2txApp_upd_rsp_read fifo_data 1 1 } } }
}
