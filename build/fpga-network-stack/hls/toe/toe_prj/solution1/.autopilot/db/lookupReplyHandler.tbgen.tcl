...
set portList { 
	...
	{ slc_sessionIdFreeList_num_data_valid sc_in sc_lv 15 signal 4 } 
	{ slc_sessionIdFreeList_fifo_cap sc_in sc_lv 15 signal 4 } 
	...
	{ slc_sessionInsert_rsp_num_data_valid sc_in sc_lv 3 signal 8 } 
	{ slc_sessionInsert_rsp_fifo_cap sc_in sc_lv 3 signal 8 } 
	...
	{ rxEng2sLookup_req_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ rxEng2sLookup_req_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ txApp2sLookup_req_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ txApp2sLookup_req_fifo_cap sc_in sc_lv 3 signal 2 } 
	...
	{ sessionInsert_req_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ sessionInsert_req_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ sLookup2txApp_rsp_num_data_valid sc_in sc_lv 3 signal 7 } 
	{ sLookup2txApp_rsp_fifo_cap sc_in sc_lv 3 signal 7 } 
	...
	{ reverseLupInsertFifo_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ reverseLupInsertFifo_fifo_cap sc_in sc_lv 3 signal 9 } 
	...
	{ s_axis_session_lup_rsp_TDATA sc_in sc_lv 128 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "slc_sessionIdFreeList_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "slc_sessionIdFreeList", "role": "num_data_valid" }} , 
 	{ "name": "slc_sessionIdFreeList_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "slc_sessionIdFreeList", "role": "fifo_cap" }} , 
 	...
 	{ "name": "slc_sessionInsert_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "slc_sessionInsert_rsp", "role": "num_data_valid" }} , 
 	{ "name": "slc_sessionInsert_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "slc_sessionInsert_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "sessionInsert_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sessionInsert_req", "role": "num_data_valid" }} , 
 	{ "name": "sessionInsert_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "sessionInsert_req", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	s_axis_session_lup_rsp { axis {  { s_axis_session_lup_rsp_TVALID in_vld 0 1 }  { s_axis_session_lup_rsp_TDATA in_data 0 128 }  { s_axis_session_lup_rsp_TREADY in_acc 1 1 } } }
	...
	txApp2sLookup_req { ap_fifo {  { txApp2sLookup_req_dout fifo_port_we 0 96 }  { txApp2sLookup_req_num_data_valid fifo_status_num_data_valid 0 3 }  { txApp2sLookup_req_fifo_cap fifo_update 0 3 }  { txApp2sLookup_req_empty_n fifo_status 0 1 }  { txApp2sLookup_req_read fifo_data 1 1 } } }
	rxEng2sLookup_req { ap_fifo {  { rxEng2sLookup_req_dout fifo_port_we 0 128 }  { rxEng2sLookup_req_num_data_valid fifo_status_num_data_valid 0 3 }  { rxEng2sLookup_req_fifo_cap fifo_update 0 3 }  { rxEng2sLookup_req_empty_n fifo_status 0 1 }  { rxEng2sLookup_req_read fifo_data 1 1 } } }
	slc_sessionIdFreeList { ap_fifo {  { slc_sessionIdFreeList_dout fifo_port_we 0 14 }  { slc_sessionIdFreeList_num_data_valid fifo_status_num_data_valid 0 15 }  { slc_sessionIdFreeList_fifo_cap fifo_update 0 15 }  { slc_sessionIdFreeList_empty_n fifo_status 0 1 }  { slc_sessionIdFreeList_read fifo_data 1 1 } } }
	sessionInsert_req { ap_fifo {  { sessionInsert_req_din fifo_port_we 1 160 }  { sessionInsert_req_num_data_valid fifo_status_num_data_valid 0 3 }  { sessionInsert_req_fifo_cap fifo_update 0 3 }  { sessionInsert_req_full_n fifo_status 0 1 }  { sessionInsert_req_write fifo_data 1 1 } } }
	sLookup2rxEng_rsp { ap_fifo {  { sLookup2rxEng_rsp_din fifo_port_we 1 32 }  { sLookup2rxEng_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { sLookup2rxEng_rsp_fifo_cap fifo_update 0 3 }  { sLookup2rxEng_rsp_full_n fifo_status 0 1 }  { sLookup2rxEng_rsp_write fifo_data 1 1 } } }
	sLookup2txApp_rsp { ap_fifo {  { sLookup2txApp_rsp_din fifo_port_we 1 32 }  { sLookup2txApp_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { sLookup2txApp_rsp_fifo_cap fifo_update 0 3 }  { sLookup2txApp_rsp_full_n fifo_status 0 1 }  { sLookup2txApp_rsp_write fifo_data 1 1 } } }
	slc_sessionInsert_rsp { ap_fifo {  { slc_sessionInsert_rsp_dout fifo_port_we 0 160 }  { slc_sessionInsert_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { slc_sessionInsert_rsp_fifo_cap fifo_update 0 3 }  { slc_sessionInsert_rsp_empty_n fifo_status 0 1 }  { slc_sessionInsert_rsp_read fifo_data 1 1 } } }
	reverseLupInsertFifo { ap_fifo {  { reverseLupInsertFifo_din fifo_port_we 1 96 }  { reverseLupInsertFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { reverseLupInsertFifo_fifo_cap fifo_update 0 3 }  { reverseLupInsertFifo_full_n fifo_status 0 1 }  { reverseLupInsertFifo_write fifo_data 1 1 } } }
}
