...
set portList { 
	...
	{ txEng_tcpPkgBuffer3_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ txEng_tcpPkgBuffer3_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer3 { ap_fifo {  { txEng_tcpPkgBuffer3_dout fifo_port_we 0 1024 }  { txEng_tcpPkgBuffer3_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer3_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer3_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer3_read fifo_data 1 1 } } }
	txEng_tcpPkgBuffer4 { ap_fifo {  { txEng_tcpPkgBuffer4_din fifo_port_we 1 1024 }  { txEng_tcpPkgBuffer4_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer4_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer4_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer4_write fifo_data 1 1 } } }
}
