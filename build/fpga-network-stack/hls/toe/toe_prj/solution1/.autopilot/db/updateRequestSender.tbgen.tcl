...
set portList { 
	...
	{ sessionInsert_req_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ sessionInsert_req_fifo_cap sc_in sc_lv 3 signal 2 } 
	...
	{ sessionDelete_req_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ sessionDelete_req_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ slc_sessionIdFinFifo_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ slc_sessionIdFinFifo_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ slc_sessionIdFinFifo_full_n sc_in sc_logic 1 signal 4 } 
	{ slc_sessionIdFinFifo_write sc_out sc_logic 1 signal 4 } 
	{ m_axis_session_upd_req_TDATA sc_out sc_lv 160 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "slc_sessionIdFinFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "slc_sessionIdFinFifo", "role": "num_data_valid" }} , 
 	{ "name": "slc_sessionIdFinFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "slc_sessionIdFinFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	m_axis_session_upd_req { axis {  { m_axis_session_upd_req_TREADY out_acc 0 1 }  { m_axis_session_upd_req_TDATA out_data 1 160 }  { m_axis_session_upd_req_TVALID out_vld 1 1 } } }
	regSessionCount { ap_vld {  { regSessionCount out_data 1 16 }  { regSessionCount_ap_vld out_vld 1 1 } } }
	sessionInsert_req { ap_fifo {  { sessionInsert_req_dout fifo_port_we 0 160 }  { sessionInsert_req_num_data_valid fifo_status_num_data_valid 0 3 }  { sessionInsert_req_fifo_cap fifo_update 0 3 }  { sessionInsert_req_empty_n fifo_status 0 1 }  { sessionInsert_req_read fifo_data 1 1 } } }
	sessionDelete_req { ap_fifo {  { sessionDelete_req_dout fifo_port_we 0 160 }  { sessionDelete_req_num_data_valid fifo_status_num_data_valid 0 3 }  { sessionDelete_req_fifo_cap fifo_update 0 3 }  { sessionDelete_req_empty_n fifo_status 0 1 }  { sessionDelete_req_read fifo_data 1 1 } } }
	slc_sessionIdFinFifo { ap_fifo {  { slc_sessionIdFinFifo_din fifo_port_we 1 14 }  { slc_sessionIdFinFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { slc_sessionIdFinFifo_fifo_cap fifo_update 0 2 }  { slc_sessionIdFinFifo_full_n fifo_status 0 1 }  { slc_sessionIdFinFifo_write fifo_data 1 1 } } }
}
