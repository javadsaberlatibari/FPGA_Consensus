...
set portList { 
	...
	{ txEng_tupleShortCutFifo_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ txEng_tupleShortCutFifo_fifo_cap sc_in sc_lv 2 signal 4 } 
	...
	{ sLookup2txEng_rev_rsp_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ sLookup2txEng_rev_rsp_fifo_cap sc_in sc_lv 3 signal 1 } 
	...
	{ txEng_isLookUpFifo_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ txEng_isLookUpFifo_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ txEng_tcpTupleFifo_num_data_valid sc_in sc_lv 6 signal 3 } 
	{ txEng_tcpTupleFifo_fifo_cap sc_in sc_lv 6 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_tcpTupleFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "txEng_tcpTupleFifo", "role": "num_data_valid" }} , 
 	{ "name": "txEng_tcpTupleFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "txEng_tcpTupleFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	txEng_isLookUpFifo { ap_fifo {  { txEng_isLookUpFifo_dout fifo_port_we 0 1 }  { txEng_isLookUpFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { txEng_isLookUpFifo_fifo_cap fifo_update 0 3 }  { txEng_isLookUpFifo_empty_n fifo_status 0 1 }  { txEng_isLookUpFifo_read fifo_data 1 1 } } }
	sLookup2txEng_rev_rsp { ap_fifo {  { sLookup2txEng_rev_rsp_dout fifo_port_we 0 96 }  { sLookup2txEng_rev_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { sLookup2txEng_rev_rsp_fifo_cap fifo_update 0 3 }  { sLookup2txEng_rev_rsp_empty_n fifo_status 0 1 }  { sLookup2txEng_rev_rsp_read fifo_data 1 1 } } }
	txEng_ipTupleFifo { ap_fifo {  { txEng_ipTupleFifo_din fifo_port_we 1 64 }  { txEng_ipTupleFifo_num_data_valid fifo_status_num_data_valid 0 6 }  { txEng_ipTupleFifo_fifo_cap fifo_update 0 6 }  { txEng_ipTupleFifo_full_n fifo_status 0 1 }  { txEng_ipTupleFifo_write fifo_data 1 1 } } }
	txEng_tcpTupleFifo { ap_fifo {  { txEng_tcpTupleFifo_din fifo_port_we 1 96 }  { txEng_tcpTupleFifo_num_data_valid fifo_status_num_data_valid 0 6 }  { txEng_tcpTupleFifo_fifo_cap fifo_update 0 6 }  { txEng_tcpTupleFifo_full_n fifo_status 0 1 }  { txEng_tcpTupleFifo_write fifo_data 1 1 } } }
	txEng_tupleShortCutFifo { ap_fifo {  { txEng_tupleShortCutFifo_dout fifo_port_we 0 96 }  { txEng_tupleShortCutFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tupleShortCutFifo_fifo_cap fifo_update 0 2 }  { txEng_tupleShortCutFifo_empty_n fifo_status 0 1 }  { txEng_tupleShortCutFifo_read fifo_data 1 1 } } }
}
