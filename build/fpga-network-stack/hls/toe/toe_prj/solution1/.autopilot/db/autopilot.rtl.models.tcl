set SynModuleInfo {
  ...
  {SRCNAME lookupReplyHandler MODELNAME lookupReplyHandler RTLNAME toe_top_lookupReplyHandler
    SUBMODULES {
      {MODELNAME toe_top_fifo_w128_d8_S RTLNAME toe_top_fifo_w128_d8_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w64_d4_S RTLNAME toe_top_fifo_w64_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
  ...
  {SRCNAME retransmit_timer MODELNAME retransmit_timer RTLNAME toe_top_retransmit_timer
    SUBMODULES {
      {MODELNAME toe_top_retransmit_timer_retransmitTimerTable_time_V_RAM_T2P_BRAM_1R1W RTLNAME toe_top_retransmit_timer_retransmitTimerTable_time_V_RAM_T2P_BRAM_1R1W BINDTYPE storage TYPE ram_t2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME toe_top_retransmit_timer_retransmitTimerTable_active_RAM_T2P_BRAM_1R1W RTLNAME toe_top_retransmit_timer_retransmitTimerTable_active_RAM_T2P_BRAM_1R1W BINDTYPE storage TYPE ram_t2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME toe_top_retransmit_timer_retransmitTimerTable_retries_V_RAM_T2P_BRAM_1R1W RTLNAME toe_top_retransmit_timer_retransmitTimerTable_retries_V_RAM_T2P_BRAM_1R1W BINDTYPE storage TYPE ram_t2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
      {MODELNAME toe_top_retransmit_timer_retransmitTimerTable_type_RAM_T2P_BRAM_1R1W RTLNAME toe_top_retransmit_timer_retransmitTimerTable_type_RAM_T2P_BRAM_1R1W BINDTYPE storage TYPE ram_t2p IMPL bram LATENCY 2 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME clear MODELNAME clear RTLNAME toe_top_clear}
  ...
  {SRCNAME clear.1 MODELNAME clear_1 RTLNAME toe_top_clear_1}
  ...
  {SRCNAME toe_top MODELNAME toe_top RTLNAME toe_top IS_TOP 1
    SUBMODULES {
      {MODELNAME toe_top_fifo_w14_d2_S RTLNAME toe_top_fifo_w14_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w14_d16384_A RTLNAME toe_top_fifo_w14_d16384_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w96_d4_S RTLNAME toe_top_fifo_w96_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d4_S RTLNAME toe_top_fifo_w128_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w160_d4_S RTLNAME toe_top_fifo_w160_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w32_d4_S RTLNAME toe_top_fifo_w32_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w16_d2_S RTLNAME toe_top_fifo_w16_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w16_d4_S RTLNAME toe_top_fifo_w16_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w96_d2_S RTLNAME toe_top_fifo_w96_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w32_d2_S RTLNAME toe_top_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w192_d2_S RTLNAME toe_top_fifo_w192_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d16_A RTLNAME toe_top_fifo_w128_d16_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w192_d16_A RTLNAME toe_top_fifo_w192_d16_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w64_d16_S RTLNAME toe_top_fifo_w64_d16_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w160_d16_A RTLNAME toe_top_fifo_w160_d16_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1_d4_S RTLNAME toe_top_fifo_w1_d4_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w15_d2_S RTLNAME toe_top_fifo_w15_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1_d2_S RTLNAME toe_top_fifo_w1_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d2_S RTLNAME toe_top_fifo_w128_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d64_A RTLNAME toe_top_fifo_w128_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w64_d2_S RTLNAME toe_top_fifo_w64_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w224_d512_A RTLNAME toe_top_fifo_w224_d512_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w224_d64_A RTLNAME toe_top_fifo_w224_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1_d64_S RTLNAME toe_top_fifo_w1_d64_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d8_A RTLNAME toe_top_fifo_w1024_d8_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w4_d2_S RTLNAME toe_top_fifo_w4_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d2_S RTLNAME toe_top_fifo_w1024_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d256_A RTLNAME toe_top_fifo_w1024_d256_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w16_d8_S RTLNAME toe_top_fifo_w16_d8_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d32_A RTLNAME toe_top_fifo_w1024_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w320_d2_S RTLNAME toe_top_fifo_w320_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w160_d2_S RTLNAME toe_top_fifo_w160_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w224_d2_S RTLNAME toe_top_fifo_w224_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w256_d2_S RTLNAME toe_top_fifo_w256_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w16_d32_S RTLNAME toe_top_fifo_w16_d32_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w160_d32_A RTLNAME toe_top_fifo_w160_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1_d32_S RTLNAME toe_top_fifo_w1_d32_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d32_A RTLNAME toe_top_fifo_w128_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w64_d32_A RTLNAME toe_top_fifo_w64_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w96_d32_A RTLNAME toe_top_fifo_w96_d32_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d1024_A RTLNAME toe_top_fifo_w1024_d1024_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w1024_d16_A RTLNAME toe_top_fifo_w1024_d16_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w96_d64_A RTLNAME toe_top_fifo_w96_d64_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME toe_top_fifo_w128_d128_A RTLNAME toe_top_fifo_w128_d128_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME {$InstName}}
    }
  }
}
