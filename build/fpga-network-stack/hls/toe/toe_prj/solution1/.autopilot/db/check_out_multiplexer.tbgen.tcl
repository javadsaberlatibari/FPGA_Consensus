...
set portList { 
	...
	{ pt_portCheckListening_rsp_fifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ pt_portCheckListening_rsp_fifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ pt_portCheckUsed_rsp_fifo_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ pt_portCheckUsed_rsp_fifo_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ pt_dstFifo_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ pt_dstFifo_fifo_cap sc_in sc_lv 3 signal 0 } 
	...
	{ portTable2rxEng_check_rsp_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ portTable2rxEng_check_rsp_fifo_cap sc_in sc_lv 3 signal 2 } 
...
set Spec2ImplPortList { 
	pt_dstFifo { ap_fifo {  { pt_dstFifo_dout fifo_port_we 0 1 }  { pt_dstFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { pt_dstFifo_fifo_cap fifo_update 0 3 }  { pt_dstFifo_empty_n fifo_status 0 1 }  { pt_dstFifo_read fifo_data 1 1 } } }
	pt_portCheckListening_rsp_fifo { ap_fifo {  { pt_portCheckListening_rsp_fifo_dout fifo_port_we 0 1 }  { pt_portCheckListening_rsp_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckListening_rsp_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckListening_rsp_fifo_empty_n fifo_status 0 1 }  { pt_portCheckListening_rsp_fifo_read fifo_data 1 1 } } }
	portTable2rxEng_check_rsp { ap_fifo {  { portTable2rxEng_check_rsp_din fifo_port_we 1 1 }  { portTable2rxEng_check_rsp_num_data_valid fifo_status_num_data_valid 0 3 }  { portTable2rxEng_check_rsp_fifo_cap fifo_update 0 3 }  { portTable2rxEng_check_rsp_full_n fifo_status 0 1 }  { portTable2rxEng_check_rsp_write fifo_data 1 1 } } }
	pt_portCheckUsed_rsp_fifo { ap_fifo {  { pt_portCheckUsed_rsp_fifo_dout fifo_port_we 0 1 }  { pt_portCheckUsed_rsp_fifo_num_data_valid fifo_status_num_data_valid 0 2 }  { pt_portCheckUsed_rsp_fifo_fifo_cap fifo_update 0 2 }  { pt_portCheckUsed_rsp_fifo_empty_n fifo_status 0 1 }  { pt_portCheckUsed_rsp_fifo_read fifo_data 1 1 } } }
}
