...
set portList { 
	...
	{ txEng_tcpPkgBuffer5_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ txEng_tcpPkgBuffer5_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ txEng_tcpPkgBuffer6_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ txEng_tcpPkgBuffer6_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set Spec2ImplPortList { 
	txEng_tcpPkgBuffer6 { ap_fifo {  { txEng_tcpPkgBuffer6_din fifo_port_we 1 1024 }  { txEng_tcpPkgBuffer6_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer6_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer6_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer6_write fifo_data 1 1 } } }
	txEng_tcpPkgBuffer5 { ap_fifo {  { txEng_tcpPkgBuffer5_dout fifo_port_we 0 1024 }  { txEng_tcpPkgBuffer5_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer5_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer5_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer5_read fifo_data 1 1 } } }
}
