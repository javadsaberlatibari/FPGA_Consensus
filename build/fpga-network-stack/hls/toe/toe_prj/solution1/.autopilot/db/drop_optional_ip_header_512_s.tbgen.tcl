...
set portList { 
	...
	{ rxEng_dataBuffer4_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ rxEng_dataBuffer4_fifo_cap sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_dataBuffer4_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer4", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_dataBuffer4_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer4", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	rxEng_dataBuffer0 { ap_fifo {  { rxEng_dataBuffer0_dout fifo_port_we 0 1024 }  { rxEng_dataBuffer0_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer0_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer0_empty_n fifo_status 0 1 }  { rxEng_dataBuffer0_read fifo_data 1 1 } } }
	rxEng_dataBuffer4 { ap_fifo {  { rxEng_dataBuffer4_din fifo_port_we 1 1024 }  { rxEng_dataBuffer4_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer4_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer4_full_n fifo_status 0 1 }  { rxEng_dataBuffer4_write fifo_data 1 1 } } }
}
