...
set portList { 
	...
	{ txEng_tcpPkgBuffer0_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ txEng_tcpPkgBuffer0_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ txEng_shift2pseudoFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ txEng_shift2pseudoFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set Spec2ImplPortList { 
	txEng_shift2pseudoFifo { ap_fifo {  { txEng_shift2pseudoFifo_din fifo_port_we 1 1024 }  { txEng_shift2pseudoFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_shift2pseudoFifo_fifo_cap fifo_update 0 2 }  { txEng_shift2pseudoFifo_full_n fifo_status 0 1 }  { txEng_shift2pseudoFifo_write fifo_data 1 1 } } }
	txEng_tcpPkgBuffer0 { ap_fifo {  { txEng_tcpPkgBuffer0_dout fifo_port_we 0 1024 }  { txEng_tcpPkgBuffer0_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer0_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer0_empty_n fifo_status 0 1 }  { txEng_tcpPkgBuffer0_read fifo_data 1 1 } } }
}
