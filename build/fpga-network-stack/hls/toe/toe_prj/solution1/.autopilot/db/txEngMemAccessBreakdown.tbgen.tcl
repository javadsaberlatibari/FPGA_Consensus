...
set portList { 
	...
	{ txMetaloader2memAccessBreakdown_num_data_valid sc_in sc_lv 6 signal 1 } 
	{ txMetaloader2memAccessBreakdown_fifo_cap sc_in sc_lv 6 signal 1 } 
	...
	{ memAccessBreakdown2txPkgStitcher_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ memAccessBreakdown2txPkgStitcher_fifo_cap sc_in sc_lv 6 signal 2 } 
	...
	{ m_axis_txread_cmd_TDATA sc_out sc_lv 128 signal 0 } 
...
set Spec2ImplPortList { 
	m_axis_txread_cmd { axis {  { m_axis_txread_cmd_TREADY out_acc 0 1 }  { m_axis_txread_cmd_TDATA out_data 1 128 }  { m_axis_txread_cmd_TVALID out_vld 1 1 } } }
	txMetaloader2memAccessBreakdown { ap_fifo {  { txMetaloader2memAccessBreakdown_dout fifo_port_we 0 128 }  { txMetaloader2memAccessBreakdown_num_data_valid fifo_status_num_data_valid 0 6 }  { txMetaloader2memAccessBreakdown_fifo_cap fifo_update 0 6 }  { txMetaloader2memAccessBreakdown_empty_n fifo_status 0 1 }  { txMetaloader2memAccessBreakdown_read fifo_data 1 1 } } }
	memAccessBreakdown2txPkgStitcher { ap_fifo {  { memAccessBreakdown2txPkgStitcher_din fifo_port_we 1 1 }  { memAccessBreakdown2txPkgStitcher_num_data_valid fifo_status_num_data_valid 0 6 }  { memAccessBreakdown2txPkgStitcher_fifo_cap fifo_update 0 6 }  { memAccessBreakdown2txPkgStitcher_full_n fifo_status 0 1 }  { memAccessBreakdown2txPkgStitcher_write fifo_data 1 1 } } }
}
