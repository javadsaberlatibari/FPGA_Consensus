...
set portList { 
	...
	{ eventEng2ackDelay_event_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ eventEng2ackDelay_event_fifo_cap sc_in sc_lv 7 signal 0 } 
	...
	{ ackDelayFifoReadCount_num_data_valid sc_in sc_lv 7 signal 1 } 
	{ ackDelayFifoReadCount_fifo_cap sc_in sc_lv 7 signal 1 } 
	...
	{ eventEng2txEng_event_num_data_valid sc_in sc_lv 7 signal 2 } 
	{ eventEng2txEng_event_fifo_cap sc_in sc_lv 7 signal 2 } 
	...
	{ ackDelayFifoWriteCount_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ ackDelayFifoWriteCount_fifo_cap sc_in sc_lv 7 signal 3 } 
...
set Spec2ImplPortList { 
	eventEng2ackDelay_event { ap_fifo {  { eventEng2ackDelay_event_dout fifo_port_we 0 224 }  { eventEng2ackDelay_event_num_data_valid fifo_status_num_data_valid 0 7 }  { eventEng2ackDelay_event_fifo_cap fifo_update 0 7 }  { eventEng2ackDelay_event_empty_n fifo_status 0 1 }  { eventEng2ackDelay_event_read fifo_data 1 1 } } }
	ackDelayFifoReadCount { ap_fifo {  { ackDelayFifoReadCount_din fifo_port_we 1 1 }  { ackDelayFifoReadCount_num_data_valid fifo_status_num_data_valid 0 7 }  { ackDelayFifoReadCount_fifo_cap fifo_update 0 7 }  { ackDelayFifoReadCount_full_n fifo_status 0 1 }  { ackDelayFifoReadCount_write fifo_data 1 1 } } }
	eventEng2txEng_event { ap_fifo {  { eventEng2txEng_event_din fifo_port_we 1 224 }  { eventEng2txEng_event_num_data_valid fifo_status_num_data_valid 0 7 }  { eventEng2txEng_event_fifo_cap fifo_update 0 7 }  { eventEng2txEng_event_full_n fifo_status 0 1 }  { eventEng2txEng_event_write fifo_data 1 1 } } }
	ackDelayFifoWriteCount { ap_fifo {  { ackDelayFifoWriteCount_din fifo_port_we 1 1 }  { ackDelayFifoWriteCount_num_data_valid fifo_status_num_data_valid 0 7 }  { ackDelayFifoWriteCount_fifo_cap fifo_update 0 7 }  { ackDelayFifoWriteCount_full_n fifo_status 0 1 }  { ackDelayFifoWriteCount_write fifo_data 1 1 } } }
}
