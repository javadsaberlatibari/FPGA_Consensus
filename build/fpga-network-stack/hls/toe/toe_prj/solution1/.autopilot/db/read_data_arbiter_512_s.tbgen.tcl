...
set portList { 
	...
	{ txBufferReadDataStitched_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ txBufferReadDataStitched_fifo_cap sc_in sc_lv 2 signal 1 } 
	...
	{ txApp2txEng_data_stream_num_data_valid sc_in sc_lv 11 signal 3 } 
	{ txApp2txEng_data_stream_fifo_cap sc_in sc_lv 11 signal 3 } 
	...
	{ txEng_isDDRbypass_num_data_valid sc_in sc_lv 6 signal 0 } 
	{ txEng_isDDRbypass_fifo_cap sc_in sc_lv 6 signal 0 } 
	...
	{ txEng_tcpPkgBuffer0_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ txEng_tcpPkgBuffer0_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txApp2txEng_data_stream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "txApp2txEng_data_stream", "role": "num_data_valid" }} , 
 	{ "name": "txApp2txEng_data_stream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "txApp2txEng_data_stream", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer0_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer0", "role": "num_data_valid" }} , 
 	{ "name": "txEng_tcpPkgBuffer0_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer0", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	txEng_isDDRbypass { ap_fifo {  { txEng_isDDRbypass_dout fifo_port_we 0 1 }  { txEng_isDDRbypass_num_data_valid fifo_status_num_data_valid 0 6 }  { txEng_isDDRbypass_fifo_cap fifo_update 0 6 }  { txEng_isDDRbypass_empty_n fifo_status 0 1 }  { txEng_isDDRbypass_read fifo_data 1 1 } } }
	txBufferReadDataStitched { ap_fifo {  { txBufferReadDataStitched_dout fifo_port_we 0 1024 }  { txBufferReadDataStitched_num_data_valid fifo_status_num_data_valid 0 2 }  { txBufferReadDataStitched_fifo_cap fifo_update 0 2 }  { txBufferReadDataStitched_empty_n fifo_status 0 1 }  { txBufferReadDataStitched_read fifo_data 1 1 } } }
	txEng_tcpPkgBuffer0 { ap_fifo {  { txEng_tcpPkgBuffer0_din fifo_port_we 1 1024 }  { txEng_tcpPkgBuffer0_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_tcpPkgBuffer0_fifo_cap fifo_update 0 2 }  { txEng_tcpPkgBuffer0_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer0_write fifo_data 1 1 } } }
	txApp2txEng_data_stream { ap_fifo {  { txApp2txEng_data_stream_dout fifo_port_we 0 1024 }  { txApp2txEng_data_stream_num_data_valid fifo_status_num_data_valid 0 11 }  { txApp2txEng_data_stream_fifo_cap fifo_update 0 11 }  { txApp2txEng_data_stream_empty_n fifo_status 0 1 }  { txApp2txEng_data_stream_read fifo_data 1 1 } } }
}
