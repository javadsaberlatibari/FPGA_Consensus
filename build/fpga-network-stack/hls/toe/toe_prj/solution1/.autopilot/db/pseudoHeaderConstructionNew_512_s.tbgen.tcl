...
set portList { 
	...
	{ txEng_shift2pseudoFifo_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ txEng_shift2pseudoFifo_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ txEng_tcpMetaFifo_num_data_valid sc_in sc_lv 6 signal 0 } 
	{ txEng_tcpMetaFifo_fifo_cap sc_in sc_lv 6 signal 0 } 
	...
	{ txEng_tcpTupleFifo_num_data_valid sc_in sc_lv 6 signal 1 } 
	{ txEng_tcpTupleFifo_fifo_cap sc_in sc_lv 6 signal 1 } 
	...
	{ txEng_tcpPkgBuffer1_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ txEng_tcpPkgBuffer1_fifo_cap sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "txEng_shift2pseudoFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_shift2pseudoFifo", "role": "num_data_valid" }} , 
 	{ "name": "txEng_shift2pseudoFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txEng_shift2pseudoFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txEng_tcpPkgBuffer1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer1", "role": "num_data_valid" }} , 
 	{ "name": "txEng_tcpPkgBuffer1_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "txEng_tcpPkgBuffer1", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	txEng_tcpMetaFifo { ap_fifo {  { txEng_tcpMetaFifo_dout fifo_port_we 0 160 }  { txEng_tcpMetaFifo_num_data_valid fifo_status_num_data_valid 0 6 }  { txEng_tcpMetaFifo_fifo_cap fifo_update 0 6 }  { txEng_tcpMetaFifo_empty_n fifo_status 0 1 }  { txEng_tcpMetaFifo_read fifo_data 1 1 } } }
	txEng_tcpTupleFifo { ap_fifo {  { txEng_tcpTupleFifo_dout fifo_port_we 0 96 }  { txEng_tcpTupleFifo_num_data_valid fifo_status_num_data_valid 0 6 }  { txEng_tcpTupleFifo_fifo_cap fifo_update 0 6 }  { txEng_tcpTupleFifo_empty_n fifo_status 0 1 }  { txEng_tcpTupleFifo_read fifo_data 1 1 } } }
	txEng_tcpPkgBuffer1 { ap_fifo {  { txEng_tcpPkgBuffer1_din fifo_port_we 1 1024 }  { txEng_tcpPkgBuffer1_num_data_valid fifo_status_num_data_valid 0 5 }  { txEng_tcpPkgBuffer1_fifo_cap fifo_update 0 5 }  { txEng_tcpPkgBuffer1_full_n fifo_status 0 1 }  { txEng_tcpPkgBuffer1_write fifo_data 1 1 } } }
	txEng_shift2pseudoFifo { ap_fifo {  { txEng_shift2pseudoFifo_dout fifo_port_we 0 1024 }  { txEng_shift2pseudoFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { txEng_shift2pseudoFifo_fifo_cap fifo_update 0 2 }  { txEng_shift2pseudoFifo_empty_n fifo_status 0 1 }  { txEng_shift2pseudoFifo_read fifo_data 1 1 } } }
}
