...
set portList { 
	...
	{ stateTable2txApp_rsp_num_data_valid sc_in sc_lv 2 signal 5 } 
	{ stateTable2txApp_rsp_fifo_cap sc_in sc_lv 2 signal 5 } 
	...
	{ txSar2txApp_upd_rsp_num_data_valid sc_in sc_lv 7 signal 4 } 
	{ txSar2txApp_upd_rsp_fifo_cap sc_in sc_lv 7 signal 4 } 
	...
	{ txApp2stateTable_req_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ txApp2stateTable_req_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ txApp2txSar_upd_req_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ txApp2txSar_upd_req_fifo_cap sc_in sc_lv 7 signal 3 } 
	...
	{ tasi_meta2pkgPushCmd_num_data_valid sc_in sc_lv 8 signal 6 } 
	{ tasi_meta2pkgPushCmd_fifo_cap sc_in sc_lv 8 signal 6 } 
	...
	{ txAppStream2event_mergeEvent_num_data_valid sc_in sc_lv 7 signal 7 } 
	{ txAppStream2event_mergeEvent_fifo_cap sc_in sc_lv 7 signal 7 } 
	...
	{ m_axis_tx_data_rsp_TDATA sc_out sc_lv 96 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "stateTable2txApp_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stateTable2txApp_rsp", "role": "num_data_valid" }} , 
 	{ "name": "stateTable2txApp_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stateTable2txApp_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txApp2stateTable_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txApp2stateTable_req", "role": "num_data_valid" }} , 
 	{ "name": "txApp2stateTable_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "txApp2stateTable_req", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	m_axis_tx_data_rsp { axis {  { m_axis_tx_data_rsp_TREADY out_acc 0 1 }  { m_axis_tx_data_rsp_TDATA out_data 1 96 }  { m_axis_tx_data_rsp_TVALID out_vld 1 1 } } }
	txApp2stateTable_req { ap_fifo {  { txApp2stateTable_req_din fifo_port_we 1 16 }  { txApp2stateTable_req_num_data_valid fifo_status_num_data_valid 0 2 }  { txApp2stateTable_req_fifo_cap fifo_update 0 2 }  { txApp2stateTable_req_full_n fifo_status 0 1 }  { txApp2stateTable_req_write fifo_data 1 1 } } }
	txApp2txSar_upd_req { ap_fifo {  { txApp2txSar_upd_req_din fifo_port_we 1 96 }  { txApp2txSar_upd_req_num_data_valid fifo_status_num_data_valid 0 7 }  { txApp2txSar_upd_req_fifo_cap fifo_update 0 7 }  { txApp2txSar_upd_req_full_n fifo_status 0 1 }  { txApp2txSar_upd_req_write fifo_data 1 1 } } }
	txSar2txApp_upd_rsp { ap_fifo {  { txSar2txApp_upd_rsp_dout fifo_port_we 0 128 }  { txSar2txApp_upd_rsp_num_data_valid fifo_status_num_data_valid 0 7 }  { txSar2txApp_upd_rsp_fifo_cap fifo_update 0 7 }  { txSar2txApp_upd_rsp_empty_n fifo_status 0 1 }  { txSar2txApp_upd_rsp_read fifo_data 1 1 } } }
	stateTable2txApp_rsp { ap_fifo {  { stateTable2txApp_rsp_dout fifo_port_we 0 32 }  { stateTable2txApp_rsp_num_data_valid fifo_status_num_data_valid 0 2 }  { stateTable2txApp_rsp_fifo_cap fifo_update 0 2 }  { stateTable2txApp_rsp_empty_n fifo_status 0 1 }  { stateTable2txApp_rsp_read fifo_data 1 1 } } }
	tasi_meta2pkgPushCmd { ap_fifo {  { tasi_meta2pkgPushCmd_din fifo_port_we 1 128 }  { tasi_meta2pkgPushCmd_num_data_valid fifo_status_num_data_valid 0 8 }  { tasi_meta2pkgPushCmd_fifo_cap fifo_update 0 8 }  { tasi_meta2pkgPushCmd_full_n fifo_status 0 1 }  { tasi_meta2pkgPushCmd_write fifo_data 1 1 } } }
	txAppStream2event_mergeEvent { ap_fifo {  { txAppStream2event_mergeEvent_din fifo_port_we 1 128 }  { txAppStream2event_mergeEvent_num_data_valid fifo_status_num_data_valid 0 7 }  { txAppStream2event_mergeEvent_fifo_cap fifo_update 0 7 }  { txAppStream2event_mergeEvent_full_n fifo_status 0 1 }  { txAppStream2event_mergeEvent_write fifo_data 1 1 } } }
}
