...
set portList { 
	...
	{ rxEng_pseudoHeaderFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ rxEng_pseudoHeaderFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
	...
	{ rxEng_dataBuffer5_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ rxEng_dataBuffer5_fifo_cap sc_in sc_lv 4 signal 2 } 
	...
	{ rxEng_dataBuffer1_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ rxEng_dataBuffer1_fifo_cap sc_in sc_lv 4 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxEng_pseudoHeaderFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_pseudoHeaderFifo", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_pseudoHeaderFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxEng_pseudoHeaderFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng_dataBuffer5_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer5", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_dataBuffer5_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer5", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxEng_dataBuffer1_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer1", "role": "num_data_valid" }} , 
 	{ "name": "rxEng_dataBuffer1_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "rxEng_dataBuffer1", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rxEng_pseudoHeaderFifo { ap_fifo {  { rxEng_pseudoHeaderFifo_dout fifo_port_we 0 1024 }  { rxEng_pseudoHeaderFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rxEng_pseudoHeaderFifo_fifo_cap fifo_update 0 2 }  { rxEng_pseudoHeaderFifo_empty_n fifo_status 0 1 }  { rxEng_pseudoHeaderFifo_read fifo_data 1 1 } } }
	rxEng_dataBuffer1 { ap_fifo {  { rxEng_dataBuffer1_din fifo_port_we 1 1024 }  { rxEng_dataBuffer1_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer1_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer1_full_n fifo_status 0 1 }  { rxEng_dataBuffer1_write fifo_data 1 1 } } }
	rxEng_dataBuffer5 { ap_fifo {  { rxEng_dataBuffer5_dout fifo_port_we 0 1024 }  { rxEng_dataBuffer5_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer5_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer5_empty_n fifo_status 0 1 }  { rxEng_dataBuffer5_read fifo_data 1 1 } } }
}
