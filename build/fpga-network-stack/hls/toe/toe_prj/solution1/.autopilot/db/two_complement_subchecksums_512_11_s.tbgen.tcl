...
set portList { 
	...
	{ rxEng_dataBuffer1_num_data_valid sc_in sc_lv 4 signal 0 } 
	{ rxEng_dataBuffer1_fifo_cap sc_in sc_lv 4 signal 0 } 
	...
	{ rxEng_dataBuffer2_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ rxEng_dataBuffer2_fifo_cap sc_in sc_lv 9 signal 1 } 
	...
	{ subSumFifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ subSumFifo_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "subSumFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "subSumFifo", "role": "num_data_valid" }} , 
 	{ "name": "subSumFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "subSumFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	rxEng_dataBuffer1 { ap_fifo {  { rxEng_dataBuffer1_dout fifo_port_we 0 1024 }  { rxEng_dataBuffer1_num_data_valid fifo_status_num_data_valid 0 4 }  { rxEng_dataBuffer1_fifo_cap fifo_update 0 4 }  { rxEng_dataBuffer1_empty_n fifo_status 0 1 }  { rxEng_dataBuffer1_read fifo_data 1 1 } } }
	rxEng_dataBuffer2 { ap_fifo {  { rxEng_dataBuffer2_din fifo_port_we 1 1024 }  { rxEng_dataBuffer2_num_data_valid fifo_status_num_data_valid 0 9 }  { rxEng_dataBuffer2_fifo_cap fifo_update 0 9 }  { rxEng_dataBuffer2_full_n fifo_status 0 1 }  { rxEng_dataBuffer2_write fifo_data 1 1 } } }
	subSumFifo { ap_fifo {  { subSumFifo_din fifo_port_we 1 1024 }  { subSumFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { subSumFifo_fifo_cap fifo_update 0 2 }  { subSumFifo_full_n fifo_status 0 1 }  { subSumFifo_write fifo_data 1 1 } } }
}
