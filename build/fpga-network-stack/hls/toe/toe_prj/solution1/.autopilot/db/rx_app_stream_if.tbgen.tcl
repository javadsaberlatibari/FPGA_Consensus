...
set portList { 
	...
	{ rxSar2rxApp_upd_rsp_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ rxSar2rxApp_upd_rsp_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ rxApp2rxSar_upd_req_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ rxApp2rxSar_upd_req_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ rxBufferReadCmd_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ rxBufferReadCmd_fifo_cap sc_in sc_lv 3 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rxSar2rxApp_upd_rsp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxSar2rxApp_upd_rsp", "role": "num_data_valid" }} , 
 	{ "name": "rxSar2rxApp_upd_rsp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxSar2rxApp_upd_rsp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "rxApp2rxSar_upd_req_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxApp2rxSar_upd_req", "role": "num_data_valid" }} , 
 	{ "name": "rxApp2rxSar_upd_req_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "rxApp2rxSar_upd_req", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	rxApp2rxSar_upd_req { ap_fifo {  { rxApp2rxSar_upd_req_din fifo_port_we 1 96 }  { rxApp2rxSar_upd_req_num_data_valid fifo_status_num_data_valid 0 2 }  { rxApp2rxSar_upd_req_fifo_cap fifo_update 0 2 }  { rxApp2rxSar_upd_req_full_n fifo_status 0 1 }  { rxApp2rxSar_upd_req_write fifo_data 1 1 } } }
	rxSar2rxApp_upd_rsp { ap_fifo {  { rxSar2rxApp_upd_rsp_dout fifo_port_we 0 96 }  { rxSar2rxApp_upd_rsp_num_data_valid fifo_status_num_data_valid 0 2 }  { rxSar2rxApp_upd_rsp_fifo_cap fifo_update 0 2 }  { rxSar2rxApp_upd_rsp_empty_n fifo_status 0 1 }  { rxSar2rxApp_upd_rsp_read fifo_data 1 1 } } }
	rxBufferReadCmd { ap_fifo {  { rxBufferReadCmd_din fifo_port_we 1 1 }  { rxBufferReadCmd_num_data_valid fifo_status_num_data_valid 0 3 }  { rxBufferReadCmd_fifo_cap fifo_update 0 3 }  { rxBufferReadCmd_full_n fifo_status 0 1 }  { rxBufferReadCmd_write fifo_data 1 1 } } }
}
