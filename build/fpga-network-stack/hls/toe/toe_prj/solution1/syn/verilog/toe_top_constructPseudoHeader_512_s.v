...
wire   [511:0] p_Result_237_fu_236_p5;
wire   [0:0] icmp_ln82_fu_230_p2;
wire    call_ln96_clear_fu_114_ap_ready;
wire   [15:0] call_ln96_clear_fu_114_header_idx_4;
wire    call_ln96_clear_fu_114_header_idx_4_ap_vld;
wire   [511:0] ap_phi_reg_pp0_iter0_sendWord_data_V_20_reg_103;
reg   [511:0] ap_phi_reg_pp0_iter1_sendWord_data_V_20_reg_103;
wire   [95:0] p_Result_s_fu_194_p5;
wire   [15:0] add_ln85_fu_248_p2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] tmp_their_address_V_fu_128_p1;
wire   [95:0] p_Result_234_fu_142_p5;
wire   [31:0] tmp_our_address_V_fu_132_p4;
wire   [7:0] tmp_569_i6_fu_176_p4;
wire   [7:0] tmp_i5_fu_166_p4;
wire   [95:0] p_Result_235_fu_154_p5;
wire   [15:0] p_Result_236_fu_186_p3;
...
toe_top_clear call_ln96_clear_fu_114(
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_113)) begin
        if (((state_3_load_load_fu_120_p1 == 1'd1) & (icmp_ln82_fu_230_p2 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((state_3_load_reg_285 == 1'd1) & (rxEng_pseudoHeaderFifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op17_read_state1 == 1'b1) & (rxEng_ipMetaFifo_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((state_3_load_reg_285 == 1'd1) & (rxEng_pseudoHeaderFifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op17_read_state1 == 1'b1) & (rxEng_ipMetaFifo_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((state_3_load_reg_285 == 1'd1) & (rxEng_pseudoHeaderFifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op17_read_state1 == 1'b1) & (rxEng_ipMetaFifo_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((ap_predicate_op17_read_state1 == 1'b1) & (rxEng_ipMetaFifo_empty_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_242 = ((tmp_i_nbreadreq_fu_82_p3 == 1'd1) & (state_3 == 1'd0) & (call_ln96_clear_fu_114_header_idx_4_ap_vld == 1'b1));
end
...
always @ (*) begin
    ap_predicate_op17_read_state1 = ((tmp_i_nbreadreq_fu_82_p3 == 1'd1) & (state_3 == 1'd0));
end
...
assign p_Result_234_fu_142_p5 = {{header_header_V_4[95:32]}, {tmp_their_address_V_fu_128_p1}};

assign p_Result_235_fu_154_p5 = {{p_Result_234_fu_142_p5[95:64]}, {tmp_our_address_V_fu_132_p4}, {p_Result_234_fu_142_p5[31:0]}};

assign p_Result_236_fu_186_p3 = {{tmp_569_i6_fu_176_p4}, {tmp_i5_fu_166_p4}};

assign p_Result_237_fu_236_p5 = {{ap_const_lv512_lc_4[511:96]}, {header_header_V_4}};

assign p_Result_s_fu_194_p5 = {{p_Result_236_fu_186_p3}, {p_Result_235_fu_154_p5[79:0]}};
...
assign tmp_569_i6_fu_176_p4 = {{rxEng_ipMetaFifo_dout[71:64]}};

assign tmp_i5_fu_166_p4 = {{rxEng_ipMetaFifo_dout[79:72]}};

assign tmp_i_nbreadreq_fu_82_p3 = rxEng_ipMetaFifo_empty_n;

assign tmp_our_address_V_fu_132_p4 = {{rxEng_ipMetaFifo_dout[63:32]}};

assign tmp_their_address_V_fu_128_p1 = rxEng_ipMetaFifo_dout[31:0];
