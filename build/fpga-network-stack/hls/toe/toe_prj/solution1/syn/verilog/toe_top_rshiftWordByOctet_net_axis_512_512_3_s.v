...
reg   [511:0] p_Val2_s_reg_268;
reg   [63:0] p_Val2_15_reg_273;
wire   [0:0] rs_firstWord_1_load_load_fu_166_p1;
wire   [255:0] trunc_ln674_fu_170_p1;
reg   [255:0] trunc_ln674_reg_289;
reg   [31:0] tmp_389_i7_reg_294;
...
wire   [511:0] currWord_data_V_fu_144_p1;
wire   [1023:0] zext_ln174_83_fu_242_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln174_fu_259_p1;
wire   [31:0] tmp_390_i8_fu_184_p4;
wire   [31:0] grp_fu_123_p4;
wire   [255:0] grp_fu_114_p4;
wire   [576:0] tmp_404_i_fu_231_p6;
wire   [576:0] zext_ln174_cast_fu_247_p5;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_72_p3 == 1'd1) & (fsmState_1 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (rs_firstWord_1_load_load_fu_166_p1 == 1'd0))) begin
        ...
        tmp_389_i7_reg_294 <= {{rxEng_dataBuffer3a_dout[543:512]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_264 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_264 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_1_load_reg_264 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (rxEng_dataBuffer3a_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((fsmState_1_load_reg_264 == 1'd1) & (rxEng_dataBuffer3b_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (rxEng_dataBuffer3b_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_147 = ((tmp_i_nbreadreq_fu_72_p3 == 1'd1) & (fsmState_1 == 1'd0) & (currWord_last_V_fu_158_p3 == 1'd1) & (ap_phi_mux_sendWord_last_V_4_phi_fu_96_p4 == 1'd0));
end
...
assign currWord_data_V_fu_144_p1 = rxEng_dataBuffer3a_dout[511:0];

assign currWord_last_V_fu_158_p3 = rxEng_dataBuffer3a_dout[1024'd576];

assign fsmState_1_load_load_fu_132_p1 = fsmState_1;

assign grp_fu_114_p4 = {{p_Val2_s_reg_268[511:256]}};

assign grp_fu_123_p4 = {{p_Val2_15_reg_273[63:32]}};

assign rs_firstWord_1_load_load_fu_166_p1 = rs_firstWord_1;

assign sendWord_last_V_fu_194_p2 = ((tmp_390_i8_fu_184_p4 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_390_i8_fu_184_p4 = {{rxEng_dataBuffer3a_dout[575:544]}};

assign tmp_404_i_fu_231_p6 = {{{{{sendWord_last_V_reg_299}, {tmp_389_i7_reg_294}}, {grp_fu_123_p4}}, {trunc_ln674_reg_289}}, {grp_fu_114_p4}};

assign tmp_i_nbreadreq_fu_72_p3 = rxEng_dataBuffer3a_empty_n;

assign trunc_ln674_fu_170_p1 = rxEng_dataBuffer3a_dout[255:0];

assign zext_ln174_83_fu_242_p1 = tmp_404_i_fu_231_p6;

assign zext_ln174_cast_fu_247_p5 = {{{{{{33'd4294967296}, {grp_fu_123_p4}}}, {256'd0}}}, {grp_fu_114_p4}};

assign zext_ln174_fu_259_p1 = zext_ln174_cast_fu_247_p5;
