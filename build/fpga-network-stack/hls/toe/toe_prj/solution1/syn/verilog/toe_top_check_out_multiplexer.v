...
reg    ap_idle_pp0;
wire   [0:0] tmp_i_267_nbreadreq_fu_36_p3;
reg    ap_predicate_op24_read_state1;
wire   [0:0] tmp_570_i_nbreadreq_fu_50_p3;
...
reg   [0:0] tmp_i_267_reg_119;
reg    ap_predicate_op39_write_state2;
reg   [0:0] tmp_570_i_reg_128;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((((tmp_570_i_nbreadreq_fu_50_p3 == 1'd1) & (cm_fsmState == 2'd2) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_i_267_nbreadreq_fu_36_p3 == 1'd1) & (cm_fsmState == 2'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        cm_fsmState <= 2'd0;
    end
end
...
always @ (*) begin
    ap_predicate_op24_read_state1 = ((tmp_i_267_nbreadreq_fu_36_p3 == 1'd1) & (cm_fsmState == 2'd1));
end

always @ (*) begin
    ap_predicate_op29_read_state1 = ((tmp_570_i_nbreadreq_fu_50_p3 == 1'd1) & (cm_fsmState == 2'd2));
end
...
always @ (*) begin
    ap_predicate_op39_write_state2 = ((tmp_i_267_reg_119 == 1'd1) & (cm_fsmState_load_reg_115 == 2'd1));
end

always @ (*) begin
    ap_predicate_op41_write_state2 = ((cm_fsmState_load_reg_115 == 2'd2) & (tmp_570_i_reg_128 == 1'd1));
end

assign select_ln211_fu_101_p3 = ((pt_dstFifo_dout[0:0] == 1'b1) ? 2'd1 : 2'd2);

assign tmp_570_i_nbreadreq_fu_50_p3 = pt_portCheckUsed_rsp_fifo_empty_n;

assign tmp_i_267_nbreadreq_fu_36_p3 = pt_portCheckListening_rsp_fifo_empty_n;
