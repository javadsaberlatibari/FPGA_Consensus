...
wire   [3:0] tmp_win_shift_V_fu_449_p4;
wire   [0:0] tmp_syn_V_fu_485_p3;
wire   [1023:0] zext_ln174_86_fu_880_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln174_fu_1004_p1;
wire   [16:0] tmp_274_fu_325_p3;
wire   [0:0] xor_ln1183_fu_367_p2;
wire   [16:0] tmp_271_fu_387_p3;
wire   [31:0] tmp_srcIp_V_fu_501_p1;
wire   [255:0] p_Result_177_fu_521_p5;
wire   [31:0] tmp_dstIp_V_fu_505_p4;
wire   [15:0] tmp_length_V_fu_459_p4;
wire   [15:0] len_V_fu_545_p2;
wire   [7:0] tmp_411_i_fu_629_p4;
wire   [7:0] tmp_410_i_fu_619_p4;
wire   [7:0] tmp_409_i_fu_609_p4;
wire   [7:0] tmp_408_i_fu_599_p4;
wire   [7:0] trunc_ln674_7_fu_595_p1;
wire   [7:0] tmp_406_i_fu_585_p4;
wire   [7:0] tmp_405_i_fu_575_p4;
wire   [7:0] tmp_404_i_fu_565_p4;
wire   [31:0] tmp_412_i_fu_639_p4;
wire   [7:0] trunc_ln674_fu_561_p1;
wire   [7:0] tmp_402_i_fu_551_p4;
wire   [255:0] p_Result_178_fu_533_p5;
wire   [111:0] tmp_413_i_fu_649_p12;
...
wire   [255:0] p_Result_179_fu_675_p5;
wire   [3:0] zext_ln1069_fu_721_p1;
wire   [255:0] p_Result_180_fu_725_p5;
wire   [0:0] tmp_fin_V_fu_493_p3;
wire   [255:0] p_Result_181_fu_737_p4;
wire   [255:0] p_Result_182_fu_747_p4;
wire   [0:0] tmp_rst_V_fu_477_p3;
wire   [255:0] p_Result_183_fu_757_p4;
wire   [0:0] tmp_ack_V_fu_469_p3;
wire   [0:0] icmp_ln1095_fu_783_p2;
wire   [0:0] xor_ln947_fu_777_p2;
wire   [7:0] tmp_416_i_fu_817_p4;
wire   [7:0] tmp_415_i_fu_807_p4;
wire   [16:0] tmp_418_i_fu_827_p4;
wire   [255:0] p_Result_184_fu_767_p4;
wire   [31:0] zext_ln414_1_fu_837_p1;
wire   [576:0] tmp_41_fu_873_p3;
wire   [7:0] zext_ln414_fu_906_p1;
wire   [24:0] tmp_417_i_fu_909_p4;
wire   [511:0] p_Result_186_fu_894_p5;
wire   [31:0] zext_ln391_fu_919_p1;
wire   [511:0] p_Result_187_fu_923_p5;
wire   [0:0] and_ln1069_fu_943_p2;
wire   [511:0] sendWord_data_V_6_fu_935_p3;
wire   [511:0] sendWord_data_V_7_fu_948_p3;
wire   [512:0] tmp_fu_956_p3;
wire   [35:0] select_ln1069_fu_970_p3;
wire   [35:0] select_ln1069_1_fu_978_p3;
wire   [0:0] sendWord_last_V_fu_885_p2;
wire  signed [38:0] sext_ln174_fu_986_p1;
wire   [512:0] or_ln174_fu_964_p2;
wire   [577:0] or_ln174_15_i_fu_990_p6;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_401_i_nbreadreq_fu_244_p3 == 1'd1) & (tmp_i_nbreadreq_fu_236_p3 == 1'd1) & (state_1 == 2'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        header_idx_1 <= 16'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_401_i_nbreadreq_fu_244_p3 == 1'd1) & (tmp_i_nbreadreq_fu_236_p3 == 1'd1) & (state_1 == 2'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        isSYN <= txEng_tcpMetaFifo_dout[160'd128];
...
always @ (posedge ap_clk) begin
    if (((grp_nbreadreq_fu_222_p3 == 1'd1) & (state_1 == 2'd2) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_s_reg_1035 <= {{txEng_shift2pseudoFifo_dout[576:512]}};
    end
end
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op144_write_state2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op122_write_state2 == 1'b1)) | ((state_1_load_reg_1009 == 2'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_254)) begin
        if ((ap_predicate_op144_write_state2 == 1'b1)) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op144_write_state2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_predicate_op122_write_state2 == 1'b1)) | ((state_1_load_reg_1009 == 2'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
assign and_ln1069_1_fu_699_p2 = (tmp_syn_V_fu_485_p3 & icmp_ln1069_3_fu_693_p2);

assign and_ln1069_fu_943_p2 = (isSYN & icmp_ln1069_reg_1053);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((txEng_tcpPkgBuffer1_full_n == 1'b0) & (ap_predicate_op144_write_state2 == 1'b1)) | ((txEng_tcpPkgBuffer1_full_n == 1'b0) & (ap_predicate_op122_write_state2 == 1'b1)) | ((state_1_load_reg_1009 == 2'd1) & (txEng_tcpPkgBuffer1_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_68 = ((tmp_401_i_nbreadreq_fu_244_p3 == 1'd1) & (tmp_i_nbreadreq_fu_236_p3 == 1'd1) & (state_1 == 2'd0));
end
...
always @ (*) begin
    ap_predicate_op122_write_state2 = ((tmp_i_254_reg_1018 == 1'd1) & (state_1_load_reg_1009 == 2'd2));
end

always @ (*) begin
    ap_predicate_op144_write_state2 = ((state_1_load_reg_1009 == 2'd3) & (tmp_400_i_reg_1058 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op66_read_state1 = ((tmp_401_i_nbreadreq_fu_244_p3 == 1'd1) & (tmp_i_nbreadreq_fu_236_p3 == 1'd1) & (state_1 == 2'd0));
end

always @ (*) begin
    ap_predicate_op73_read_state1 = ((tmp_401_i_nbreadreq_fu_244_p3 == 1'd1) & (tmp_i_nbreadreq_fu_236_p3 == 1'd1) & (state_1 == 2'd0));
end

assign grp_fu_291_p3 = txEng_shift2pseudoFifo_dout[1024'd576];

assign grp_fu_299_p2 = (header_idx_1 + 16'd1);

assign grp_nbreadreq_fu_222_p3 = txEng_shift2pseudoFifo_empty_n;

assign icmp_ln1069_3_fu_693_p2 = ((tmp_win_shift_V_fu_449_p4 == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln1069_fu_437_p2 = ((win_shift_V == 4'd0) ? 1'b1 : 1'b0);

assign icmp_ln1095_fu_783_p2 = ((tmp_length_V_fu_459_p4 != 16'd0) ? 1'b1 : 1'b0);

assign icmp_ln82_1_fu_333_p2 = ((tmp_274_fu_325_p3 == 17'd0) ? 1'b1 : 1'b0);

assign icmp_ln82_fu_395_p2 = ((tmp_271_fu_387_p3 == 17'd0) ? 1'b1 : 1'b0);

assign len_V_fu_545_p2 = (tmp_length_V_fu_459_p4 + 16'd20);

assign or_ln174_15_i_fu_990_p6 = {{{{{{{{1'd0}, {sendWord_last_V_fu_885_p2}}}, {24'd0}}}, {sext_ln174_fu_986_p1}}}, {or_ln174_fu_964_p2}};

assign or_ln174_fu_964_p2 = (tmp_fu_956_p3 | 513'd13407807929942597099574024998205846127479365820592393377723561443721764030073546976801874298166903427690031858186486050853753882811946569946433649006084096);

assign p_Result_177_fu_521_p5 = {{header_header_V_1[255:32]}, {tmp_srcIp_V_fu_501_p1}};

assign p_Result_178_fu_533_p5 = {{p_Result_177_fu_521_p5[255:64]}, {tmp_dstIp_V_fu_505_p4}, {p_Result_177_fu_521_p5[31:0]}};

assign p_Result_179_fu_675_p5 = {{p_Result_178_fu_533_p5[255:192]}, {tmp_413_i_fu_649_p12}, {p_Result_178_fu_533_p5[79:0]}};

assign p_Result_180_fu_725_p5 = {{p_Result_179_fu_675_p5[255:200]}, {zext_ln1069_fu_721_p1}, {p_Result_179_fu_675_p5[195:0]}};

assign p_Result_181_fu_737_p4 = {p_Result_180_fu_725_p5[256 - 1:201], |(tmp_fin_V_fu_493_p3), p_Result_180_fu_725_p5[199:0]};

assign p_Result_182_fu_747_p4 = {p_Result_181_fu_737_p4[256 - 1:202], |(tmp_syn_V_fu_485_p3), p_Result_181_fu_737_p4[200:0]};

assign p_Result_183_fu_757_p4 = {p_Result_182_fu_747_p4[256 - 1:203], |(tmp_rst_V_fu_477_p3), p_Result_182_fu_747_p4[201:0]};

assign p_Result_184_fu_767_p4 = {p_Result_183_fu_757_p4[256 - 1:205], |(tmp_ack_V_fu_469_p3), p_Result_183_fu_757_p4[203:0]};

assign p_Result_185_fu_401_p5 = {{ap_const_lv512_lc_4[511:256]}, {header_header_V_1}};

assign p_Result_186_fu_894_p5 = {{ap_phi_reg_pp0_iter1_sendWord_data_V_8_reg_280[511:288]}, {32'd3020227586}, {ap_phi_reg_pp0_iter1_sendWord_data_V_8_reg_280[255:0]}};

assign p_Result_187_fu_923_p5 = {{p_Result_186_fu_894_p5[511:320]}, {zext_ln391_fu_919_p1}, {p_Result_186_fu_894_p5[287:0]}};

assign p_Result_188_fu_339_p5 = {{tmp_data_V_3_fu_321_p1[511:256]}, {header_header_V_1}};

assign p_Result_s_fu_841_p5 = {{p_Result_184_fu_767_p4[255:240]}, {zext_ln414_1_fu_837_p1}, {p_Result_184_fu_767_p4[207:0]}};

assign select_ln1069_1_fu_978_p3 = ((isSYN[0:0] == 1'b1) ? select_ln1069_fu_970_p3 : 36'd2147483647);

assign select_ln1069_3_fu_713_p3 = ((tmp_syn_V_fu_485_p3[0:0] == 1'b1) ? select_ln1069_4_fu_705_p3 : 3'd5);

assign select_ln1069_4_fu_705_p3 = ((and_ln1069_1_fu_699_p2[0:0] == 1'b1) ? 3'd6 : 3'd7);

assign select_ln1069_fu_970_p3 = ((and_ln1069_fu_943_p2[0:0] == 1'b1) ? 36'd34359738367 : 36'd68719476735);
...
assign sendWord_data_V_6_fu_935_p3 = ((isSYN[0:0] == 1'b1) ? p_Result_187_fu_923_p5 : ap_phi_reg_pp0_iter1_sendWord_data_V_8_reg_280);

assign sendWord_data_V_7_fu_948_p3 = ((and_ln1069_fu_943_p2[0:0] == 1'b1) ? p_Result_186_fu_894_p5 : sendWord_data_V_6_fu_935_p3);

assign sendWord_last_V_fu_885_p2 = (hasBody_load_reg_1013 ^ 1'd1);

assign sext_ln174_fu_986_p1 = $signed(select_ln1069_1_fu_978_p3);

assign state_1_load_load_fu_304_p1 = state_1;

assign tmp_271_fu_387_p3 = {{header_idx_1}, {1'd0}};

assign tmp_274_fu_325_p3 = {{header_idx_1}, {1'd0}};

assign tmp_401_i_nbreadreq_fu_244_p3 = txEng_tcpTupleFifo_empty_n;

assign tmp_402_i_fu_551_p4 = {{len_V_fu_545_p2[15:8]}};

assign tmp_404_i_fu_565_p4 = {{txEng_tcpMetaFifo_dout[31:24]}};

assign tmp_405_i_fu_575_p4 = {{txEng_tcpMetaFifo_dout[23:16]}};

assign tmp_406_i_fu_585_p4 = {{txEng_tcpMetaFifo_dout[15:8]}};

assign tmp_408_i_fu_599_p4 = {{txEng_tcpMetaFifo_dout[63:56]}};

assign tmp_409_i_fu_609_p4 = {{txEng_tcpMetaFifo_dout[55:48]}};

assign tmp_410_i_fu_619_p4 = {{txEng_tcpMetaFifo_dout[47:40]}};

assign tmp_411_i_fu_629_p4 = {{txEng_tcpMetaFifo_dout[39:32]}};

assign tmp_412_i_fu_639_p4 = {{txEng_tcpTupleFifo_dout[95:64]}};

assign tmp_413_i_fu_649_p12 = {{{{{{{{{{{tmp_411_i_fu_629_p4}, {tmp_410_i_fu_619_p4}}, {tmp_409_i_fu_609_p4}}, {tmp_408_i_fu_599_p4}}, {trunc_ln674_7_fu_595_p1}}, {tmp_406_i_fu_585_p4}}, {tmp_405_i_fu_575_p4}}, {tmp_404_i_fu_565_p4}}, {tmp_412_i_fu_639_p4}}, {trunc_ln674_fu_561_p1}}, {tmp_402_i_fu_551_p4}};

assign tmp_415_i_fu_807_p4 = {{txEng_tcpMetaFifo_dout[79:72]}};

assign tmp_416_i_fu_817_p4 = {{txEng_tcpMetaFifo_dout[71:64]}};

assign tmp_417_i_fu_909_p4 = {{{{1'd0}, {zext_ln414_fu_906_p1}}}, {16'd771}};

assign tmp_418_i_fu_827_p4 = {{{{1'd0}, {tmp_416_i_fu_817_p4}}}, {tmp_415_i_fu_807_p4}};

assign tmp_41_fu_873_p3 = {{tmp_s_reg_1035}, {ap_phi_reg_pp0_iter1_currWord_data_V_reg_271}};

assign tmp_ack_V_fu_469_p3 = txEng_tcpMetaFifo_dout[160'd112];
...
assign tmp_fin_V_fu_493_p3 = txEng_tcpMetaFifo_dout[160'd136];

assign tmp_fu_956_p3 = {{1'd0}, {sendWord_data_V_7_fu_948_p3}};

assign tmp_i_nbreadreq_fu_236_p3 = txEng_tcpMetaFifo_empty_n;

assign tmp_length_V_fu_459_p4 = {{txEng_tcpMetaFifo_dout[111:96]}};

assign tmp_rst_V_fu_477_p3 = txEng_tcpMetaFifo_dout[160'd120];

assign tmp_srcIp_V_fu_501_p1 = txEng_tcpTupleFifo_dout[31:0];

assign tmp_syn_V_fu_485_p3 = txEng_tcpMetaFifo_dout[160'd128];

assign tmp_win_shift_V_fu_449_p4 = {{txEng_tcpMetaFifo_dout[83:80]}};
...
assign xor_ln947_fu_777_p2 = (tmp_syn_V_fu_485_p3 ^ 1'd1);

assign zext_ln1069_fu_721_p1 = select_ln1069_3_fu_713_p3;

assign zext_ln174_86_fu_880_p1 = tmp_41_fu_873_p3;

assign zext_ln174_fu_1004_p1 = or_ln174_15_i_fu_990_p6;

assign zext_ln391_fu_919_p1 = tmp_417_i_fu_909_p4;

assign zext_ln414_1_fu_837_p1 = tmp_418_i_fu_827_p4;

assign zext_ln414_fu_906_p1 = win_shift_V_load_reg_1048;
