...
module toe_top_hls_deadlock_idx0_monitor ( // for module toe_top_toe_top_inst
    ...
    input wire [77:0] inst_idle_sigs,
    input wire [59:0] inst_block_sigs,
    output wire block
);
...
wire idx15_block;
wire idx12_block;
wire [59:0] process_idle_vec;
wire [59:0] process_chan_block_vec;
wire [59:0] process_axis_block_vec;
wire df_has_axis_block;
wire all_process_stop;

assign block = monitor_find_block;
assign idx4_block = axis_block_sigs[4];
assign idx13_block = axis_block_sigs[16];
...
assign idx15_block = axis_block_sigs[19];
assign idx12_block = axis_block_sigs[15];
...
assign process_axis_block_vec[19] = idx4_block & (1'b0 | axis_block_sigs[4]);
...
assign process_axis_block_vec[33] = idx5_block & (1'b0 | axis_block_sigs[5]);
...
assign process_axis_block_vec[36] = idx6_block & (1'b0 | axis_block_sigs[6]);
...
assign process_axis_block_vec[38] = idx7_block & (1'b0 | axis_block_sigs[7]);
...
assign process_axis_block_vec[48] = idx8_block & (1'b0 | axis_block_sigs[8]);
assign process_idle_vec[48] = inst_idle_sigs[48];
assign process_chan_block_vec[48] = inst_block_sigs[48];
assign process_axis_block_vec[49] = idx9_block & (1'b0 | axis_block_sigs[9] | axis_block_sigs[10]);
assign process_idle_vec[49] = inst_idle_sigs[49];
assign process_chan_block_vec[49] = inst_block_sigs[49];
assign process_axis_block_vec[50] = idx10_block & (1'b0 | axis_block_sigs[11] | axis_block_sigs[12]);
assign process_idle_vec[50] = inst_idle_sigs[50];
assign process_chan_block_vec[50] = inst_block_sigs[50];
assign process_axis_block_vec[51] = idx11_block & (1'b0 | axis_block_sigs[13] | axis_block_sigs[14]);
assign process_idle_vec[51] = inst_idle_sigs[51];
assign process_chan_block_vec[51] = inst_block_sigs[51];
assign process_axis_block_vec[52] = idx12_block & (1'b0 | axis_block_sigs[15]);
...
assign process_axis_block_vec[54] = idx13_block & (1'b0 | axis_block_sigs[16]);
assign process_idle_vec[54] = inst_idle_sigs[54];
assign process_chan_block_vec[54] = inst_block_sigs[54];
assign process_axis_block_vec[55] = idx14_block & (1'b0 | axis_block_sigs[17] | axis_block_sigs[18]);
assign process_idle_vec[55] = inst_idle_sigs[55];
assign process_chan_block_vec[55] = inst_block_sigs[55];
assign process_axis_block_vec[56] = idx15_block & (1'b0 | axis_block_sigs[19]);
assign process_idle_vec[56] = inst_idle_sigs[56];
assign process_chan_block_vec[56] = inst_block_sigs[56];
assign process_axis_block_vec[57] = idx16_block & (1'b0 | axis_block_sigs[20] | axis_block_sigs[21]);
assign process_idle_vec[57] = inst_idle_sigs[57];
assign process_chan_block_vec[57] = inst_block_sigs[57];
assign process_axis_block_vec[58] = idx17_block & (1'b0 | axis_block_sigs[22] | axis_block_sigs[23] | axis_block_sigs[24]);
...
// instant sub module
 toe_top_hls_deadlock_idx10_monitor toe_top_hls_deadlock_idx10_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 toe_top_hls_deadlock_idx16_monitor toe_top_hls_deadlock_idx16_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 toe_top_hls_deadlock_idx1_monitor toe_top_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
 ...
 toe_top_hls_deadlock_idx11_monitor toe_top_hls_deadlock_idx11_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
