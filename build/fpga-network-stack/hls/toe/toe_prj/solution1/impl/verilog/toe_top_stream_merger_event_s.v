...
reg   [127:0] tmp_reg_65;
reg   [127:0] tmp_reg_65_pp0_iter1_reg;
reg   [127:0] tmp_235_reg_74;
...
always @ (*) begin
    ap_predicate_op23_read_state2 = ((tmp_i_238_nbreadreq_fu_40_p3 == 1'd1) & (tmp_i_reg_61 == 1'd0));
end

always @ (*) begin
    ap_predicate_op24_write_state3 = ((tmp_i_238_reg_70 == 1'd1) & (tmp_i_reg_61_pp0_iter1_reg == 1'd0));
end

assign tmp_i_238_nbreadreq_fu_40_p3 = probeTimer2eventEng_setEvent_empty_n;
