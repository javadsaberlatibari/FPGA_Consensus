...
wire   [1023:0] zext_ln174_82_fu_246_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln174_fu_263_p1;
wire   [51:0] tmp_384_i8_fu_188_p4;
wire   [51:0] grp_fu_127_p4;
wire   [415:0] grp_fu_118_p4;
wire   [576:0] tmp_402_i_fu_235_p6;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_nbreadreq_fu_76_p3 == 1'd1) & (fsmState == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (rs_firstWord_load_load_fu_170_p1 == 1'd0))) begin
        ...
        tmp_383_i7_reg_298 <= {{txEng_tcpPkgBuffer3_dout[523:512]}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_load_reg_268 == 1'd1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (txEng_tcpPkgBuffer3_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_load_reg_268 == 1'd1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (txEng_tcpPkgBuffer3_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((fsmState_load_reg_268 == 1'd1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op18_read_state1 == 1'b1) & (txEng_tcpPkgBuffer3_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((fsmState_load_reg_268 == 1'd1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)) | ((ap_predicate_op46_write_state2 == 1'b1) & (txEng_tcpPkgBuffer4_full_n == 1'b0)));
end
...
assign currWord_last_V_fu_162_p3 = txEng_tcpPkgBuffer3_dout[1024'd576];

assign fsmState_load_load_fu_136_p1 = fsmState;

assign grp_fu_118_p4 = {{p_Val2_s_reg_272[511:96]}};

assign grp_fu_127_p4 = {{p_Val2_12_reg_277[63:12]}};

assign rs_firstWord_load_load_fu_170_p1 = rs_firstWord;

assign sendWord_last_V_fu_198_p2 = ((tmp_384_i8_fu_188_p4 == 52'd0) ? 1'b1 : 1'b0);

assign tmp_384_i8_fu_188_p4 = {{txEng_tcpPkgBuffer3_dout[575:524]}};

assign tmp_402_i_fu_235_p6 = {{{{{sendWord_last_V_reg_303}, {tmp_383_i7_reg_298}}, {grp_fu_127_p4}}, {trunc_ln674_reg_293}}, {grp_fu_118_p4}};

assign tmp_i_nbreadreq_fu_76_p3 = txEng_tcpPkgBuffer3_empty_n;

assign trunc_ln674_fu_174_p1 = txEng_tcpPkgBuffer3_dout[95:0];

assign zext_ln174_82_fu_246_p1 = tmp_402_i_fu_235_p6;
