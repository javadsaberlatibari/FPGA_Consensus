...
reg   [127:0] tmp_reg_84;
reg   [127:0] tmp_reg_84_pp0_iter1_reg;
reg   [127:0] txAppStream2event_mergeEvent_read_reg_93;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_115_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_reg_80 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_predicate_op27_read_state2 = ((tmp_i_115_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_reg_80 == 1'd0));
end

always @ (*) begin
    ap_predicate_op32_write_state3 = ((tmp_i_115_reg_89 == 1'd1) & (tmp_i_reg_80_pp0_iter1_reg == 1'd0));
end

always @ (*) begin
    ap_predicate_op33_write_state3 = ((icmp_ln54_reg_99 == 1'd1) & (tmp_i_115_reg_89 == 1'd1) & (tmp_i_reg_80_pp0_iter1_reg == 1'd0));
end
...
assign tmp_i_115_nbreadreq_fu_42_p3 = txAppStream2event_mergeEvent_empty_n;
