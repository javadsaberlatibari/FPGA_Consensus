...
attribute shreg_extract : string;
    ...
    signal tmp_439_i_nbreadreq_fu_72_p3 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal p_s_reg_253 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((tmp_439_i_nbreadreq_fu_72_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_64_p3 = ap_const_lv1_1) and (state_4 = ap_const_lv1_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((state_4_load_load_fu_114_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (optionKind_fu_144_p1 = ap_const_lv8_3) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                p_s_reg_253 <= fields_V(19 downto 16);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_condition_46_assign_proc : process(tmp_i_nbreadreq_fu_64_p3, tmp_439_i_nbreadreq_fu_72_p3, state_4)
    begin
                ap_condition_46 <= ((tmp_439_i_nbreadreq_fu_72_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_64_p3 = ap_const_lv1_1) and (state_4 = ap_const_lv1_0));
    end process;
    ...
    ap_predicate_op24_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_64_p3, tmp_439_i_nbreadreq_fu_72_p3, state_4)
    begin
                ap_predicate_op24_read_state1 <= ((tmp_439_i_nbreadreq_fu_72_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_64_p3 = ap_const_lv1_1) and (state_4 = ap_const_lv1_0));
    end process;


    ap_predicate_op26_read_state1_assign_proc : process(tmp_i_nbreadreq_fu_64_p3, tmp_439_i_nbreadreq_fu_72_p3, state_4)
    begin
                ap_predicate_op26_read_state1 <= ((tmp_439_i_nbreadreq_fu_72_p3 = ap_const_lv1_1) and (tmp_i_nbreadreq_fu_64_p3 = ap_const_lv1_1) and (state_4 = ap_const_lv1_0));
    end process;
    ...
    rxEng_winScaleFifo_din_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_predicate_op53_write_state2, ap_predicate_op54_write_state2, ap_predicate_op55_write_state2, p_s_reg_253, ap_block_pp0_stage0_01001)
    begin
    ...
    tmp_439_i_nbreadreq_fu_72_p3 <= (0=>(rxEng_optionalFieldsFifo_empty_n), others=>'-');
