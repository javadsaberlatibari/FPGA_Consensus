...
set IPName      "rocev2"
set Version     "0.82"
set DisplayName "RoCEv2 Endpoint"
set Revision    "2113113514"
...
set xo_kernel_name "rocev2_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/pub/scratch/pyuvaraj/Vitis_RoCE_W/Vitis_RoCE/build/fpga-network-stack/hls/rocev2/rocev2_prj/solution1"
set debug_dir "/pub/scratch/pyuvaraj/Vitis_RoCE_W/Vitis_RoCE/build/fpga-network-stack/hls/rocev2/rocev2_prj/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {rocev2_top_regslice_both
...
set Interfaces {
    ...
    m_axis_mem_write_cmd {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_mem_write_cmd"
        has_tready "1"
        ports {
            TDATA 192
        }
    ...
    m_axis_mem_read_cmd {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_mem_read_cmd"
        has_tready "1"
        ports {
            TDATA 192
        }
    ...
    m_axis_mem_write_data {
        type "axi4stream"
        mode "master"
        port_prefix "m_axis_mem_write_data"
        has_tready "1"
        ports {
            TDATA 1024
        }
    ...
    s_axis_mem_read_data {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_mem_read_data"
        has_tready "1"
        ports {
            TDATA 1024
        }
    ...
    s_axis_qp_interface {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_qp_interface"
        has_tready "1"
        ports {
            TDATA 256
        }
    ...
    s_axis_qp_conn_interface {
        type "axi4stream"
        mode "slave"
        port_prefix "s_axis_qp_conn_interface"
        has_tready "1"
        ports {
            TDATA 384
        }
    ...
    ap_clk {
        ...
        buses "s_axis_rx_data s_axis_tx_meta s_axis_tx_data m_axis_tx_data m_axis_mem_write_cmd m_axis_mem_read_cmd m_axis_mem_write_data s_axis_mem_read_data s_axis_qp_interface s_axis_qp_conn_interface"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.2 machine 64 combinational 0 latency 43 II x}
