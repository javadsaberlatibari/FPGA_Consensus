...
input  [191:0] stateTable2qpi_rsp_dout;
...
output  [159:0] qpi2stateTable_upd_req_din;
...
output  [63:0] if2msnTable_init_din;
...
reg[159:0] qpi2stateTable_upd_req_din;
...
reg   [15:0] trunc_ln145_s_reg_286;
wire   [31:0] trunc_ln145_fu_130_p1;
wire   [159:0] zext_ln174_41_fu_216_p1;
reg    ap_block_pp0_stage0_01001;
wire   [159:0] zext_ln174_fu_254_p1;
wire   [128:0] zext_ln174_cast_fu_236_p8;
wire   [47:0] tmp_119_i_fu_263_p4;
reg   [0:0] ap_NS_fsm;
reg    ap_idle_pp0_0to0;
reg    ap_reset_idle_pp0;
wire    ap_enable_pp0;
wire    regslice_both_s_axis_qp_interface_U_apdone_blk;
wire   [255:0] s_axis_qp_interface_TDATA_int_regslice;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_147)) begin
        if (((tmp_i_218_nbreadreq_fu_98_p3 == 1'd1) & (qp_fsmState == 1'd1))) begin
            qp_fsmState <= 1'd0;
        end else if (((tmp_i_nbreadreq_fu_84_p3 == 1'd1) & (qp_fsmState == 1'd0))) begin
            qp_fsmState <= 1'd1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_84_p3 == 1'd1) & (qp_fsmState == 1'd0) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        context_local_psn_V <= {{s_axis_qp_interface_TDATA_int_regslice[119:96]}};
        context_newState <= trunc_ln145_fu_130_p1;
        context_qp_num_V <= {{s_axis_qp_interface_TDATA_int_regslice[47:32]}};
        context_r_key_V <= {{s_axis_qp_interface_TDATA_int_regslice[143:128]}};
        context_remote_psn_V <= {{s_axis_qp_interface_TDATA_int_regslice[87:64]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_i_nbreadreq_fu_84_p3 == 1'd1) & (qp_fsmState == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        trunc_ln145_s_reg_286 <= {{s_axis_qp_interface_TDATA_int_regslice[47:32]}};
    end
end
...
always @ (*) begin
    if ((((ap_predicate_op48_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)) | ((ap_predicate_op40_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((ap_predicate_op48_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_predicate_op40_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((ap_predicate_op52_write_state2 == 1'b1) & (if2msnTable_init_full_n == 1'b0)) | ((ap_predicate_op48_write_state2 == 1'b1) & (qpi2stateTable_upd_req_full_n == 1'b0)) | ((ap_predicate_op40_write_state2 == 1'b1) & (qpi2stateTable_upd_req_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op21_read_state1 = ((tmp_i_nbreadreq_fu_84_p3 == 1'd1) & (qp_fsmState == 1'd0));
end

always @ (*) begin
    ap_predicate_op36_read_state1 = ((tmp_i_218_nbreadreq_fu_98_p3 == 1'd1) & (qp_fsmState == 1'd1));
end

always @ (*) begin
    ap_predicate_op40_write_state2 = ((tmp_i_reg_282 == 1'd1) & (qp_fsmState_load_reg_278 == 1'd0));
end

always @ (*) begin
    ap_predicate_op48_write_state2 = ((tmp_i_218_reg_291 == 1'd1) & (qp_fsmState_load_reg_278 == 1'd1));
end

always @ (*) begin
    ap_predicate_op52_write_state2 = ((tmp_i_218_reg_291 == 1'd1) & (qp_fsmState_load_reg_278 == 1'd1));
end

assign if2msnTable_init_din = tmp_119_i_fu_263_p4;

assign s_axis_qp_interface_TREADY = regslice_both_s_axis_qp_interface_U_ack_in;

assign tmp_119_i_fu_263_p4 = {{{context_r_key_V}, {16'd0}}, {context_qp_num_V}};

assign tmp_i_218_nbreadreq_fu_98_p3 = stateTable2qpi_rsp_empty_n;

assign tmp_i_nbreadreq_fu_84_p3 = s_axis_qp_interface_TVALID_int_regslice;

assign trunc_ln145_fu_130_p1 = s_axis_qp_interface_TDATA_int_regslice[31:0];

assign zext_ln174_41_fu_216_p1 = trunc_ln145_s_reg_286;

assign zext_ln174_cast_fu_236_p8 = {{{{{{{{{{{{9'd256}, {context_local_psn_V}}}, {8'd0}}}, {context_remote_psn_V}}}, {context_newState}}}, {16'd0}}}, {context_qp_num_V}};

assign zext_ln174_fu_254_p1 = zext_ln174_cast_fu_236_p8;
