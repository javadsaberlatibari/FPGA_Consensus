...
wire   [23:0] connMeta_remote_qpn_V_fu_88_p1;
reg   [23:0] connMeta_remote_qpn_V_reg_129;
reg   [15:0] len_reg_134;
reg   [143:0] tmp_13_i_reg_139;
reg    ap_block_pp0_stage0_01001;
wire   [175:0] tmp_14_i_fu_102_p4;
wire   [175:0] or_ln174_fu_110_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_99_nbreadreq_fu_54_p3 == 1'd1) & (tmp_i_nbreadreq_fu_46_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        connMeta_remote_qpn_V_reg_129 <= connMeta_remote_qpn_V_fu_88_p1;
        tmp_13_i_reg_139 <= {{tx_connTable2ibh_rsp_dout[271:128]}};
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ap_predicate_op32_write_state2 == 1'b1) & (tx_dstQpFifo_full_n == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (tx_ipUdpMetaFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op26_read_state1 == 1'b1) & (tx_lengthFifo_empty_n == 1'b0)) | ((ap_predicate_op24_read_state1 == 1'b1) & (tx_connTable2ibh_rsp_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ap_predicate_op32_write_state2 == 1'b1) & (tx_dstQpFifo_full_n == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (tx_ipUdpMetaFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op26_read_state1 == 1'b1) & (tx_lengthFifo_empty_n == 1'b0)) | ((ap_predicate_op24_read_state1 == 1'b1) & (tx_connTable2ibh_rsp_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ap_predicate_op32_write_state2 == 1'b1) & (tx_dstQpFifo_full_n == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (tx_ipUdpMetaFifo_full_n == 1'b0)))) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op26_read_state1 == 1'b1) & (tx_lengthFifo_empty_n == 1'b0)) | ((ap_predicate_op24_read_state1 == 1'b1) & (tx_connTable2ibh_rsp_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((ap_predicate_op26_read_state1 == 1'b1) & (tx_lengthFifo_empty_n == 1'b0)) | ((ap_predicate_op24_read_state1 == 1'b1) & (tx_connTable2ibh_rsp_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((ap_predicate_op32_write_state2 == 1'b1) & (tx_dstQpFifo_full_n == 1'b0)) | ((ap_predicate_op31_write_state2 == 1'b1) & (tx_ipUdpMetaFifo_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_predicate_op24_read_state1 = ((tmp_i_99_nbreadreq_fu_54_p3 == 1'd1) & (tmp_i_nbreadreq_fu_46_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op26_read_state1 = ((tmp_i_99_nbreadreq_fu_54_p3 == 1'd1) & (tmp_i_nbreadreq_fu_46_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op31_write_state2 = ((tmp_i_99_reg_125 == 1'd1) & (tmp_i_reg_121 == 1'd1));
end

always @ (*) begin
    ap_predicate_op32_write_state2 = ((tmp_i_99_reg_125 == 1'd1) & (tmp_i_reg_121 == 1'd1));
end

assign connMeta_remote_qpn_V_fu_88_p1 = tx_connTable2ibh_rsp_dout[23:0];

assign or_ln174_fu_110_p2 = (tmp_14_i_fu_102_p4 | 176'd106842870246160215471097626244258299975152173056);

assign tmp_14_i_fu_102_p4 = {{{len_reg_134}, {16'd0}}, {tmp_13_i_reg_139}};

assign tmp_i_99_nbreadreq_fu_54_p3 = tx_lengthFifo_empty_n;

assign tmp_i_nbreadreq_fu_46_p3 = tx_connTable2ibh_rsp_empty_n;

assign tx_dstQpFifo_din = connMeta_remote_qpn_V_reg_129;

assign tx_ipUdpMetaFifo_din = or_ln174_fu_110_p2;
