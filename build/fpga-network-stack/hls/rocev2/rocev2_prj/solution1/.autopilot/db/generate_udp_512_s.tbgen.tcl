...
set C_modelArgList {
	...
	{ tx_udp2ipFifo int 1024 regular {fifo 1 volatile } {global 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "tx_udpMetaFifo", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "tx_udp2ipFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
...
set portList { 
	...
	{ tx_udp2ipFifo_din sc_out sc_lv 1024 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tx_udp2ipFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "tx_udp2ipFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	tx_udp2ipFifo { ap_fifo {  { tx_udp2ipFifo_din fifo_port_we 1 1024 }  { tx_udp2ipFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_udp2ipFifo_fifo_cap fifo_update 0 2 }  { tx_udp2ipFifo_full_n fifo_status 0 1 }  { tx_udp2ipFifo_write fifo_data 1 1 } } }
