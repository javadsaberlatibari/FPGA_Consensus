set moduleName prepend_ibh_header_512_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {prepend_ibh_header<512>}
set C_modelType { void 0 }
set C_modelArgList {
	{ tx_ibhHeaderFifo int 256 regular {fifo 0 volatile } {global 0}  }
	{ tx_ib2udpFifo int 1024 regular {fifo 1 volatile } {global 1}  }
	{ tx_shift2ibhFifo int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tx_ibhHeaderFifo", "interface" : "fifo", "bitwidth" : 256, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "tx_ib2udpFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "tx_shift2ibhFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ tx_shift2ibhFifo_dout sc_in sc_lv 1024 signal 2 } 
	...
	{ tx_ibhHeaderFifo_dout sc_in sc_lv 256 signal 0 } 
	...
	{ tx_ib2udpFifo_din sc_out sc_lv 1024 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tx_shift2ibhFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "tx_shift2ibhFifo", "role": "dout" }} , 
 	...
 	{ "name": "tx_ibhHeaderFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "tx_ibhHeaderFifo", "role": "dout" }} , 
 	...
 	{ "name": "tx_ib2udpFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "tx_ib2udpFifo", "role": "din" }} , 
...
set Spec2ImplPortList { 
	tx_ibhHeaderFifo { ap_fifo {  { tx_ibhHeaderFifo_dout fifo_port_we 0 256 }  { tx_ibhHeaderFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_ibhHeaderFifo_fifo_cap fifo_update 0 2 }  { tx_ibhHeaderFifo_empty_n fifo_status 0 1 }  { tx_ibhHeaderFifo_read fifo_data 1 1 } } }
	tx_ib2udpFifo { ap_fifo {  { tx_ib2udpFifo_din fifo_port_we 1 1024 }  { tx_ib2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_ib2udpFifo_fifo_cap fifo_update 0 2 }  { tx_ib2udpFifo_full_n fifo_status 0 1 }  { tx_ib2udpFifo_write fifo_data 1 1 } } }
	tx_shift2ibhFifo { ap_fifo {  { tx_shift2ibhFifo_dout fifo_port_we 0 1024 }  { tx_shift2ibhFifo_num_data_valid fifo_status_num_data_valid 0 4 }  { tx_shift2ibhFifo_fifo_cap fifo_update 0 4 }  { tx_shift2ibhFifo_empty_n fifo_status 0 1 }  { tx_shift2ibhFifo_read fifo_data 1 1 } } }
}
