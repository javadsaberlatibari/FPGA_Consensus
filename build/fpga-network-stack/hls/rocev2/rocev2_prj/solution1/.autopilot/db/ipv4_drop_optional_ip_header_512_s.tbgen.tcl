...
set C_modelArgList {
	...
	{ rx_ip2udpFifo int 1024 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "rx_process2dropLengthFifo", "interface" : "fifo", "bitwidth" : 4, "direction" : "READONLY", "extern" : 0} , 
 	...
 	{ "Name" : "rx_ip2udpFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ rx_process2dropLengthFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ rx_process2dropLengthFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ rx_process2dropLengthFifo_empty_n sc_in sc_logic 1 signal 0 } 
	{ rx_process2dropLengthFifo_read sc_out sc_logic 1 signal 0 } 
	{ rx_ip2udpFifo_din sc_out sc_lv 1024 signal 2 } 
	{ rx_ip2udpFifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ rx_ip2udpFifo_fifo_cap sc_in sc_lv 2 signal 2 } 
	{ rx_ip2udpFifo_full_n sc_in sc_logic 1 signal 2 } 
	{ rx_ip2udpFifo_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rx_ip2udpFifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "rx_ip2udpFifo", "role": "din" }} , 
 	...
 	{ "name": "rx_ip2udpFifo_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rx_ip2udpFifo", "role": "full_n" }} , 
 	{ "name": "rx_ip2udpFifo_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "rx_ip2udpFifo", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "rx_ip2udpFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	rx_process2dropLengthFifo { ap_fifo {  { rx_process2dropLengthFifo_dout fifo_port_we 0 4 }  { rx_process2dropLengthFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rx_process2dropLengthFifo_fifo_cap fifo_update 0 2 }  { rx_process2dropLengthFifo_empty_n fifo_status 0 1 }  { rx_process2dropLengthFifo_read fifo_data 1 1 } } }
	rx_process2dropFifo { ap_fifo {  { rx_process2dropFifo_dout fifo_port_we 0 1024 }  { rx_process2dropFifo_num_data_valid fifo_status_num_data_valid 0 4 }  { rx_process2dropFifo_fifo_cap fifo_update 0 4 }  { rx_process2dropFifo_empty_n fifo_status 0 1 }  { rx_process2dropFifo_read fifo_data 1 1 } } }
	rx_ip2udpFifo { ap_fifo {  { rx_ip2udpFifo_din fifo_port_we 1 1024 }  { rx_ip2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rx_ip2udpFifo_fifo_cap fifo_update 0 2 }  { rx_ip2udpFifo_full_n fifo_status 0 1 }  { rx_ip2udpFifo_write fifo_data 1 1 } } }
}
