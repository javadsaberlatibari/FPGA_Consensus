...
set C_modelArgList {
	...
	{ tx_ib2udpFifo int 1024 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tx_shift2udpFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "WRITEONLY", "extern" : 0} , 
 	{ "Name" : "tx_ib2udpFifo", "interface" : "fifo", "bitwidth" : 1024, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ tx_ib2udpFifo_dout sc_in sc_lv 1024 signal 1 } 
	{ tx_ib2udpFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ tx_ib2udpFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ tx_ib2udpFifo_empty_n sc_in sc_logic 1 signal 1 } 
	{ tx_ib2udpFifo_read sc_out sc_logic 1 signal 1 } 
	{ tx_shift2udpFifo_din sc_out sc_lv 1024 signal 0 } 
	{ tx_shift2udpFifo_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ tx_shift2udpFifo_fifo_cap sc_in sc_lv 2 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tx_ib2udpFifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":1024, "type": "signal", "bundle":{"name": "tx_ib2udpFifo", "role": "dout" }} , 
 	...
 	{ "name": "tx_ib2udpFifo_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tx_ib2udpFifo", "role": "empty_n" }} , 
 	{ "name": "tx_ib2udpFifo_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "tx_ib2udpFifo", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "tx_ib2udpFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	tx_shift2udpFifo { ap_fifo {  { tx_shift2udpFifo_din fifo_port_we 1 1024 }  { tx_shift2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_shift2udpFifo_fifo_cap fifo_update 0 2 }  { tx_shift2udpFifo_full_n fifo_status 0 1 }  { tx_shift2udpFifo_write fifo_data 1 1 } } }
	tx_ib2udpFifo { ap_fifo {  { tx_ib2udpFifo_dout fifo_port_we 0 1024 }  { tx_ib2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_ib2udpFifo_fifo_cap fifo_update 0 2 }  { tx_ib2udpFifo_empty_n fifo_status 0 1 }  { tx_ib2udpFifo_read fifo_data 1 1 } } }
}
