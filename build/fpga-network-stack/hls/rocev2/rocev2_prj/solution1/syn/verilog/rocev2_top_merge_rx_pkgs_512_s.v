...
module rocev2_top_merge_rx_pkgs_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
wire   [0:0] tmp_151_i_nbreadreq_fu_52_p3;
reg    ap_predicate_op26_read_state1;
wire   [0:0] tmp_i_229_nbreadreq_fu_66_p3;
reg    ap_predicate_op35_read_state1;
wire   [0:0] tmp_152_i_nbreadreq_fu_80_p3;
...
reg   [1023:0] rx_rethSift2mergerFifo_read_reg_217;
wire   [576:0] trunc_ln174_fu_141_p1;
reg   [576:0] trunc_ln174_reg_232;
reg   [1023:0] rx_exhNoShiftFifo_read_reg_241;
wire   [1023:0] zext_ln174_fu_205_p1;
wire   [1:0] select_ln2004_1_fu_191_p3;
wire   [0:0] currWord_last_V_16_fu_119_p3;
wire   [0:0] currWord_last_V_15_fu_133_p3;
wire   [0:0] currWord_last_V_fu_151_p3;
reg    ap_block_pp0_stage0_01001;
wire   [0:0] icmp_ln2004_1_fu_171_p2;
wire   [0:0] icmp_ln2004_fu_165_p2;
wire   [0:0] or_ln2004_fu_185_p2;
wire   [1:0] select_ln2004_fu_177_p3;
reg   [0:0] ap_NS_fsm;
reg    ap_idle_pp0_0to1;
reg    ap_reset_idle_pp0;
wire    ap_enable_pp0;
reg   [1023:0] m_axis_mem_write_data_TDATA_int_regslice;
...
always @ (posedge ap_clk) begin
    ...
    end else if ((((tmp_152_i_nbreadreq_fu_80_p3 == 1'd1) & (state_3 == 2'd3) & (currWord_last_V_fu_151_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_i_229_nbreadreq_fu_66_p3 == 1'd1) & (state_3 == 2'd1) & (currWord_last_V_15_fu_133_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((tmp_151_i_nbreadreq_fu_52_p3 == 1'd1) & (state_3 == 2'd2) & (currWord_last_V_16_fu_119_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        state_3 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_i_229_nbreadreq_fu_66_p3 == 1'd1) & (state_3 == 2'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_predicate_op26_read_state1 = ((tmp_151_i_nbreadreq_fu_52_p3 == 1'd1) & (state_3 == 2'd2));
end

always @ (*) begin
    ap_predicate_op35_read_state1 = ((tmp_i_229_nbreadreq_fu_66_p3 == 1'd1) & (state_3 == 2'd1));
end

always @ (*) begin
    ap_predicate_op45_read_state1 = ((tmp_152_i_nbreadreq_fu_80_p3 == 1'd1) & (state_3 == 2'd3));
end
...
always @ (*) begin
    ap_predicate_op63_write_state2 = ((tmp_151_i_reg_213 == 1'd1) & (state_3_load_reg_209 == 2'd2));
end

always @ (*) begin
    ap_predicate_op65_write_state2 = ((tmp_i_229_reg_225 == 1'd1) & (state_3_load_reg_209 == 2'd1));
end

always @ (*) begin
    ap_predicate_op66_write_state2 = ((tmp_152_i_reg_237 == 1'd1) & (state_3_load_reg_209 == 2'd3));
end

always @ (*) begin
    ap_predicate_op67_write_state3 = ((tmp_151_i_reg_213_pp0_iter1_reg == 1'd1) & (state_3_load_reg_209_pp0_iter1_reg == 2'd2));
end

always @ (*) begin
    ap_predicate_op68_write_state3 = ((tmp_i_229_reg_225_pp0_iter1_reg == 1'd1) & (state_3_load_reg_209_pp0_iter1_reg == 2'd1));
end

always @ (*) begin
    ap_predicate_op69_write_state3 = ((tmp_152_i_reg_237_pp0_iter1_reg == 1'd1) & (state_3_load_reg_209_pp0_iter1_reg == 2'd3));
end

assign currWord_last_V_15_fu_133_p3 = rx_aethSift2mergerFifo_dout[1024'd576];

assign currWord_last_V_16_fu_119_p3 = rx_rethSift2mergerFifo_dout[1024'd576];

assign currWord_last_V_fu_151_p3 = rx_exhNoShiftFifo_dout[1024'd576];

assign icmp_ln2004_1_fu_171_p2 = ((rx_pkgShiftTypeFifo_dout == 32'd0) ? 1'b1 : 1'b0);

assign icmp_ln2004_fu_165_p2 = ((rx_pkgShiftTypeFifo_dout == 32'd1) ? 1'b1 : 1'b0);

assign m_axis_mem_write_data_TVALID = regslice_both_m_axis_mem_write_data_U_vld_out;

assign or_ln2004_fu_185_p2 = (icmp_ln2004_fu_165_p2 | icmp_ln2004_1_fu_171_p2);

assign select_ln2004_1_fu_191_p3 = ((or_ln2004_fu_185_p2[0:0] == 1'b1) ? select_ln2004_fu_177_p3 : 2'd3);

assign select_ln2004_fu_177_p3 = ((icmp_ln2004_1_fu_171_p2[0:0] == 1'b1) ? 2'd1 : 2'd2);

assign tmp_151_i_nbreadreq_fu_52_p3 = rx_rethSift2mergerFifo_empty_n;

assign tmp_152_i_nbreadreq_fu_80_p3 = rx_exhNoShiftFifo_empty_n;

assign tmp_i_229_nbreadreq_fu_66_p3 = rx_aethSift2mergerFifo_empty_n;

assign tmp_i_nbreadreq_fu_94_p3 = rx_pkgShiftTypeFifo_empty_n;

assign trunc_ln174_fu_141_p1 = rx_aethSift2mergerFifo_dout[576:0];

assign zext_ln174_fu_205_p1 = trunc_ln174_reg_232;

endmodule //rocev2_top_merge_rx_pkgs_512_s
