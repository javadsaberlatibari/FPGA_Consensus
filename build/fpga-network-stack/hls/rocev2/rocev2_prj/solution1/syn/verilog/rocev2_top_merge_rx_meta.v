...
wire   [0:0] tmp_i_230_nbreadreq_fu_42_p3;
reg    ap_predicate_op20_read_state1;
reg    ap_predicate_op22_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [0:0] tmp_i_reg_98;
reg   [0:0] tmp_i_230_reg_102;
reg   [0:0] meta1_valid_reg_111;
...
wire   [31:0] meta0_their_address_V_fu_69_p1;
reg   [31:0] meta0_their_address_V_reg_106;
wire   [0:0] meta1_valid_fu_73_p3;
wire   [47:0] trunc_ln174_fu_81_p1;
reg   [47:0] trunc_ln174_reg_115;
reg    ap_block_pp0_stage0_01001;
wire   [175:0] tmp_168_i_fu_85_p4;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_230_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_nbreadreq_fu_34_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        meta0_their_address_V_reg_106 <= meta0_their_address_V_fu_69_p1;
        meta1_valid_reg_111 <= rx_udpMetaFifo_dout[64'd48];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_i_230_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_nbreadreq_fu_34_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (meta1_valid_fu_73_p3 == 1'd1))) begin
...
always @ (*) begin
    ap_predicate_op20_read_state1 = ((tmp_i_230_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_nbreadreq_fu_34_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op22_read_state1 = ((tmp_i_230_nbreadreq_fu_42_p3 == 1'd1) & (tmp_i_nbreadreq_fu_34_p3 == 1'd1));
end

always @ (*) begin
    ap_predicate_op29_write_state2 = ((meta1_valid_reg_111 == 1'd1) & (tmp_i_230_reg_102 == 1'd1) & (tmp_i_reg_98 == 1'd1));
end

assign meta0_their_address_V_fu_69_p1 = rx_ip2udpMetaFifo_dout[31:0];

assign meta1_valid_fu_73_p3 = rx_udpMetaFifo_dout[64'd48];

assign rx_ipUdpMetaFifo_din = tmp_168_i_fu_85_p4;

assign tmp_168_i_fu_85_p4 = {{{trunc_ln174_reg_115}, {96'd0}}, {meta0_their_address_V_reg_106}};

assign tmp_i_230_nbreadreq_fu_42_p3 = rx_udpMetaFifo_empty_n;

assign tmp_i_nbreadreq_fu_34_p3 = rx_ip2udpMetaFifo_empty_n;

assign trunc_ln174_fu_81_p1 = rx_udpMetaFifo_dout[47:0];
