    ...
    udp_top_hls_deadlock_detect_unit #(6, 0, 2, 2) udp_top_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~process_udp_512_U0.rx_udp2shiftFifo_blk_n);
    ...
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~process_udp_512_U0.rx_udpMetaFifo_blk_n);
    ...
    udp_top_hls_deadlock_detect_unit #(6, 1, 1, 1) udp_top_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~udp_rshiftWordByOctet_net_axis_512_512_2_U0.rx_udp2shiftFifo_blk_n);
    ...
    udp_top_hls_deadlock_detect_unit #(6, 2, 1, 1) udp_top_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~merge_rx_meta_U0.rx_udpMetaFifo_blk_n);
    ...
    udp_top_hls_deadlock_detect_unit #(6, 3, 1, 1) udp_top_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~split_tx_meta_U0.tx_udpMetaFifo_blk_n);
    ...
    assign in_chan_dep_data_vec_3[5 : 0] = dep_chan_data_5_3;
    ...
    udp_top_hls_deadlock_detect_unit #(6, 4, 1, 1) udp_top_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~udp_lshiftWordByOctet_512_1_U0.tx_shift2udpFifo_blk_n);
    ...
    udp_top_hls_deadlock_detect_unit #(6, 5, 2, 2) udp_top_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~generate_udp_512_U0.tx_udpMetaFifo_blk_n);
    ...
    assign proc_5_data_FIFO_blk[1] = 1'b0 | (~generate_udp_512_U0.tx_shift2udpFifo_blk_n);
