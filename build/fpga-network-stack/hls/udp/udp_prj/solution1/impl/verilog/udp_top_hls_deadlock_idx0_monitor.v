...
assign idx6_block = axis_block_sigs[7];
...
assign process_axis_block_vec[2] = idx3_block & (1'b0 | axis_block_sigs[2] | axis_block_sigs[3]);
assign process_idle_vec[2] = inst_idle_sigs[2];
assign process_chan_block_vec[2] = inst_block_sigs[2];
assign process_axis_block_vec[3] = idx4_block & (1'b0 | axis_block_sigs[4] | axis_block_sigs[5]);
assign process_idle_vec[3] = inst_idle_sigs[3];
assign process_chan_block_vec[3] = inst_block_sigs[3];
assign process_axis_block_vec[4] = idx5_block & (1'b0 | axis_block_sigs[6]);
assign process_idle_vec[4] = inst_idle_sigs[4];
assign process_chan_block_vec[4] = inst_block_sigs[4];
assign process_axis_block_vec[5] = idx6_block & (1'b0 | axis_block_sigs[7]);
...
// instant sub module
 udp_top_hls_deadlock_idx3_monitor udp_top_hls_deadlock_idx3_monitor_U (
    .clock(clock),
    .reset(reset),
 ...
 udp_top_hls_deadlock_idx4_monitor udp_top_hls_deadlock_idx4_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
