...
set portList { 
	...
	{ tx_udpMetaFifo_dout sc_in sc_lv 64 signal 1 } 
	{ tx_udpMetaFifo_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ tx_udpMetaFifo_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ tx_udpMetaFifo_empty_n sc_in sc_logic 1 signal 1 } 
	{ tx_udpMetaFifo_read sc_out sc_logic 1 signal 1 } 
...
set Spec2ImplPortList { 
	...
	tx_shift2udpFifo { ap_fifo {  { tx_shift2udpFifo_dout fifo_port_we 0 1024 }  { tx_shift2udpFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { tx_shift2udpFifo_fifo_cap fifo_update 0 2 }  { tx_shift2udpFifo_empty_n fifo_status 0 1 }  { tx_shift2udpFifo_read fifo_data 1 1 } } }
}
