...
#define AUTOTB_TVIN_s_axis_rx_data "../tv/cdatafile/c.udp_top.autotvin_s_axis_rx_data.dat"
#define AUTOTB_TVOUT_s_axis_rx_data "../tv/cdatafile/c.udp_top.autotvout_s_axis_rx_data.dat"
...
#define AUTOTB_TVIN_m_axis_rx_data "../tv/cdatafile/c.udp_top.autotvin_m_axis_rx_data.dat"
#define AUTOTB_TVOUT_m_axis_rx_data "../tv/cdatafile/c.udp_top.autotvout_m_axis_rx_data.dat"
#define WRAPC_STREAM_SIZE_OUT_m_axis_rx_data "../tv/stream_size/stream_size_out_m_axis_rx_data.dat"
#define WRAPC_STREAM_EGRESS_STATUS_m_axis_rx_data "../tv/stream_size/stream_egress_status_m_axis_rx_data.dat"
...
#define AUTOTB_TVIN_s_axis_tx_data "../tv/cdatafile/c.udp_top.autotvin_s_axis_tx_data.dat"
#define AUTOTB_TVOUT_s_axis_tx_data "../tv/cdatafile/c.udp_top.autotvout_s_axis_tx_data.dat"
...
#define AUTOTB_TVIN_m_axis_tx_data "../tv/cdatafile/c.udp_top.autotvin_m_axis_tx_data.dat"
#define AUTOTB_TVOUT_m_axis_tx_data "../tv/cdatafile/c.udp_top.autotvout_m_axis_tx_data.dat"
...
#define AUTOTB_TVOUT_PC_s_axis_rx_data "../tv/rtldatafile/rtl.udp_top.autotvout_s_axis_rx_data.dat"
#define AUTOTB_TVOUT_PC_m_axis_rx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_rx_meta.dat"
#define AUTOTB_TVOUT_PC_m_axis_rx_data "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_rx_data.dat"
#define AUTOTB_TVOUT_PC_s_axis_tx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_s_axis_tx_meta.dat"
#define AUTOTB_TVOUT_PC_s_axis_tx_data "../tv/rtldatafile/rtl.udp_top.autotvout_s_axis_tx_data.dat"
#define AUTOTB_TVOUT_PC_m_axis_tx_meta "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_tx_meta.dat"
#define AUTOTB_TVOUT_PC_m_axis_tx_data "../tv/rtldatafile/rtl.udp_top.autotvout_m_axis_tx_data.dat"
...
string get_depth_list () {
  ...
  total_list << "{m_axis_rx_data " << m_axis_rx_data_depth << "}\n";
...
extern "C" void udp_top_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, __cosim_s16__*, __cosim_s2__*);

extern "C" void apatb_udp_top_hw(volatile void * __xlx_apatb_param_s_axis_rx_meta, volatile void * __xlx_apatb_param_s_axis_rx_data, volatile void * __xlx_apatb_param_m_axis_rx_meta, volatile void * __xlx_apatb_param_m_axis_rx_data, volatile void * __xlx_apatb_param_s_axis_tx_meta, volatile void * __xlx_apatb_param_s_axis_tx_data, volatile void * __xlx_apatb_param_m_axis_tx_meta, volatile void * __xlx_apatb_param_m_axis_tx_data, __cosim_s16__* __xlx_apatb_param_reg_ip_address, __cosim_s2__* __xlx_apatb_param_reg_listen_port) {
...
long __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size; ++i)((hls::stream<__cosim_s8__>*)__xlx_apatb_param_s_axis_rx_meta)->read();
...
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<256> > m_axis_rx_meta_pc_buffer;
          int i = 0;
...
__cosim_s32__ xlx_stream_elt __attribute__ ((aligned));
...
((long long*)&xlx_stream_elt)[0*4+2] = m_axis_rx_meta_pc_buffer[j].range(191,128).to_int64();
((long long*)&xlx_stream_elt)[0*4+3] = m_axis_rx_meta_pc_buffer[j].range(255,192).to_int64();
((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  long __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){__xlx_apatb_param_m_axis_rx_data_stream_buf_final_size = atoi(AESL_token.c_str());
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_m_axis_rx_data);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<1024> > m_axis_rx_data_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
            ...
            // push token into output port buffer
            if (AESL_token != "") {
              m_axis_rx_data_pc_buffer.push_back(AESL_token.c_str());
              i++;
            }
...
((long long*)&xlx_stream_elt)[0*16+0] = m_axis_rx_data_pc_buffer[j].range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*16+1] = m_axis_rx_data_pc_buffer[j].range(127,64).to_int64();
((long long*)&xlx_stream_elt)[0*16+2] = m_axis_rx_data_pc_buffer[j].range(191,128).to_int64();
((long long*)&xlx_stream_elt)[0*16+3] = m_axis_rx_data_pc_buffer[j].range(255,192).to_int64();
((long long*)&xlx_stream_elt)[0*16+4] = m_axis_rx_data_pc_buffer[j].range(319,256).to_int64();
((long long*)&xlx_stream_elt)[0*16+5] = m_axis_rx_data_pc_buffer[j].range(383,320).to_int64();
((long long*)&xlx_stream_elt)[0*16+6] = m_axis_rx_data_pc_buffer[j].range(447,384).to_int64();
((long long*)&xlx_stream_elt)[0*16+7] = m_axis_rx_data_pc_buffer[j].range(511,448).to_int64();
((long long*)&xlx_stream_elt)[0*16+8] = m_axis_rx_data_pc_buffer[j].range(575,512).to_int64();
((long long*)&xlx_stream_elt)[0*16+9] = m_axis_rx_data_pc_buffer[j].range(639,576).to_int64();
((long long*)&xlx_stream_elt)[0*16+10] = m_axis_rx_data_pc_buffer[j].range(703,640).to_int64();
((long long*)&xlx_stream_elt)[0*16+11] = m_axis_rx_data_pc_buffer[j].range(767,704).to_int64();
((long long*)&xlx_stream_elt)[0*16+12] = m_axis_rx_data_pc_buffer[j].range(831,768).to_int64();
((long long*)&xlx_stream_elt)[0*16+13] = m_axis_rx_data_pc_buffer[j].range(895,832).to_int64();
((long long*)&xlx_stream_elt)[0*16+14] = m_axis_rx_data_pc_buffer[j].range(959,896).to_int64();
((long long*)&xlx_stream_elt)[0*16+15] = m_axis_rx_data_pc_buffer[j].range(1023,960).to_int64();
((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->write(xlx_stream_elt);
}
}
        } // end transaction
      } // end file is good
...
long __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size;
{
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > m_axis_tx_meta_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
((char*)&xlx_stream_elt)[0*8+6] = m_axis_tx_meta_pc_buffer[j].range(55, 48).to_int64();
((char*)&xlx_stream_elt)[0*8+7] = m_axis_tx_meta_pc_buffer[j].range(63, 56).to_int64();
...
aesl_fh.touch(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data);
aesl_fh.touch(WRAPC_STREAM_EGRESS_STATUS_m_axis_rx_data);
...
std::vector<__cosim_s32__> __xlx_apatb_param_m_axis_rx_meta_stream_buf;
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_size = ((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->size();
std::vector<__cosim_s128__> __xlx_apatb_param_m_axis_rx_data_stream_buf;
long __xlx_apatb_param_m_axis_rx_data_stream_buf_size = ((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->size();
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_reg_ip_address;
aesl_fh.write(AUTOTB_TVIN_reg_ip_address, formatData(pos, 128));
}
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_reg_listen_port;
aesl_fh.write(AUTOTB_TVIN_reg_listen_port, formatData(pos, 16));
}
...
for (int i = 0; i < __xlx_apatb_param_s_axis_rx_meta_stream_buf_final_size; ++i) {
unsigned char *pos = (unsigned char*)(__xlx_apatb_param_s_axis_rx_meta_stream_buf.data()+i);
std::string s(formatData(pos, 64));
aesl_fh.write(AUTOTB_TVIN_s_axis_rx_meta, s);
}
...
long __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size = ((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->size() - __xlx_apatb_param_m_axis_rx_meta_stream_buf_size;
{
  while (!((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->empty())
    __xlx_apatb_param_m_axis_rx_meta_stream_buf.push_back(((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_meta_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s32__>*)__xlx_apatb_param_m_axis_rx_meta)->write(__xlx_apatb_param_m_axis_rx_meta_stream_buf[i]);
  }
// print m_axis_rx_meta Transactions
{
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_meta, begin_str(AESL_transaction));
for (int i = 0; i < __xlx_apatb_param_m_axis_rx_meta_stream_buf_final_size; ++i) {
unsigned char *pos = (unsigned char*)(__xlx_apatb_param_m_axis_rx_meta_stream_buf.data()+__xlx_apatb_param_m_axis_rx_meta_stream_buf_size+i);
std::string s(formatData(pos, 256));
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_meta, s);
}
...
long __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size = ((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->size() - __xlx_apatb_param_m_axis_rx_data_stream_buf_size;
{
  while (!((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->empty())
    __xlx_apatb_param_m_axis_rx_data_stream_buf.push_back(((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->read());
  for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_stream_buf.size(); ++i)
    ((hls::stream<__cosim_s128__>*)__xlx_apatb_param_m_axis_rx_data)->write(__xlx_apatb_param_m_axis_rx_data_stream_buf[i]);
  }
// print m_axis_rx_data Transactions
{
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data, begin_str(AESL_transaction));
for (int i = 0; i < __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size; ++i) {
unsigned char *pos = (unsigned char*)(__xlx_apatb_param_m_axis_rx_data_stream_buf.data()+__xlx_apatb_param_m_axis_rx_data_stream_buf_size+i);
std::string s(formatData(pos, 1024));
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data, s);
}

  tcl_file.set_num(__xlx_apatb_param_m_axis_rx_data_stream_buf_final_size, &tcl_file.m_axis_rx_data_depth);
aesl_fh.write(AUTOTB_TVOUT_m_axis_rx_data, end_str());
}

{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_m_axis_rx_data_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_m_axis_rx_data, end_str());
}
...
for (int i = 0; i < __xlx_apatb_param_m_axis_tx_meta_stream_buf_final_size; ++i) {
unsigned char *pos = (unsigned char*)(__xlx_apatb_param_m_axis_tx_meta_stream_buf.data()+__xlx_apatb_param_m_axis_tx_meta_stream_buf_size+i);
std::string s(formatData(pos, 64));
aesl_fh.write(AUTOTB_TVOUT_m_axis_tx_meta, s);
}
