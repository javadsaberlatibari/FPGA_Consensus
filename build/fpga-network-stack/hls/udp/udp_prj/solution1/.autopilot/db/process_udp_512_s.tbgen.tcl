...
set C_modelArgList {
	...
	{ regListenPort int 16 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_rx_data", "interface" : "axis", "bitwidth" : 1024, "direction" : "READONLY"} , 
 	{ "Name" : "regListenPort", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rx_udpMetaFifo_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ rx_udpMetaFifo_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ rx_udp2shiftFifo_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ rx_udp2shiftFifo_fifo_cap sc_in sc_lv 2 signal 2 } 
	...
	{ regListenPort sc_in sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "regListenPort", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "regListenPort", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	regListenPort { ap_stable {  { regListenPort in_data 0 16 } } }
