...
set portList { 
	...
	{ m_axis_rx_meta_TDATA sc_out sc_lv 256 signal 1 } 
...
set Spec2ImplPortList { 
	s_axis_rx_meta { axis {  { s_axis_rx_meta_TVALID in_vld 0 1 }  { s_axis_rx_meta_TDATA in_data 0 64 }  { s_axis_rx_meta_TREADY in_acc 1 1 } } }
	m_axis_rx_meta { axis {  { m_axis_rx_meta_TREADY out_acc 0 1 }  { m_axis_rx_meta_TDATA out_data 1 256 }  { m_axis_rx_meta_TVALID out_vld 1 1 } } }
	rx_udpMetaFifo { ap_fifo {  { rx_udpMetaFifo_dout fifo_port_we 0 64 }  { rx_udpMetaFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { rx_udpMetaFifo_fifo_cap fifo_update 0 2 }  { rx_udpMetaFifo_empty_n fifo_status 0 1 }  { rx_udpMetaFifo_read fifo_data 1 1 } } }
}
