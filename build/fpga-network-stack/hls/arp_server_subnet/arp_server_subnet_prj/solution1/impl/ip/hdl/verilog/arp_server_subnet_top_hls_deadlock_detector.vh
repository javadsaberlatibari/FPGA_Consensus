    ...
    arp_server_subnet_top_hls_deadlock_detect_unit #(3, 0, 2, 2) arp_server_subnet_top_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~process_arp_pkg_512_U0.arpReplyMetaFifo_blk_n);
    ...
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~process_arp_pkg_512_U0.arpTableInsertFifo_blk_n);
    ...
    arp_server_subnet_top_hls_deadlock_detect_unit #(3, 1, 2, 2) arp_server_subnet_top_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~generate_arp_pkg_512_U0.arpReplyMetaFifo_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~generate_arp_pkg_512_U0.arpRequestMetaFifo_blk_n);
    ...
    arp_server_subnet_top_hls_deadlock_detect_unit #(3, 2, 2, 2) arp_server_subnet_top_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~arp_table_U0.arpTableInsertFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~arp_table_U0.arpRequestMetaFifo_blk_n);
