...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_arp_lookup_reply_TREADY { I 1 bit } m_axis_arp_lookup_reply_TDATA { O 128 vector } m_axis_arp_lookup_reply_TVALID { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_host_arp_lookup_reply_TREADY { I 1 bit } m_axis_host_arp_lookup_reply_TDATA { O 128 vector } m_axis_host_arp_lookup_reply_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpTableInsertFifo_dout { I 192 vector } arpTableInsertFifo_num_data_valid { I 3 vector } arpTableInsertFifo_fifo_cap { I 3 vector } arpTableInsertFifo_empty_n { I 1 bit } arpTableInsertFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpRequestMetaFifo_din { O 32 vector } arpRequestMetaFifo_num_data_valid { I 3 vector } arpRequestMetaFifo_fifo_cap { I 3 vector } arpRequestMetaFifo_full_n { I 1 bit } arpRequestMetaFifo_write { O 1 bit } } \
} "
}
