...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("s_axis_lup_req_TDATA", 128, hls_in, 0, "axis", "in_data", 1),
	...
	Port_Property("s_axis_upd_req_TDATA", 192, hls_in, 1, "axis", "in_data", 1),
	...
	Port_Property("m_axis_lup_rsp_TDATA", 128, hls_out, 2, "axis", "out_data", 1),
	...
	Port_Property("m_axis_upd_rsp_TDATA", 192, hls_out, 3, "axis", "out_data", 1),
	...
	Port_Property("regInsertFailureCount", 16, hls_out, 4, "ap_vld", "out_data", 1),
	Port_Property("regInsertFailureCount_ap_vld", 1, hls_out, 4, "ap_vld", "out_vld", 1),
};
