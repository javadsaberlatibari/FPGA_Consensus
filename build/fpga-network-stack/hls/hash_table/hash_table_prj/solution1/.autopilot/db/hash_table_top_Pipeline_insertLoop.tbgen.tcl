...
set C_modelArgList {
	...
	{ xor_ln886_out int 1 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "victimBit_V_load", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "xor_ln886_out", "interface" : "wire", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ xor_ln886_out sc_out sc_lv 1 signal 4 } 
	{ xor_ln886_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "xor_ln886_out", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "xor_ln886_out", "role": "default" }} , 
 	{ "name": "xor_ln886_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "xor_ln886_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ret2_calculate_hashes_fu_1646", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "13", "Max" : "80"}
	, {"Name" : "Interval", "Min" : "13", "Max" : "80"}
]}
...
set Spec2ImplPortList { 
	...
	xor_ln886_out { ap_vld {  { xor_ln886_out out_data 1 1 }  { xor_ln886_out_ap_vld out_vld 1 1 } } }
	cuckooTables { ap_memory {  { cuckooTables_address0 mem_address 1 6 }  { cuckooTables_ce0 mem_ce 1 1 }  { cuckooTables_q0 mem_dout 0 64 }  { cuckooTables_address1 MemPortADDR2 1 6 }  { cuckooTables_ce1 MemPortCE2 1 1 }  { cuckooTables_we1 MemPortWE2 1 1 }  { cuckooTables_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_18 { ap_memory {  { cuckooTables_18_address0 mem_address 1 6 }  { cuckooTables_18_ce0 mem_ce 1 1 }  { cuckooTables_18_q0 mem_dout 0 1 }  { cuckooTables_18_address1 MemPortADDR2 1 6 }  { cuckooTables_18_ce1 MemPortCE2 1 1 }  { cuckooTables_18_we1 MemPortWE2 1 1 }  { cuckooTables_18_d1 MemPortDIN2 1 1 } } }
	cuckooTables_1 { ap_memory {  { cuckooTables_1_address0 mem_address 1 6 }  { cuckooTables_1_ce0 mem_ce 1 1 }  { cuckooTables_1_q0 mem_dout 0 64 }  { cuckooTables_1_address1 MemPortADDR2 1 6 }  { cuckooTables_1_ce1 MemPortCE2 1 1 }  { cuckooTables_1_we1 MemPortWE2 1 1 }  { cuckooTables_1_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_19 { ap_memory {  { cuckooTables_19_address0 mem_address 1 6 }  { cuckooTables_19_ce0 mem_ce 1 1 }  { cuckooTables_19_q0 mem_dout 0 1 }  { cuckooTables_19_address1 MemPortADDR2 1 6 }  { cuckooTables_19_ce1 MemPortCE2 1 1 }  { cuckooTables_19_we1 MemPortWE2 1 1 }  { cuckooTables_19_d1 MemPortDIN2 1 1 } } }
	cuckooTables_2 { ap_memory {  { cuckooTables_2_address0 mem_address 1 6 }  { cuckooTables_2_ce0 mem_ce 1 1 }  { cuckooTables_2_q0 mem_dout 0 64 }  { cuckooTables_2_address1 MemPortADDR2 1 6 }  { cuckooTables_2_ce1 MemPortCE2 1 1 }  { cuckooTables_2_we1 MemPortWE2 1 1 }  { cuckooTables_2_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_20 { ap_memory {  { cuckooTables_20_address0 mem_address 1 6 }  { cuckooTables_20_ce0 mem_ce 1 1 }  { cuckooTables_20_q0 mem_dout 0 1 }  { cuckooTables_20_address1 MemPortADDR2 1 6 }  { cuckooTables_20_ce1 MemPortCE2 1 1 }  { cuckooTables_20_we1 MemPortWE2 1 1 }  { cuckooTables_20_d1 MemPortDIN2 1 1 } } }
	cuckooTables_3 { ap_memory {  { cuckooTables_3_address0 mem_address 1 6 }  { cuckooTables_3_ce0 mem_ce 1 1 }  { cuckooTables_3_q0 mem_dout 0 64 }  { cuckooTables_3_address1 MemPortADDR2 1 6 }  { cuckooTables_3_ce1 MemPortCE2 1 1 }  { cuckooTables_3_we1 MemPortWE2 1 1 }  { cuckooTables_3_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_21 { ap_memory {  { cuckooTables_21_address0 mem_address 1 6 }  { cuckooTables_21_ce0 mem_ce 1 1 }  { cuckooTables_21_q0 mem_dout 0 1 }  { cuckooTables_21_address1 MemPortADDR2 1 6 }  { cuckooTables_21_ce1 MemPortCE2 1 1 }  { cuckooTables_21_we1 MemPortWE2 1 1 }  { cuckooTables_21_d1 MemPortDIN2 1 1 } } }
	cuckooTables_4 { ap_memory {  { cuckooTables_4_address0 mem_address 1 6 }  { cuckooTables_4_ce0 mem_ce 1 1 }  { cuckooTables_4_q0 mem_dout 0 64 }  { cuckooTables_4_address1 MemPortADDR2 1 6 }  { cuckooTables_4_ce1 MemPortCE2 1 1 }  { cuckooTables_4_we1 MemPortWE2 1 1 }  { cuckooTables_4_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_22 { ap_memory {  { cuckooTables_22_address0 mem_address 1 6 }  { cuckooTables_22_ce0 mem_ce 1 1 }  { cuckooTables_22_q0 mem_dout 0 1 }  { cuckooTables_22_address1 MemPortADDR2 1 6 }  { cuckooTables_22_ce1 MemPortCE2 1 1 }  { cuckooTables_22_we1 MemPortWE2 1 1 }  { cuckooTables_22_d1 MemPortDIN2 1 1 } } }
	cuckooTables_5 { ap_memory {  { cuckooTables_5_address0 mem_address 1 6 }  { cuckooTables_5_ce0 mem_ce 1 1 }  { cuckooTables_5_q0 mem_dout 0 64 }  { cuckooTables_5_address1 MemPortADDR2 1 6 }  { cuckooTables_5_ce1 MemPortCE2 1 1 }  { cuckooTables_5_we1 MemPortWE2 1 1 }  { cuckooTables_5_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_23 { ap_memory {  { cuckooTables_23_address0 mem_address 1 6 }  { cuckooTables_23_ce0 mem_ce 1 1 }  { cuckooTables_23_q0 mem_dout 0 1 }  { cuckooTables_23_address1 MemPortADDR2 1 6 }  { cuckooTables_23_ce1 MemPortCE2 1 1 }  { cuckooTables_23_we1 MemPortWE2 1 1 }  { cuckooTables_23_d1 MemPortDIN2 1 1 } } }
	cuckooTables_6 { ap_memory {  { cuckooTables_6_address0 mem_address 1 6 }  { cuckooTables_6_ce0 mem_ce 1 1 }  { cuckooTables_6_q0 mem_dout 0 64 }  { cuckooTables_6_address1 MemPortADDR2 1 6 }  { cuckooTables_6_ce1 MemPortCE2 1 1 }  { cuckooTables_6_we1 MemPortWE2 1 1 }  { cuckooTables_6_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_24 { ap_memory {  { cuckooTables_24_address0 mem_address 1 6 }  { cuckooTables_24_ce0 mem_ce 1 1 }  { cuckooTables_24_q0 mem_dout 0 1 }  { cuckooTables_24_address1 MemPortADDR2 1 6 }  { cuckooTables_24_ce1 MemPortCE2 1 1 }  { cuckooTables_24_we1 MemPortWE2 1 1 }  { cuckooTables_24_d1 MemPortDIN2 1 1 } } }
	cuckooTables_7 { ap_memory {  { cuckooTables_7_address0 mem_address 1 6 }  { cuckooTables_7_ce0 mem_ce 1 1 }  { cuckooTables_7_q0 mem_dout 0 64 }  { cuckooTables_7_address1 MemPortADDR2 1 6 }  { cuckooTables_7_ce1 MemPortCE2 1 1 }  { cuckooTables_7_we1 MemPortWE2 1 1 }  { cuckooTables_7_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_25 { ap_memory {  { cuckooTables_25_address0 mem_address 1 6 }  { cuckooTables_25_ce0 mem_ce 1 1 }  { cuckooTables_25_q0 mem_dout 0 1 }  { cuckooTables_25_address1 MemPortADDR2 1 6 }  { cuckooTables_25_ce1 MemPortCE2 1 1 }  { cuckooTables_25_we1 MemPortWE2 1 1 }  { cuckooTables_25_d1 MemPortDIN2 1 1 } } }
	cuckooTables_8 { ap_memory {  { cuckooTables_8_address0 mem_address 1 6 }  { cuckooTables_8_ce0 mem_ce 1 1 }  { cuckooTables_8_q0 mem_dout 0 64 }  { cuckooTables_8_address1 MemPortADDR2 1 6 }  { cuckooTables_8_ce1 MemPortCE2 1 1 }  { cuckooTables_8_we1 MemPortWE2 1 1 }  { cuckooTables_8_d1 MemPortDIN2 1 64 } } }
	...
	cuckooTables_26 { ap_memory {  { cuckooTables_26_address0 mem_address 1 6 }  { cuckooTables_26_ce0 mem_ce 1 1 }  { cuckooTables_26_q0 mem_dout 0 1 }  { cuckooTables_26_address1 MemPortADDR2 1 6 }  { cuckooTables_26_ce1 MemPortCE2 1 1 }  { cuckooTables_26_we1 MemPortWE2 1 1 }  { cuckooTables_26_d1 MemPortDIN2 1 1 } } }
}
