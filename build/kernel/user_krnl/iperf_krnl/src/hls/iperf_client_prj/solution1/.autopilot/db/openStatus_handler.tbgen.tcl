...
set C_modelArgList {
	...
	{ openConStatusBuffer int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_open_status", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "openConStatusBuffer", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ openConStatusBuffer_din sc_out sc_lv 32 signal 1 } 
	{ openConStatusBuffer_num_data_valid sc_in sc_lv 10 signal 1 } 
	{ openConStatusBuffer_fifo_cap sc_in sc_lv 10 signal 1 } 
	{ openConStatusBuffer_full_n sc_in sc_logic 1 signal 1 } 
	{ openConStatusBuffer_write sc_out sc_logic 1 signal 1 } 
	{ s_axis_open_status_TDATA sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "openConStatusBuffer_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "openConStatusBuffer", "role": "din" }} , 
...
set Spec2ImplPortList { 
	s_axis_open_status { axis {  { s_axis_open_status_TVALID in_vld 0 1 }  { s_axis_open_status_TDATA in_data 0 32 }  { s_axis_open_status_TREADY in_acc 1 1 } } }
	openConStatusBuffer { ap_fifo {  { openConStatusBuffer_din fifo_port_we 1 32 }  { openConStatusBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { openConStatusBuffer_fifo_cap fifo_update 0 10 }  { openConStatusBuffer_full_n fifo_status 0 1 }  { openConStatusBuffer_write fifo_data 1 1 } } }
}
