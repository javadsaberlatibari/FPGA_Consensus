...
port (
    ...
    s_axis_open_status_TDATA : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    s_axis_tx_status_TDATA : IN STD_LOGIC_VECTOR (95 downto 0);
...
architecture behav of iperf_client is 
    ...
    "iperf_client_iperf_client,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.543583,HLS_SYN_LAT=5,HLS_SYN_TPT=1,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=4912,HLS_SYN_LUT=3861,HLS_VERSION=2022_1}";
    ...
    signal openStatus_handler_U0_openConStatusBuffer_din : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal txDataBuffer_handler_512_U0_m_axis_tx_data_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    ...
    signal client_512_U0_m_axis_open_connection_TDATA : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal dualModeEn_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal dualModeEn_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal packetGap_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal packetGap_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal timeInSeconds_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal timeInSeconds_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal timeInCycles_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal timeInCycles_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal openConStatusBuffer_dout : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal startSignalFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal startSignalFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal stopSignalFifo_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal stopSignalFifo_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    port (
        ...
        dualModeEn_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        dualModeEn_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ...
        packetGap_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        packetGap_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        packetGap_c_full_n : IN STD_LOGIC;
        packetGap_c_write : OUT STD_LOGIC;
        timeInSeconds : IN STD_LOGIC_VECTOR (31 downto 0);
        timeInSeconds_c_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        timeInSeconds_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        timeInSeconds_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        ...
        timeInCycles_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        timeInCycles_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
    ...
    port (
        ...
        ap_ready : OUT STD_LOGIC;
        s_axis_open_status_TVALID : IN STD_LOGIC;
        openConStatusBuffer_din : OUT STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    port map (
        ...
        dualModeEn_c_num_data_valid => dualModeEn_c_num_data_valid,
        dualModeEn_c_fifo_cap => dualModeEn_c_fifo_cap,
        ...
        packetGap_c_num_data_valid => packetGap_c_num_data_valid,
        packetGap_c_fifo_cap => packetGap_c_fifo_cap,
        ...
        timeInSeconds_c_num_data_valid => timeInSeconds_c_num_data_valid,
        timeInSeconds_c_fifo_cap => timeInSeconds_c_fifo_cap,
        ...
        timeInCycles_c_num_data_valid => timeInCycles_c_num_data_valid,
        timeInCycles_c_fifo_cap => timeInCycles_c_fifo_cap,
    ...
    port map (
        ...
        timeInSeconds_num_data_valid => timeInSeconds_c_num_data_valid,
        timeInSeconds_fifo_cap => timeInSeconds_c_fifo_cap,
        ...
        packetGap_num_data_valid => packetGap_c_num_data_valid,
        packetGap_fifo_cap => packetGap_c_fifo_cap,
        ...
        dualModeEn_num_data_valid => dualModeEn_c_num_data_valid,
        dualModeEn_fifo_cap => dualModeEn_c_fifo_cap,
        ...
        stopSignalFifo_num_data_valid => stopSignalFifo_num_data_valid,
        stopSignalFifo_fifo_cap => stopSignalFifo_fifo_cap,
        ...
        startSignalFifo_num_data_valid => startSignalFifo_num_data_valid,
        startSignalFifo_fifo_cap => startSignalFifo_fifo_cap,
    ...
    port map (
        ...
        timeInCycles_num_data_valid => timeInCycles_c_num_data_valid,
        timeInCycles_fifo_cap => timeInCycles_c_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => dualModeEn_c_num_data_valid,
        if_fifo_cap => dualModeEn_c_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => packetGap_c_num_data_valid,
        if_fifo_cap => packetGap_c_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => timeInSeconds_c_num_data_valid,
        if_fifo_cap => timeInSeconds_c_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => timeInCycles_c_num_data_valid,
        if_fifo_cap => timeInCycles_c_fifo_cap,
    ...
    openConStatusBuffer_U : component iperf_client_fifo_w32_d512_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    port map (
        ...
        if_num_data_valid => startSignalFifo_num_data_valid,
        if_fifo_cap => startSignalFifo_fifo_cap,
    ...
    port map (
        ...
        if_num_data_valid => stopSignalFifo_num_data_valid,
        if_fifo_cap => stopSignalFifo_fifo_cap,
