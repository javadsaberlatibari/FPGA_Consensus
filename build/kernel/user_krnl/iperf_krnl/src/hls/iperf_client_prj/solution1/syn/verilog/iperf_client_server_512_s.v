...
wire   [0:0] tmp_7_nbreadreq_fu_88_p3;
wire   [0:0] tmp_s_nbreadreq_fu_102_p3;
...
reg   [0:0] tmp_7_reg_219;
reg   [0:0] icmp_ln1069_reg_223;
reg    ap_predicate_op56_write_state2;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state2_io;
reg   [0:0] listenState_load_reg_209_pp0_iter1_reg;
reg   [0:0] tmp_7_reg_219_pp0_iter1_reg;
reg   [0:0] icmp_ln1069_reg_223_pp0_iter1_reg;
...
wire   [0:0] icmp_ln1069_fu_183_p2;
wire   [31:0] trunc_ln174_fu_189_p1;
reg   [31:0] trunc_ln174_reg_227;
wire   [0:0] tmp_6_fu_163_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1069_fu_183_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((ap_predicate_op56_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0) & (ap_predicate_op59_write_state3 == 1'b1)))) begin
...
always @ (*) begin
    if (((ap_done_reg == 1'b0) & (tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((ap_done_reg == 1'b0) & (ap_predicate_op48_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)) | ((ap_done_reg == 1'b0) & (ap_predicate_op39_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    if ((((ap_predicate_op48_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_predicate_op39_read_state1 == 1'b1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op48_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op39_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op38_read_state1 == 1'b1) & (s_axis_rx_metadata_TVALID_int_regslice == 1'b0)) | ((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (s_axis_notifications_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op17_read_state1 == 1'b1) & (s_axis_listen_port_status_TVALID_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_m_axis_read_package_U_apdone_blk == 1'b1) | (regslice_both_m_axis_listen_port_U_apdone_blk == 1'b1) | ((m_axis_read_package_TREADY_int_regslice == 1'b0) & (ap_predicate_op59_write_state3 == 1'b1)) | ((m_axis_listen_port_TREADY_int_regslice == 1'b0) & (listenState_load_reg_209_pp0_iter1_reg == 1'd0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ap_predicate_op56_write_state2 == 1'b1) & (m_axis_read_package_TREADY_int_regslice == 1'b0)) | ((listenState_load_reg_209 == 1'd0) & (m_axis_listen_port_TREADY_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op48_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op39_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op38_read_state1 == 1'b1) & (s_axis_rx_metadata_TVALID_int_regslice == 1'b0)) | ((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (s_axis_notifications_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op17_read_state1 == 1'b1) & (s_axis_listen_port_status_TVALID_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (regslice_both_m_axis_read_package_U_apdone_blk == 1'b1) | (regslice_both_m_axis_listen_port_U_apdone_blk == 1'b1) | ((m_axis_read_package_TREADY_int_regslice == 1'b0) & (ap_predicate_op59_write_state3 == 1'b1)) | ((m_axis_listen_port_TREADY_int_regslice == 1'b0) & (listenState_load_reg_209_pp0_iter1_reg == 1'd0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op56_write_state2 == 1'b1) & (m_axis_read_package_TREADY_int_regslice == 1'b0)) | ((listenState_load_reg_209 == 1'd0) & (m_axis_listen_port_TREADY_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((ap_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op48_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op39_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op38_read_state1 == 1'b1) & (s_axis_rx_metadata_TVALID_int_regslice == 1'b0)) | ((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (s_axis_notifications_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op17_read_state1 == 1'b1) & (s_axis_listen_port_status_TVALID_int_regslice == 1'b0)))) | ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | (regslice_both_m_axis_read_package_U_apdone_blk == 1'b1) | (regslice_both_m_axis_listen_port_U_apdone_blk == 1'b1) | ((m_axis_read_package_TREADY_int_regslice == 1'b0) & (ap_predicate_op59_write_state3 == 1'b1)) | ((m_axis_listen_port_TREADY_int_regslice == 1'b0) & (listenState_load_reg_209_pp0_iter1_reg == 1'd0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((ap_predicate_op56_write_state2 == 1'b1) & (m_axis_read_package_TREADY_int_regslice == 1'b0)) | ((listenState_load_reg_209 == 1'd0) & (m_axis_listen_port_TREADY_int_regslice == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((ap_predicate_op48_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op39_read_state1 == 1'b1) & (s_axis_rx_data_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op38_read_state1 == 1'b1) & (s_axis_rx_metadata_TVALID_int_regslice == 1'b0)) | ((tmp_7_nbreadreq_fu_88_p3 == 1'd1) & (s_axis_notifications_TVALID_int_regslice == 1'b0)) | ((ap_predicate_op17_read_state1 == 1'b1) & (s_axis_listen_port_status_TVALID_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_io = (((ap_predicate_op56_write_state2 == 1'b1) & (m_axis_read_package_TREADY_int_regslice == 1'b0)) | ((listenState_load_reg_209 == 1'd0) & (m_axis_listen_port_TREADY_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((ap_predicate_op56_write_state2 == 1'b1) & (m_axis_read_package_TREADY_int_regslice == 1'b0)) | ((listenState_load_reg_209 == 1'd0) & (m_axis_listen_port_TREADY_int_regslice == 1'b0)));
end

always @ (*) begin
    ap_block_state3_io = (((m_axis_read_package_TREADY_int_regslice == 1'b0) & (ap_predicate_op59_write_state3 == 1'b1)) | ((m_axis_listen_port_TREADY_int_regslice == 1'b0) & (listenState_load_reg_209_pp0_iter1_reg == 1'd0)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((regslice_both_m_axis_read_package_U_apdone_blk == 1'b1) | (regslice_both_m_axis_listen_port_U_apdone_blk == 1'b1) | ((m_axis_read_package_TREADY_int_regslice == 1'b0) & (ap_predicate_op59_write_state3 == 1'b1)) | ((m_axis_listen_port_TREADY_int_regslice == 1'b0) & (listenState_load_reg_209_pp0_iter1_reg == 1'd0)));
end

always @ (*) begin
    ap_condition_200 = ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_205 = ((tmp_nbreadreq_fu_74_p3 == 1'd1) & (listenState == 1'd1) & (tmp_6_fu_163_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_395 = ((grp_nbreadreq_fu_110_p3 == 1'd1) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_396 = ((tmp_s_nbreadreq_fu_102_p3 == 1'd1) & (serverFsmState == 1'd0) & (grp_fu_145_p3 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op17_read_state1 = ((tmp_nbreadreq_fu_74_p3 == 1'd1) & (listenState == 1'd1));
end

always @ (*) begin
    ap_predicate_op38_read_state1 = ((grp_nbreadreq_fu_110_p3 == 1'd1) & (tmp_s_nbreadreq_fu_102_p3 == 1'd1) & (serverFsmState == 1'd0));
end

always @ (*) begin
    ap_predicate_op39_read_state1 = ((grp_nbreadreq_fu_110_p3 == 1'd1) & (tmp_s_nbreadreq_fu_102_p3 == 1'd1) & (serverFsmState == 1'd0));
end

always @ (*) begin
    ap_predicate_op48_read_state1 = ((grp_nbreadreq_fu_110_p3 == 1'd1) & (serverFsmState == 1'd1));
end

always @ (*) begin
    ap_predicate_op56_write_state2 = ((icmp_ln1069_reg_223 == 1'd0) & (tmp_7_reg_219 == 1'd1));
end

always @ (*) begin
    ap_predicate_op59_write_state3 = ((icmp_ln1069_reg_223_pp0_iter1_reg == 1'd0) & (tmp_7_reg_219_pp0_iter1_reg == 1'd1));
end

assign grp_fu_145_p3 = s_axis_rx_data_TDATA_int_regslice[1024'd576];

assign grp_nbreadreq_fu_110_p3 = s_axis_rx_data_TVALID_int_regslice;

assign icmp_ln1069_fu_183_p2 = ((tmp_length_V_fu_173_p4 == 16'd0) ? 1'b1 : 1'b0);
...
assign tmp_6_fu_163_p1 = s_axis_listen_port_status_TDATA_int_regslice[0:0];

assign tmp_7_nbreadreq_fu_88_p3 = s_axis_notifications_TVALID_int_regslice;

assign tmp_length_V_fu_173_p4 = {{s_axis_notifications_TDATA_int_regslice[31:16]}};

assign tmp_nbreadreq_fu_74_p3 = s_axis_listen_port_status_TVALID_int_regslice;

assign tmp_s_nbreadreq_fu_102_p3 = s_axis_rx_metadata_TVALID_int_regslice;

assign trunc_ln174_fu_189_p1 = s_axis_notifications_TDATA_int_regslice[31:0];
