...
assign process_axis_block_vec[5] = idx5_block & (1'b0 | axis_block_sigs[4] | axis_block_sigs[5]);
...
// instant sub module
 ...
 iperf_client_hls_deadlock_idx5_monitor iperf_client_hls_deadlock_idx5_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
