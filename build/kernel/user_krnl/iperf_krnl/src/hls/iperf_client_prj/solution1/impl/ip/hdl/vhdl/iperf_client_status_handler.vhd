...
attribute shreg_extract : string;
    ...
    signal tmp_i_reg_82 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_sessionID_V_fu_57_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_sessionID_V_reg_86 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_5_i2_reg_91 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_6_i_fu_71_p3 : STD_LOGIC_VECTOR (17 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_nbreadreq_fu_36_p3 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_5_i2_reg_91 <= s_axis_tx_status_TDATA_int_regslice(65 downto 64);
                tmp_sessionID_V_reg_86 <= tmp_sessionID_V_fu_57_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_i_reg_82 <= tmp_i_nbreadreq_fu_36_p3;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_i_nbreadreq_fu_36_p3, ap_done_reg, txStatusBuffer_full_n, tmp_i_reg_82, s_axis_tx_status_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_i_reg_82 = ap_const_lv1_1) and (txStatusBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_i_nbreadreq_fu_36_p3 = ap_const_lv1_1) and (s_axis_tx_status_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_i_nbreadreq_fu_36_p3, ap_done_reg, txStatusBuffer_full_n, tmp_i_reg_82, s_axis_tx_status_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((tmp_i_reg_82 = ap_const_lv1_1) and (txStatusBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_i_nbreadreq_fu_36_p3 = ap_const_lv1_1) and (s_axis_tx_status_TVALID_int_regslice = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_start, ap_enable_reg_pp0_iter1, tmp_i_nbreadreq_fu_36_p3, ap_done_reg, txStatusBuffer_full_n, tmp_i_reg_82, s_axis_tx_status_TVALID_int_regslice)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((tmp_i_reg_82 = ap_const_lv1_1) and (txStatusBuffer_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((tmp_i_nbreadreq_fu_36_p3 = ap_const_lv1_1) and (s_axis_tx_status_TVALID_int_regslice = ap_const_logic_0)))));
    end process;
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(txStatusBuffer_full_n, tmp_i_reg_82)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((tmp_i_reg_82 = ap_const_lv1_1) and (txStatusBuffer_full_n = ap_const_logic_0));
    end process;
    ...
    tmp_6_i_fu_71_p3 <= (tmp_5_i2_reg_91 & tmp_sessionID_V_reg_86);
    tmp_i_nbreadreq_fu_36_p3 <= (0=>(s_axis_tx_status_TVALID_int_regslice), others=>'-');
    tmp_sessionID_V_fu_57_p1 <= s_axis_tx_status_TDATA_int_regslice(16 - 1 downto 0);

    txStatusBuffer_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, txStatusBuffer_full_n, tmp_i_reg_82, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (tmp_i_reg_82 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    txStatusBuffer_din <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_6_i_fu_71_p3),32));

    txStatusBuffer_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_i_reg_82, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_i_reg_82 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
