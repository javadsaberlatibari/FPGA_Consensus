...
set portList { 
	...
	{ txStatusBuffer_num_data_valid sc_in sc_lv 10 signal 1 } 
	{ txStatusBuffer_fifo_cap sc_in sc_lv 10 signal 1 } 
	{ txStatusBuffer_full_n sc_in sc_logic 1 signal 1 } 
	{ txStatusBuffer_write sc_out sc_logic 1 signal 1 } 
	{ s_axis_tx_status_TDATA sc_in sc_lv 96 signal 0 } 
...
set Spec2ImplPortList { 
	s_axis_tx_status { axis {  { s_axis_tx_status_TVALID in_vld 0 1 }  { s_axis_tx_status_TDATA in_data 0 96 }  { s_axis_tx_status_TREADY in_acc 1 1 } } }
	txStatusBuffer { ap_fifo {  { txStatusBuffer_din fifo_port_we 1 32 }  { txStatusBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { txStatusBuffer_fifo_cap fifo_update 0 10 }  { txStatusBuffer_full_n fifo_status 0 1 }  { txStatusBuffer_write fifo_data 1 1 } } }
}
