...
set portList { 
	...
	{ useIpAddr_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ useIpAddr_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ timeInSeconds_num_data_valid sc_in sc_lv 3 signal 8 } 
	{ timeInSeconds_fifo_cap sc_in sc_lv 3 signal 8 } 
	...
	{ packetGap_num_data_valid sc_in sc_lv 3 signal 7 } 
	{ packetGap_fifo_cap sc_in sc_lv 3 signal 7 } 
	...
	{ pkgWordCount_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ pkgWordCount_fifo_cap sc_in sc_lv 3 signal 6 } 
	...
	{ useConn_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ useConn_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ useConn_empty_n sc_in sc_logic 1 signal 4 } 
	{ useConn_read sc_out sc_logic 1 signal 4 } 
	{ dualModeEn_dout sc_in sc_lv 1 signal 3 } 
	{ dualModeEn_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ dualModeEn_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ stopSignalFifo_num_data_valid sc_in sc_lv 2 signal 24 } 
	{ stopSignalFifo_fifo_cap sc_in sc_lv 2 signal 24 } 
	...
	{ openConStatusBuffer_dout sc_in sc_lv 32 signal 19 } 
	{ openConStatusBuffer_num_data_valid sc_in sc_lv 10 signal 19 } 
	{ openConStatusBuffer_fifo_cap sc_in sc_lv 10 signal 19 } 
	...
	{ txDataBuffer_num_data_valid sc_in sc_lv 10 signal 23 } 
	{ txDataBuffer_fifo_cap sc_in sc_lv 10 signal 23 } 
	...
	{ txMetaDataBuffer_num_data_valid sc_in sc_lv 10 signal 20 } 
	{ txMetaDataBuffer_fifo_cap sc_in sc_lv 10 signal 20 } 
	...
	{ startSignalFifo_num_data_valid sc_in sc_lv 2 signal 21 } 
	{ startSignalFifo_fifo_cap sc_in sc_lv 2 signal 21 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "timeInSeconds_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInSeconds", "role": "num_data_valid" }} , 
 	{ "name": "timeInSeconds_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInSeconds", "role": "fifo_cap" }} , 
 	...
 	{ "name": "packetGap_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "packetGap", "role": "num_data_valid" }} , 
 	{ "name": "packetGap_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "packetGap", "role": "fifo_cap" }} , 
 	...
 	{ "name": "dualModeEn_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualModeEn", "role": "num_data_valid" }} , 
 	{ "name": "dualModeEn_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualModeEn", "role": "fifo_cap" }} , 
 	...
 	{ "name": "stopSignalFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stopSignalFifo", "role": "num_data_valid" }} , 
 	{ "name": "stopSignalFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "stopSignalFifo", "role": "fifo_cap" }} , 
 	...
 	{ "name": "txDataBuffer_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "txDataBuffer", "role": "num_data_valid" }} , 
 	{ "name": "txDataBuffer_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "txDataBuffer", "role": "fifo_cap" }} , 
 	...
 	{ "name": "startSignalFifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "startSignalFifo", "role": "num_data_valid" }} , 
 	{ "name": "startSignalFifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "startSignalFifo", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	dualModeEn { ap_fifo {  { dualModeEn_dout fifo_port_we 0 1 }  { dualModeEn_num_data_valid fifo_status_num_data_valid 0 3 }  { dualModeEn_fifo_cap fifo_update 0 3 }  { dualModeEn_empty_n fifo_status 0 1 }  { dualModeEn_read fifo_data 1 1 } } }
	useConn { ap_fifo {  { useConn_dout fifo_port_we 0 14 }  { useConn_num_data_valid fifo_status_num_data_valid 0 3 }  { useConn_fifo_cap fifo_update 0 3 }  { useConn_empty_n fifo_status 0 1 }  { useConn_read fifo_data 1 1 } } }
	...
	pkgWordCount { ap_fifo {  { pkgWordCount_dout fifo_port_we 0 8 }  { pkgWordCount_num_data_valid fifo_status_num_data_valid 0 3 }  { pkgWordCount_fifo_cap fifo_update 0 3 }  { pkgWordCount_empty_n fifo_status 0 1 }  { pkgWordCount_read fifo_data 1 1 } } }
	packetGap { ap_fifo {  { packetGap_dout fifo_port_we 0 8 }  { packetGap_num_data_valid fifo_status_num_data_valid 0 3 }  { packetGap_fifo_cap fifo_update 0 3 }  { packetGap_empty_n fifo_status 0 1 }  { packetGap_read fifo_data 1 1 } } }
	timeInSeconds { ap_fifo {  { timeInSeconds_dout fifo_port_we 0 32 }  { timeInSeconds_num_data_valid fifo_status_num_data_valid 0 3 }  { timeInSeconds_fifo_cap fifo_update 0 3 }  { timeInSeconds_empty_n fifo_status 0 1 }  { timeInSeconds_read fifo_data 1 1 } } }
	...
	startSignalFifo { ap_fifo {  { startSignalFifo_din fifo_port_we 1 1 }  { startSignalFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { startSignalFifo_fifo_cap fifo_update 0 2 }  { startSignalFifo_full_n fifo_status 0 1 }  { startSignalFifo_write fifo_data 1 1 } } }
	txStatusBuffer { ap_fifo {  { txStatusBuffer_dout fifo_port_we 0 32 }  { txStatusBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { txStatusBuffer_fifo_cap fifo_update 0 10 }  { txStatusBuffer_empty_n fifo_status 0 1 }  { txStatusBuffer_read fifo_data 1 1 } } }
	txDataBuffer { ap_fifo {  { txDataBuffer_din fifo_port_we 1 1024 }  { txDataBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { txDataBuffer_fifo_cap fifo_update 0 10 }  { txDataBuffer_full_n fifo_status 0 1 }  { txDataBuffer_write fifo_data 1 1 } } }
	stopSignalFifo { ap_fifo {  { stopSignalFifo_dout fifo_port_we 0 1 }  { stopSignalFifo_num_data_valid fifo_status_num_data_valid 0 2 }  { stopSignalFifo_fifo_cap fifo_update 0 2 }  { stopSignalFifo_empty_n fifo_status 0 1 }  { stopSignalFifo_read fifo_data 1 1 } } }
}
