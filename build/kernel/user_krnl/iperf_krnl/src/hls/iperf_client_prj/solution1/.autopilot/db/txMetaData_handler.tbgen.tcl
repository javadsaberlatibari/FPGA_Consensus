...
set portList { 
	...
	{ txMetaDataBuffer_num_data_valid sc_in sc_lv 10 signal 1 } 
	{ txMetaDataBuffer_fifo_cap sc_in sc_lv 10 signal 1 } 
...
set Spec2ImplPortList { 
	...
	txMetaDataBuffer { ap_fifo {  { txMetaDataBuffer_dout fifo_port_we 0 32 }  { txMetaDataBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { txMetaDataBuffer_fifo_cap fifo_update 0 10 }  { txMetaDataBuffer_empty_n fifo_status 0 1 }  { txMetaDataBuffer_read fifo_data 1 1 } } }
}
