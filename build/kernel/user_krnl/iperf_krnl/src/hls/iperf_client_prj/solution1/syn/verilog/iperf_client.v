...
(* CORE_GENERATION_INFO="iperf_client_iperf_client,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.543583,HLS_SYN_LAT=5,HLS_SYN_TPT=1,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=4912,HLS_SYN_LUT=3861,HLS_VERSION=2022_1}" *)
...
wire   [31:0] openStatus_handler_U0_openConStatusBuffer_din;
...
wire   [1023:0] txDataBuffer_handler_512_U0_m_axis_tx_data_TDATA;
...
wire   [63:0] client_512_U0_m_axis_open_connection_TDATA;
...
wire   [2:0] dualModeEn_c_num_data_valid;
wire   [2:0] dualModeEn_c_fifo_cap;
...
wire   [2:0] packetGap_c_num_data_valid;
wire   [2:0] packetGap_c_fifo_cap;
wire    packetGap_c_empty_n;
wire    timeInSeconds_c_full_n;
wire   [31:0] timeInSeconds_c_dout;
wire   [2:0] timeInSeconds_c_num_data_valid;
wire   [2:0] timeInSeconds_c_fifo_cap;
wire    timeInSeconds_c_empty_n;
wire    timeInCycles_c_full_n;
wire   [63:0] timeInCycles_c_dout;
wire   [2:0] timeInCycles_c_num_data_valid;
wire   [2:0] timeInCycles_c_fifo_cap;
...
wire   [31:0] openConStatusBuffer_dout;
...
wire   [1:0] startSignalFifo_num_data_valid;
wire   [1:0] startSignalFifo_fifo_cap;
wire    startSignalFifo_empty_n;
wire    stopSignalFifo_full_n;
wire   [0:0] stopSignalFifo_dout;
wire   [1:0] stopSignalFifo_num_data_valid;
wire   [1:0] stopSignalFifo_fifo_cap;
...
iperf_client_fifo_w32_d512_A openConStatusBuffer_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
