...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txStatusBuffer_din { O 32 vector } txStatusBuffer_num_data_valid { I 10 vector } txStatusBuffer_fifo_cap { I 10 vector } txStatusBuffer_full_n { I 1 bit } txStatusBuffer_write { O 1 bit } } \
} "
}
