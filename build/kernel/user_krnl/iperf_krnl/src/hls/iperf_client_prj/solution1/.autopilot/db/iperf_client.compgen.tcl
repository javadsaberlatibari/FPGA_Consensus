...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_notifications_TDATA { I 96 vector } s_axis_notifications_TVALID { I 1 bit } s_axis_notifications_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_rx_data_TDATA { I 1024 vector } s_axis_rx_data_TVALID { I 1 bit } s_axis_rx_data_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_open_connection_TDATA { O 64 vector } m_axis_open_connection_TVALID { O 1 bit } m_axis_open_connection_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_open_status_TDATA { I 32 vector } s_axis_open_status_TVALID { I 1 bit } s_axis_open_status_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_data_TDATA { O 1024 vector } m_axis_tx_data_TVALID { O 1 bit } m_axis_tx_data_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_tx_status_TDATA { I 96 vector } s_axis_tx_status_TVALID { I 1 bit } s_axis_tx_status_TREADY { O 1 bit } } \
} "
} else {
