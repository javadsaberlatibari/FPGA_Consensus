...
set portList { 
	...
	{ dualModeEn_c_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ dualModeEn_c_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ useConn_c_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ useConn_c_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ packetGap_c_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ packetGap_c_fifo_cap sc_in sc_lv 3 signal 9 } 
	...
	{ timeInSeconds_c_num_data_valid sc_in sc_lv 3 signal 11 } 
	{ timeInSeconds_c_fifo_cap sc_in sc_lv 3 signal 11 } 
	...
	{ timeInCycles_c_num_data_valid sc_in sc_lv 3 signal 13 } 
	{ timeInCycles_c_fifo_cap sc_in sc_lv 3 signal 13 } 
	...
	{ useIpAddr_c_num_data_valid sc_in sc_lv 3 signal 15 } 
	{ useIpAddr_c_fifo_cap sc_in sc_lv 3 signal 15 } 
	...
	{ regIpAddress0_c_num_data_valid sc_in sc_lv 3 signal 17 } 
	{ regIpAddress0_c_fifo_cap sc_in sc_lv 3 signal 17 } 
	...
	{ regIpAddress1_c_num_data_valid sc_in sc_lv 3 signal 19 } 
	{ regIpAddress1_c_fifo_cap sc_in sc_lv 3 signal 19 } 
	...
	{ regIpAddress2_c_num_data_valid sc_in sc_lv 3 signal 21 } 
	{ regIpAddress2_c_fifo_cap sc_in sc_lv 3 signal 21 } 
	...
	{ regIpAddress3_c_num_data_valid sc_in sc_lv 3 signal 23 } 
	{ regIpAddress3_c_fifo_cap sc_in sc_lv 3 signal 23 } 
	...
	{ regIpAddress4_c_num_data_valid sc_in sc_lv 3 signal 25 } 
	{ regIpAddress4_c_fifo_cap sc_in sc_lv 3 signal 25 } 
	...
	{ regIpAddress5_c_num_data_valid sc_in sc_lv 3 signal 27 } 
	{ regIpAddress5_c_fifo_cap sc_in sc_lv 3 signal 27 } 
	...
	{ regIpAddress6_c_num_data_valid sc_in sc_lv 3 signal 29 } 
	{ regIpAddress6_c_fifo_cap sc_in sc_lv 3 signal 29 } 
	...
	{ regIpAddress7_c_num_data_valid sc_in sc_lv 3 signal 31 } 
	{ regIpAddress7_c_fifo_cap sc_in sc_lv 3 signal 31 } 
	...
	{ regIpAddress8_c_num_data_valid sc_in sc_lv 3 signal 33 } 
	{ regIpAddress8_c_fifo_cap sc_in sc_lv 3 signal 33 } 
	...
	{ regIpAddress9_c_num_data_valid sc_in sc_lv 3 signal 35 } 
	{ regIpAddress9_c_fifo_cap sc_in sc_lv 3 signal 35 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dualModeEn_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualModeEn_c", "role": "num_data_valid" }} , 
 	{ "name": "dualModeEn_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "dualModeEn_c", "role": "fifo_cap" }} , 
 	...
 	{ "name": "packetGap_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "packetGap_c", "role": "num_data_valid" }} , 
 	{ "name": "packetGap_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "packetGap_c", "role": "fifo_cap" }} , 
 	...
 	{ "name": "timeInSeconds_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInSeconds_c", "role": "num_data_valid" }} , 
 	{ "name": "timeInSeconds_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInSeconds_c", "role": "fifo_cap" }} , 
 	...
 	{ "name": "timeInCycles_c_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInCycles_c", "role": "num_data_valid" }} , 
 	{ "name": "timeInCycles_c_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "timeInCycles_c", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	dualModeEn_c { ap_fifo {  { dualModeEn_c_din fifo_port_we 1 1 }  { dualModeEn_c_num_data_valid fifo_status_num_data_valid 0 3 }  { dualModeEn_c_fifo_cap fifo_update 0 3 }  { dualModeEn_c_full_n fifo_status 0 1 }  { dualModeEn_c_write fifo_data 1 1 } } }
	useConn { ap_none {  { useConn in_data 0 14 } } }
	useConn_c { ap_fifo {  { useConn_c_din fifo_port_we 1 14 }  { useConn_c_num_data_valid fifo_status_num_data_valid 0 3 }  { useConn_c_fifo_cap fifo_update 0 3 }  { useConn_c_full_n fifo_status 0 1 }  { useConn_c_write fifo_data 1 1 } } }
	pkgWordCount { ap_none {  { pkgWordCount in_data 0 8 } } }
	pkgWordCount_c { ap_fifo {  { pkgWordCount_c_din fifo_port_we 1 8 }  { pkgWordCount_c_num_data_valid fifo_status_num_data_valid 0 3 }  { pkgWordCount_c_fifo_cap fifo_update 0 3 }  { pkgWordCount_c_full_n fifo_status 0 1 }  { pkgWordCount_c_write fifo_data 1 1 } } }
	packetGap { ap_none {  { packetGap in_data 0 8 } } }
	packetGap_c { ap_fifo {  { packetGap_c_din fifo_port_we 1 8 }  { packetGap_c_num_data_valid fifo_status_num_data_valid 0 3 }  { packetGap_c_fifo_cap fifo_update 0 3 }  { packetGap_c_full_n fifo_status 0 1 }  { packetGap_c_write fifo_data 1 1 } } }
	timeInSeconds { ap_none {  { timeInSeconds in_data 0 32 } } }
	timeInSeconds_c { ap_fifo {  { timeInSeconds_c_din fifo_port_we 1 32 }  { timeInSeconds_c_num_data_valid fifo_status_num_data_valid 0 3 }  { timeInSeconds_c_fifo_cap fifo_update 0 3 }  { timeInSeconds_c_full_n fifo_status 0 1 }  { timeInSeconds_c_write fifo_data 1 1 } } }
	timeInCycles { ap_none {  { timeInCycles in_data 0 64 } } }
	timeInCycles_c { ap_fifo {  { timeInCycles_c_din fifo_port_we 1 64 }  { timeInCycles_c_num_data_valid fifo_status_num_data_valid 0 3 }  { timeInCycles_c_fifo_cap fifo_update 0 3 }  { timeInCycles_c_full_n fifo_status 0 1 }  { timeInCycles_c_write fifo_data 1 1 } } }
