    ...
    wire [6:0] in_chan_dep_data_vec_4;
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 0, 2, 2) iperf_client_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign in_chan_dep_data_vec_0[6 : 0] = dep_chan_data_5_0;
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 1, 1, 1) iperf_client_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign in_chan_dep_data_vec_1[6 : 0] = dep_chan_data_5_1;
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 2, 1, 1) iperf_client_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign in_chan_dep_data_vec_2[6 : 0] = dep_chan_data_5_2;
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 3, 1, 1) iperf_client_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 4, 1, 1) iperf_client_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign in_chan_dep_data_vec_4[6 : 0] = dep_chan_data_5_4;
    ...
    iperf_client_hls_deadlock_detect_unit #(7, 5, 6, 6) iperf_client_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[3] = 1'b0 | (~client_512_U0.startSignalFifo_blk_n) | (~client_512_U0.stopSignalFifo_blk_n);
    ...
    assign proc_5_data_FIFO_blk[4] = 1'b0 | (~client_512_U0.txStatusBuffer_blk_n);
    ...
    assign proc_5_data_FIFO_blk[5] = 1'b0 | (~client_512_U0.txDataBuffer_blk_n);
    ...
    // Process: clock_U0
    iperf_client_hls_deadlock_detect_unit #(7, 6, 2, 2) iperf_client_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~clock_U0.timeInCycles_blk_n);
    ...
    assign proc_6_data_FIFO_blk[1] = 1'b0 | (~clock_U0.startSignalFifo_blk_n) | (~clock_U0.stopSignalFifo_blk_n);
