...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_tx_status_TVALID { I 1 bit } s_axis_tx_status_TDATA { I 96 vector } s_axis_tx_status_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txStatusBuffer_din { O 96 vector } txStatusBuffer_num_data_valid { I 10 vector } txStatusBuffer_fifo_cap { I 10 vector } txStatusBuffer_full_n { I 1 bit } txStatusBuffer_write { O 1 bit } } \
} "
}
