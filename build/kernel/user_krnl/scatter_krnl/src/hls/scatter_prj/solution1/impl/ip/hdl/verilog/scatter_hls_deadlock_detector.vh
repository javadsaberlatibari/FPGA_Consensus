    ...
    scatter_hls_deadlock_detect_unit #(6, 0, 1, 1) scatter_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    scatter_hls_deadlock_detect_unit #(6, 1, 1, 1) scatter_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    scatter_hls_deadlock_detect_unit #(6, 2, 1, 1) scatter_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    scatter_hls_deadlock_detect_unit #(6, 3, 5, 5) scatter_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~client_512_U0.openConStatusBuffer_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~client_512_U0.txMetaDataBuffer_blk_n);
    ...
    assign proc_3_data_FIFO_blk[3] = 1'b0 | (~client_512_U0.txStatusBuffer_blk_n);
    ...
    assign proc_3_data_FIFO_blk[4] = 1'b0 | (~client_512_U0.closeConnectionBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(6, 4, 1, 1) scatter_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~txMetaData_handler_U0.txMetaDataBuffer_blk_n);
    ...
    scatter_hls_deadlock_detect_unit #(6, 5, 1, 1) scatter_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~closeConnection_handler_U0.closeConnectionBuffer_blk_n);
