                    ...
                    3: begin
                        if (~entry_proc_U0.runExperiment_c_blk_n) begin
                            if (~runExperiment_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'scatter_scatter.runExperiment_c_U' written by process 'scatter_scatter.client_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path scatter_scatter.runExperiment_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~runExperiment_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'scatter_scatter.runExperiment_c_U' read by process 'scatter_scatter.client_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path scatter_scatter.runExperiment_c_U");
                        ...
                        if (~entry_proc_U0.regBasePort_c_blk_n) begin
                            if (~regBasePort_c_U.if_empty_n) begin
                                $display("//      Blocked by empty input FIFO 'scatter_scatter.regBasePort_c_U' written by process 'scatter_scatter.client_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path scatter_scatter.regBasePort_c_U");
                                $fdisplay(fp, "Dependence_Channel_status EMPTY");
                            end
                            else if (~regBasePort_c_U.if_full_n) begin
                                $display("//      Blocked by full output FIFO 'scatter_scatter.regBasePort_c_U' read by process 'scatter_scatter.client_512_U0'");
                                $fdisplay(fp, "Dependence_Channel_path scatter_scatter.regBasePort_c_U");
                                $fdisplay(fp, "Dependence_Channel_status FULL");
                            end
                        end
