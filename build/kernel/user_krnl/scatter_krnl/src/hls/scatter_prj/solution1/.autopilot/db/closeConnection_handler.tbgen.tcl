...
set portList { 
	...
	{ closeConnectionBuffer_num_data_valid sc_in sc_lv 10 signal 1 } 
	{ closeConnectionBuffer_fifo_cap sc_in sc_lv 10 signal 1 } 
...
set Spec2ImplPortList { 
	...
	closeConnectionBuffer { ap_fifo {  { closeConnectionBuffer_dout fifo_port_we 0 16 }  { closeConnectionBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { closeConnectionBuffer_fifo_cap fifo_update 0 10 }  { closeConnectionBuffer_empty_n fifo_status 0 1 }  { closeConnectionBuffer_read fifo_data 1 1 } } }
}
