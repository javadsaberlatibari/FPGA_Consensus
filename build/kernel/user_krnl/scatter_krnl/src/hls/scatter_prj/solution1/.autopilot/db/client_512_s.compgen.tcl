...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { m_axis_tx_data_TREADY { I 1 bit } m_axis_tx_data_TDATA { O 1024 vector } m_axis_tx_data_TVALID { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'm_axis_tx_data'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_useConn \
    op interface \
    ports { useConn_dout { I 16 vector } useConn_num_data_valid { I 3 vector } useConn_fifo_cap { I 3 vector } useConn_empty_n { I 1 bit } useConn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { pkgWordCount_dout { I 16 vector } pkgWordCount_num_data_valid { I 3 vector } pkgWordCount_fifo_cap { I 3 vector } pkgWordCount_empty_n { I 1 bit } pkgWordCount_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { regBasePort_dout { I 16 vector } regBasePort_num_data_valid { I 3 vector } regBasePort_fifo_cap { I 3 vector } regBasePort_empty_n { I 1 bit } regBasePort_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { expectedRespInKB_dout { I 16 vector } expectedRespInKB_num_data_valid { I 3 vector } expectedRespInKB_fifo_cap { I 3 vector } expectedRespInKB_empty_n { I 1 bit } expectedRespInKB_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { clientPkgNum_dout { I 32 vector } clientPkgNum_num_data_valid { I 3 vector } clientPkgNum_fifo_cap { I 3 vector } clientPkgNum_empty_n { I 1 bit } clientPkgNum_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { regIpAddress10_dout { I 32 vector } regIpAddress10_num_data_valid { I 3 vector } regIpAddress10_fifo_cap { I 3 vector } regIpAddress10_empty_n { I 1 bit } regIpAddress10_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { txStatusBuffer_dout { I 96 vector } txStatusBuffer_num_data_valid { I 10 vector } txStatusBuffer_fifo_cap { I 10 vector } txStatusBuffer_empty_n { I 1 bit } txStatusBuffer_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { closeConnectionBuffer_din { O 16 vector } closeConnectionBuffer_num_data_valid { I 10 vector } closeConnectionBuffer_fifo_cap { I 10 vector } closeConnectionBuffer_full_n { I 1 bit } closeConnectionBuffer_write { O 1 bit } } \
} "
}
