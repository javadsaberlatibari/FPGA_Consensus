...
architecture behav of scatter is 
    ...
    "scatter_scatter,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.200000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.079982,HLS_SYN_LAT=6,HLS_SYN_TPT=1,HLS_SYN_MEM=7,HLS_SYN_DSP=0,HLS_SYN_FF=1701,HLS_SYN_LUT=3146,HLS_VERSION=2022_1}";
    ...
    signal client_512_U0_m_axis_tx_data_TDATA : STD_LOGIC_VECTOR (1023 downto 0);
    signal client_512_U0_m_axis_tx_data_TVALID : STD_LOGIC;
...
begin
    ...
    openConStatusBuffer_U : component scatter_fifo_w32_d512_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
