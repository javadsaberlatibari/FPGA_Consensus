...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_open_status_TVALID { I 1 bit } s_axis_open_status_TDATA { I 32 vector } s_axis_open_status_TREADY { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { openConStatusBuffer_din { O 32 vector } openConStatusBuffer_num_data_valid { I 10 vector } openConStatusBuffer_fifo_cap { I 10 vector } openConStatusBuffer_full_n { I 1 bit } openConStatusBuffer_write { O 1 bit } } \
} "
}
