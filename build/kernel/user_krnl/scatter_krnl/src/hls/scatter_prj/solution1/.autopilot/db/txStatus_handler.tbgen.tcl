...
set Spec2ImplPortList { 
	...
	txStatusBuffer { ap_fifo {  { txStatusBuffer_din fifo_port_we 1 96 }  { txStatusBuffer_num_data_valid fifo_status_num_data_valid 0 10 }  { txStatusBuffer_fifo_cap fifo_update 0 10 }  { txStatusBuffer_full_n fifo_status 0 1 }  { txStatusBuffer_write fifo_data 1 1 } } }
}
