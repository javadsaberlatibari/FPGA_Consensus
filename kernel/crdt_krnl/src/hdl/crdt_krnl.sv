...
(
  ...
  // AXI4-Stream (master) interface m_axis_role_network_status
  output wire                                             m_axis_role_network_status_tvalid,
  input  wire                                             m_axis_role_network_status_tready,
  output wire [C_M_AXIS_ROLE_TX_STATUS_TDATA_WIDTH-1:0]   m_axis_role_network_status_tdata ,
  output wire [C_M_AXIS_ROLE_TX_STATUS_TDATA_WIDTH/8-1:0] m_axis_role_network_status_tkeep ,
  output wire                                             m_axis_role_network_status_tlast ,
  // AXI4-Stream (slave) interface m_axis_role_user_status
  input  wire                                             s_axis_role_user_status_tvalid  ,
  output wire                                             s_axis_role_user_status_tready  ,
  input  wire [C_M_AXIS_ROLE_TX_STATUS_TDATA_WIDTH-1:0]     s_axis_role_user_status_tdata   ,
  input  wire [C_M_AXIS_ROLE_TX_STATUS_TDATA_WIDTH/8-1:0]   s_axis_role_user_status_tkeep   ,
  input  wire                                             s_axis_role_user_status_tlast   ,
...
axi_stream      network_kernel_status();
axi_stream      user_kernel_status();
...
stack_top #(
    ...
    .network_kernel_status ( network_kernel_status ),
    .user_kernel_status ( user_kernel_status ),
    // DMA
...
assign m_axis_role_network_status_tvalid = network_kernel_status.valid;
assign m_axis_role_network_status_tdata = network_kernel_status.data;
assign m_axis_role_network_status_tkeep = network_kernel_status.keep;
assign m_axis_role_network_status_tlast = network_kernel_status.last;
assign network_kernel_status.ready = m_axis_role_network_status_tready;

assign user_kernel_status.valid = s_axis_role_user_status_tvalid;
assign user_kernel_status.data = s_axis_role_user_status_tdata;
assign user_kernel_status.keep = s_axis_role_user_status_tkeep;
assign user_kernel_status.last = s_axis_role_user_status_tlast;
assign s_axis_role_user_status_tready = user_kernel_status.ready;
