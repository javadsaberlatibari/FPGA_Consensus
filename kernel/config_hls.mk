...
#HYBRID
#LOAD KERNEL
_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/hybrid_kv_summary_krnl.xo: kernel/hybrid_krnl/hybrid_kv_summary_krnl/hybrid_kv_summary_krnl.cpp
	mkdir -p _x.hw.xilinx_u280_gen3x16_xdma_1_202211_1
	$(VPP) $(CLFLAGS) -c -k hybrid_kv_summary_krnl -o _x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/hybrid_kv_summary_krnl.xo --input_files kernel/hybrid_krnl/hybrid_kv_summary_krnl/hybrid_kv_summary_krnl.cpp
