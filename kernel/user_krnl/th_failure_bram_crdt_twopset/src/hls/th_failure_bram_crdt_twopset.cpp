...
void update_twopset(int *network_ptr, int node_num, int board_num, int check_value, hls::stream<ap_uint<64> >& local_set_e, hls::stream<ap_uint<64> >& break_signal , hls::stream<ap_uint<64> >& set_size_request){
    ...
    while((!break_flag) || (check_throughput_count!=(node_num-2))){
...
void handle_query(int board_num, int failed_node, int *setsize, int query_num, hls::stream<ap_uint<256> >& axis_mem_request, hls::stream<ap_uint<64> >& set_size_request){
...
void bram_mem_maneger_twopset(int *network_ptr, int *setsize, int node_num, int board_num, int failed_node, int query_num, int write_num, int check_value, hls::stream<ap_uint<256> >& axis_mem_request, hls::stream<ap_uint<64> >& update_set_request){

    #pragma HLS dataflow
    static hls::stream<ap_uint<64> > set_size_request, local_set_e, break_signal;

    handle_query(board_num, failed_node, setsize, query_num, axis_mem_request, set_size_request);
    update_local_twopset(write_num, update_set_request, local_set_e, break_signal);
    update_twopset(network_ptr, node_num, board_num, check_value, local_set_e, break_signal , set_size_request);
...
extern "C" {
    ...
    void th_failure_bram_crdt_twopset(
        hls::stream<pkt256>& m_axis_tx_meta, 
        hls::stream<pkt512>& m_axis_tx_data, 
        hls::stream<pkt512>& s_axis_tx_status, 
        int s_axi_lqpn, 
        ...
        //#pragma HLS STREAM depth=8 variable=update_set_request
            ...
            bram_mem_maneger_twopset(network_ptr, crdt, node_num, board_num, failed_node, query_num, write_num, check_value, axis_mem_request, update_set_request);
    }
