...
void update_twopset(int *network_ptr, int node_num, int board_num, int check_value, int execution_time, hls::stream<ap_uint<64> >& local_set_e, hls::stream<ap_uint<64> >& break_signal , hls::stream<ap_uint<64> >& set_size_request){
...
void bram_mem_maneger_twopset(int *network_ptr, int *setsize, int node_num, int board_num, int query_num, int write_num, int check_value, int execution_time, hls::stream<ap_uint<256> >& axis_mem_request, hls::stream<ap_uint<64> >& update_set_request){
    ...
    update_twopset(network_ptr, node_num, board_num, check_value, execution_time, local_set_e, break_signal , set_size_request);
...
extern "C" {
    ...
    void th_bram_crdt_twopset(
        ...
        //#pragma HLS STREAM depth=8 variable=update_set_request
            ...
            bram_mem_maneger_twopset(network_ptr, crdt, node_num, board_num, query_num, write_num, check_value, execution_time, axis_mem_request, update_set_request);
    }
