...
void update_twopset(int *network_ptr, int node_num, int board_num, int check_value, hls::stream<ap_int<64> >& break_signal, hls::stream<ap_int<64> >& remote_set_e_addset, hls::stream<ap_int<64> >& remote_set_e_removeset){
...
void bram_mem_maneger_twopset(int *network_ptr, int node_num, int board_num, int query_num, int write_num, int check_value, hls::stream<ap_int<64> >& axis_mem_request, hls::stream<ap_int<64> >& update_set_request){
    #pragma HLS DATAFLOW
    ...
    update_twopset(network_ptr, node_num, board_num, check_value, break_signal_twopset, remote_set_e_addset, remote_set_e_removeset);
...
extern "C" {
    ...
    void th_twopset_bram_bench(
        ...
        #pragma HLS DATAFLOW
            ...
            bram_mem_maneger_twopset(network_ptr, node_num, board_num, query_num, write_num, check_value, axis_mem_request, update_set_request);
    }
