...
void bram_mem_maneger(int *network_ptr, int *counter, int node_num, int board_num, int query_num, int check_value, int execution_time, ap_uint<512> *cyc_th, hls::stream<ap_uint<256> >& axis_mem_request){
...
extern "C" {
    ...
    void th_bram_crdt_counter(
        ...
        static hls::stream<ap_uint<256> > axis_mem_request;
            ...
            bram_mem_maneger(network_ptr, crdt, node_num, board_num, query_num, check_value, execution_time, cyc_th, axis_mem_request);
