...
void update_pnset(int *network_ptr, int node_num, int board_num, hls::stream<ap_int<64> >& local_set_e, hls::stream<ap_uint<64> >& break_signal , hls::stream<ap_uint<64> >& set_size_request){
...
void bram_mem_maneger_pnset(int *network_ptr, int *setsize, int node_num, int board_num, int query_num, int write_num, hls::stream<ap_uint<256> >& axis_mem_request, hls::stream<ap_int<64> >& update_set_request){
...
extern "C" {
    ...
    void bram_crdt_pnset(
        ...
        //#pragma HLS STREAM depth=8 variable=update_set_request
            ...
            bram_mem_maneger_pnset(network_ptr, crdt, node_num, board_num, query_num, write_num, axis_mem_request, update_set_request);
    }
