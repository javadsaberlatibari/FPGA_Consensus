...
void crdt_pnset(
    ...
    hls::stream<pkt64>& m_axis_tx_data,
    hls::stream<ap_int<64> >& axis_last_op_response,
    hls::stream<ap_int<64> >& set_size_request,
...
void update_remote_pnset(int *network_ptr, int node_num, int board_num, int write_num, bool throughput, int expected_packets, hls::stream<ap_int<64> >& local_set_e, hls::stream<ap_int<64> >& break_signal , hls::stream<ap_int<64> >& set_size_request){
...
void bram_mem_maneger_pnset(int *network_ptr, int node_num, int board_num, int query_num, int write_num, bool throughput, int expected_packets, hls::stream<ap_int<64> >& set_size_request, hls::stream<ap_int<64> >& update_set_request){

    #pragma HLS DATAFLOW

    static hls::stream<ap_int<64> > break_signal;
    ...
    update_remote_pnset(network_ptr, node_num, board_num, write_num, throughput, expected_packets, local_set_e, break_signal , set_size_request);
...
extern "C" {
    ...
    void bram_pnset_bram_bench(
        ...
        static hls::stream<ap_int<64> > set_size_request;
        ...
        //#pragma HLS STREAM depth=8 variable=update_set_request
            ...
            bram_mem_maneger_pnset(network_ptr, node_num, board_num, query_num, write_num, throughput, expected_packets, set_size_request, update_set_request);
    }
