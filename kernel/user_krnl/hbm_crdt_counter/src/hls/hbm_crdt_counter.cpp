...
void hbm_mem_maneger(int *network_ptr, int *counter, int node_num, int board_num, int query_num, hls::stream<ap_uint<256> >& axis_mem_request){
...
extern "C" {
    ...
    void hbm_crdt_counter(
        ...
        static hls::stream<ap_uint<256> > axis_mem_request;
            ...
            hbm_mem_maneger(network_ptr, crdt, node_num, board_num, query_num, axis_mem_request);
