...
void bram_mem_maneger_lww(int *network_ptr, int node_num, int board_num, int query_num, int check_value, hls::stream<ap_uint<32> >& axis_mem_request, hls::stream<ap_uint<16> >& now_time_stamp){
    #pragma HLS PIPELINE II=1
...
extern "C" {
    ...
    void th_reg_bram_bench(
        ...
        #pragma HLS dataflow
            ...
            bram_mem_maneger_lww(network_ptr, node_num, board_num, query_num, check_value, axis_mem_request, now_time_stamp);
