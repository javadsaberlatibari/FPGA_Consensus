...
void update_gset(int *network_ptr, int node_num, int board_num, int check_value, hls::stream<ap_uint<64> >& local_set_e, hls::stream<ap_uint<64> >& break_signal , hls::stream<ap_uint<64> >& set_size_request){
...
void handle_query(int query_num, hls::stream<ap_uint<64> >& axis_mem_request, hls::stream<ap_uint<64> >& set_size_request){

    static int query_cnt=0;

    static ap_uint<64> tmp_set_size=0;
    static ap_uint<64> tmp_read=0;
...
void bram_mem_maneger_gset(int *network_ptr, int node_num, int board_num, int query_num, int write_num, int check_value , hls::stream<ap_uint<64> >& axis_mem_request, hls::stream<ap_uint<64> >& update_set_request){
    ...
    update_gset(network_ptr, node_num, board_num, check_value, local_set_e, break_signal , set_size_request);
...
extern "C" {
    ...
    void th_gset_bram_bench(
        ...
        #pragma HLS DATAFLOW
            ...
            bram_mem_maneger_gset(network_ptr, node_num, board_num, query_num, write_num, check_value, axis_mem_request, update_set_request);
    }
