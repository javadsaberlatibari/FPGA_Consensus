...
void update_gset(int *network_ptr, int node_num, int board_num, hls::stream<ap_uint<64> >& local_set_e, hls::stream<ap_uint<64> >& break_signal , hls::stream<ap_uint<64> >& set_size_request){
...
void bram_mem_maneger_gset(int *network_ptr, int node_num, int board_num, int query_num, int write_num, hls::stream<ap_uint<64> >& axis_mem_request, hls::stream<ap_uint<64> >& update_set_request){
...
extern "C" {
    ...
    void bram_crdt_gset_bram_bench(
        hls::stream<pkt256>& m_axis_tx_meta, 
        hls::stream<pkt64>& m_axis_tx_data, 
        ...
        #pragma HLS DATAFLOW
            ...
            bram_mem_maneger_gset(network_ptr, node_num, board_num, query_num, write_num, axis_mem_request, update_set_request);
    }
