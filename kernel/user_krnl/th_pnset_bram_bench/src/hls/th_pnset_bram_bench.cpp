...
void update_pnset(int *network_ptr, int node_num, int board_num, int check_value, hls::stream<ap_int<64> >& local_set_e, hls::stream<ap_int<64> >& break_signal , hls::stream<ap_int<64> >& set_size_request){
...
void bram_mem_maneger_pnset(int *network_ptr, int node_num, int board_num, int query_num, int write_num, int check_value, hls::stream<ap_int<64> >& axis_mem_request, hls::stream<ap_int<64> >& update_set_request){
    ...
    update_pnset(network_ptr, node_num, board_num, check_value, local_set_e, break_signal , set_size_request);
...
extern "C" {
    ...
    void th_pnset_bram_bench(
        ...
        //#pragma HLS STREAM depth=8 variable=update_set_request
            ...
            bram_mem_maneger_pnset(network_ptr, node_num, board_num, query_num, write_num, check_value, axis_mem_request, update_set_request);
    }
